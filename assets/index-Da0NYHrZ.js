...
class rm extends im {
  ...
  set(t, n, a, l) {
    ...
    if (!this._isShallow) {
      const u = ua(o);
      if (!mn(a) && !ua(a) && (o = Te(o), a = Te(a)), !i && ht(o) && !ht(a)) return u || (o.value = a), true;
    }
...
function Yp(e, t, n) {
  return function(...a) {
    const l = this.__v_raw, o = Te(l), i = Fl(o), r = e === "entries" || e === Symbol.iterator && i, s = e === "keys" && i, u = l[e](...a), c = n ? Ps : t ? Hl : An;
    return !t && jt(o, "iterate", s ? Is : Za), At(Object.create(u), { next() {
...
function Kp(e, t) {
  const n = { get(l) {
    ...
    const i = this, r = i.__v_raw, s = Te(r), u = t ? Ps : e ? Hl : An;
...
function hS(e, t, n, a, l, o, { o: { nextSibling: i, parentNode: r, querySelector: s, insert: u, createText: c } }, d) {
  ...
  if (S) {
    ...
    t.shapeFlag & 16 && (m ? (v(e, t), f(S, y), t.targetAnchor || Ts(S, t, c, u, r(e) === S ? e : null)) : (t.anchor = i(e), f(S, y), t.targetAnchor || Ts(S, t, c, u), d(y && i(y), t, S, n, a, l, o))), Ai(t, m);
...
function To(e, t, n, a, l) {
  const { appear: o, mode: i, persisted: r = false, onBeforeEnter: s, onEnter: u, onAfterEnter: c, onEnterCancelled: d, onBeforeLeave: f, onLeave: v, onAfterLeave: S, onLeaveCancelled: m, onBeforeAppear: y, onAppear: h, onAfterAppear: k, onAppearCancelled: I } = t, V = String(e.key), w = Pm(n, e), g = (A, P) => {
    A && Tn(A, a, 9, P);
  }, C = (A, P) => {
    const E = P[1];
...
function So(e, t, n, a, l = false) {
  ...
  const o = a.shapeFlag & 4 ? gr(a.component) : a.el, i = l ? null : o, { i: r, r: s } = e, u = t && t.r, c = r.refs === ut ? r.refs = {} : r.refs, d = r.setupState, f = Te(d), v = d === ut ? Nv : (m) => Id(c, m) ? false : tt(f, m), S = (m, y) => !(y && Id(c, y));
  if (u != null && u !== s) {
...
function jm(e, t, n = false) {
  ...
  if ($e(o)) for (let c = 0; c < o.length; c++) {
    ...
    const d = nn(c);
    if (Fd(d)) {
      const f = o[c], v = i[d] = $e(f) || He(f) ? { type: f } : At({}, f), S = v.type;
      let m = false, y = true;
...
function qS(e, t) {
  ...
  const { insert: a, remove: l, patchProp: o, createElement: i, createText: r, createComment: s, setText: u, setElementText: c, parentNode: d, nextSibling: f, setScopeId: v = Hn, insertStaticContent: S } = e, m = (F, H, Q, ue = null, oe = null, se = null, be = void 0, ce = null, G = !!H.dynamicChildren) => {
    ...
    let Se;
    if (Q && za(Q, false), (Se = me.onVnodeBeforeUpdate) && Bn(Se, Q, H, F), _e && Ha(H, F, Q, "beforeUpdate"), Q && za(Q, true), (X.innerHTML && me.innerHTML == null || X.textContent && me.textContent == null) && c(ce, ""), le ? P(F.dynamicChildren, le, ce, Q, ue, es(H, oe), se) : be || Z(F, H, ce, null, Q, ue, es(H, oe), se, false), G > 0) {
...
function og(e) {
  ...
  const { name: n = "v", type: a, duration: l, enterFromClass: o = `${n}-enter-from`, enterActiveClass: i = `${n}-enter-active`, enterToClass: r = `${n}-enter-to`, appearFromClass: s = o, appearActiveClass: u = i, appearToClass: c = r, leaveFromClass: d = `${n}-leave-from`, leaveActiveClass: f = `${n}-leave-active`, leaveToClass: v = `${n}-leave-to` } = e, S = gk(l), m = S && S[0], y = S && S[1], { onBeforeEnter: h, onEnter: k, onEnterCancelled: I, onLeave: V, onLeaveCancelled: w, onBeforeAppear: g = h, onAppear: C = k, onAppearCancelled: x = I } = t, A = (D, M, T, L) => {
    ...
    Wa(L, [M, W]), Wd(() => {
      xa(M, D ? s : o), Fn(M, D ? c : r), zd(L) || jd(M, a, m, W);
    });
  };
...
const ww = { key: 0, class: "zone-preview-text" }, xw = { class: "zone-list" }, Cw = { class: "zone-text" }, _w = { class: "zone-coords" }, Vw = { class: "zone-actions" }, Iw = { key: 0, class: "zone-empty" }, Pw = an({ __name: "GridZoneTab", props: { zones: {}, previewRect: {} }, emits: ["add-zone", "update-zone", "remove-zone", "clear-zones", "tool-change", "draft-change"], setup(e, { emit: t }) {
  ...
  return re(l, A, { immediate: true }), re(o, A, { immediate: true }), re([c, d, f, v, S, m, y], P, { immediate: true }), (E, D) => {
    const M = je("v-switch"), T = je("v-text-field"), L = je("v-col"), W = je("v-row"), N = je("v-select"), Z = je("v-btn"), R = je("v-divider");
    return De(), Re(ge, null, [p(M, { modelValue: l.value, "onUpdate:modelValue": D[0] || (D[0] = ($) => l.value = $), inset: "", density: "compact", color: "primary", "hide-details": "", label: "Zone Tool (drag on page)" }, null, 8, ["modelValue"]), p(M, { modelValue: o.value, "onUpdate:modelValue": D[1] || (D[1] = ($) => o.value = $), class: "mt-1", inset: "", density: "compact", "hide-details": "", label: "Snap to major blocks (5x5)" }, null, 8, ["modelValue"]), n.previewRect ? (De(), Re("div", ww, " Preview: (" + Ie(n.previewRect.x1) + "," + Ie(n.previewRect.y1) + ") \u2192 (" + Ie(n.previewRect.x2) + "," + Ie(n.previewRect.y2) + ") ", 1)) : Qt("", true), p(W, { dense: "" }, { default: Pe(() => [p(L, { cols: "3" }, { default: Pe(() => [p(T, { modelValue: i.value, "onUpdate:modelValue": D[2] || (D[2] = ($) => i.value = $), modelModifiers: { number: true }, label: "x1", type: "number", density: "compact", "hide-details": "" }, null, 8, ["modelValue"])]), _: 1 }), p(L, { cols: "3" }, { default: Pe(() => [p(T, { modelValue: r.value, "onUpdate:modelValue": D[3] || (D[3] = ($) => r.value = $), modelModifiers: { number: true }, label: "y1", type: "number", density: "compact", "hide-details": "" }, null, 8, ["modelValue"])]), _: 1 }), p(L, { cols: "3" }, { default: Pe(() => [p(T, { modelValue: s.value, "onUpdate:modelValue": D[4] || (D[4] = ($) => s.value = $), modelModifiers: { number: true }, label: "x2", type: "number", density: "compact", "hide-details": "" }, null, 8, ["modelValue"])]), _: 1 }), p(L, { cols: "3" }, { default: Pe(() => [p(T, { modelValue: u.value, "onUpdate:modelValue": D[5] || (D[5] = ($) => u.value = $), modelModifiers: { number: true }, label: "y2", type: "number", density: "compact", "hide-details": "" }, null, 8, ["modelValue"])]), _: 1 })]), _: 1 }), p(W, { dense: "", class: "mt-2" }, { default: Pe(() => [p(L, { cols: "6" }, { default: Pe(() => [p(N, { modelValue: c.value, "onUpdate:modelValue": D[6] || (D[6] = ($) => c.value = $), items: V, "item-title": "title", "item-value": "value", label: "Mode", density: "compact", "hide-details": "" }, null, 8, ["modelValue"])]), _: 1 }), p(L, { cols: "6" }, { default: Pe(() => [p(N, { modelValue: d.value, "onUpdate:modelValue": D[7] || (D[7] = ($) => d.value = $), items: w, "item-title": "title", "item-value": "value", label: "Edge", density: "compact", "hide-details": "" }, null, 8, ["modelValue"])]), _: 1 })]), _: 1 }), p(W, { dense: "", class: "mt-2" }, { default: Pe(() => [p(L, { cols: "6" }, { default: Pe(() => [p(T, { modelValue: f.value, "onUpdate:modelValue": D[8] || (D[8] = ($) => f.value = $), modelModifiers: { number: true }, label: "Edge width", type: "number", min: "1", max: "4", density: "compact", "hide-details": "" }, null, 8, ["modelValue"])]), _: 1 }), p(L, { cols: "6" }, { default: Pe(() => [p(T, { modelValue: v.value, "onUpdate:modelValue": D[9] || (D[9] = ($) => v.value = $), modelModifiers: { number: true }, label: "Opacity (0-1)", type: "number", min: "0", max: "1", step: "0.1", density: "compact", "hide-details": "" }, null, 8, ["modelValue"])]), _: 1 })]), _: 1 }), d.value === "fade" ? (De(), gn(W, { key: 1, dense: "", class: "mt-2" }, { default: Pe(() => [p(L, { cols: "12" }, { default: Pe(() => [p(T, { modelValue: S.value, "onUpdate:modelValue": D[10] || (D[10] = ($) => S.value = $), modelModifiers: { number: true }, label: "Fade strength (0-1)", type: "number", min: "0", max: "1", step: "0.1", density: "compact", "hide-details": "" }, null, 8, ["modelValue"])]), _: 1 })]), _: 1 })) : Qt("", true), d.value === "noted" ? (De(), gn(W, { key: 2, dense: "", class: "mt-2" }, { default: Pe(() => [p(L, { cols: "12" }, { default: Pe(() => [p(T, { modelValue: m.value, "onUpdate:modelValue": D[11] || (D[11] = ($) => m.value = $), modelModifiers: { number: true }, label: "Note pitch cells", type: "number", min: "1", density: "compact", "hide-details": "" }, null, 8, ["modelValue"])]), _: 1 })]), _: 1 })) : Qt("", true), d.value === "bold-major" || d.value === "noted" ? (De(), gn(W, { key: 3, dense: "", class: "mt-1" }, { default: Pe(() => [p(L, { cols: "12" }, { default: Pe(() => [p(M, { modelValue: y.value, "onUpdate:modelValue": D[12] || (D[12] = ($) => y.value = $), inset: "", density: "compact", "hide-details": "", label: "Hide borders inside adjacent zones" }, null, 8, ["modelValue"])]), _: 1 })]), _: 1 })) : Qt("", true), p(Z, { class: "mt-3", size: "small", color: "primary", variant: "tonal", onClick: C }, { default: Pe(() => [...D[14] || (D[14] = [Ke(" Add Zone ", -1)])]), _: 1 }), p(R, { class: "my-3" }), b("div", xw, [(De(true), Re(ge, null, Jt(h.value, ($) => (De(), Re("div", { key: $.id, class: "zone-row" }, [b("div", Cw, [b("div", null, "#" + Ie(k($)) + " \xB7 " + Ie($.mode) + " \xB7 " + Ie($.edge.style), 1), b("div", _w, "(" + Ie($.x1) + "," + Ie($.y1) + ") \u2192 (" + Ie($.x2) + "," + Ie($.y2) + ")", 1)]), b("div", Vw, [p(Z, { size: "x-small", variant: "text", onClick: (Y) => x($) }, { default: Pe(() => [Ke(Ie($.enabled ? "Disable" : "Enable"), 1)]), _: 2 }, 1032, ["onClick"]), p(Z, { size: "x-small", variant: "text", color: "error", onClick: (Y) => a("remove-zone", $.id) }, { default: Pe(() => [...D[15] || (D[15] = [Ke("Delete", -1)])]), _: 1 }, 8, ["onClick"])])]))), 128)), h.value.length === 0 ? (De(), Re("div", Iw, "No zones.")) : Qt("", true)]), p(Z, { class: "mt-3", size: "small", color: "error", variant: "text", disabled: h.value.length === 0, onClick: D[13] || (D[13] = ($) => a("clear-zones")) }, { default: Pe(() => [...D[16] || (D[16] = [Ke(" Clear All ", -1)])]), _: 1 }, 8, ["disabled"])], 64);
  };
} }), Kn = (e, t) => {
  ...
  const c = iw({ onSetZones: (R) => l.post({ type: "set_zones", zones: u(R) }), onAddZone: (R) => l.post({ type: "add_zone", zone: s(R) }), onUpdateZone: (R) => l.post({ type: "update_zone", zone: s(R) }), onRemoveZone: (R) => l.post({ type: "remove_zone", id: R }), onClearZones: () => l.post({ type: "clear_zones" }) }), d = mw({ onAddRegion: (R) => l.post({ type: "add_hires", region: { ...R } }), onUpdateRegion: (R) => l.post({ type: "update_hires", region: { ...R } }), onRemoveRegion: (R) => l.post({ type: "remove_hires", id: R }), onClearRegions: () => l.post({ type: "clear_hires" }) }), f = q(false), v = q(false), S = q(false), m = q({ mode: "both", edge: { style: "none", widthCells: 1, opacity: 1 } }), { theme: y } = xg();
  re(y, (R) => {
  ...
  return Ct(() => {
    ...
    document.documentElement.style.setProperty("--grid-margin", `${j.toFixed(1)}px`), l.init($, Y), t.debug("Worker spawned, gridPitch", Y.toFixed(2)), l.on("ready", (ae) => {
      t.info(`${ae.backend.toUpperCase()} renderer active`), l.post({ type: "set_theme", theme: y.value }), l.post({ type: "set_zones", zones: u(c.zones.value) }), d.regions.value.length > 0 && l.post({ type: "set_hires_regions", regions: d.regions.value.map((ye) => ({ ...ye })) });
  ...
  }), (R, $) => (De(), Re(ge, null, [b("canvas", { ref_key: "canvasRef", ref: n, class: "app-bg" }, null, 512), Ne(r).previewStyle.value ? (De(), Re("div", { key: 0, class: "zone-preview-overlay", style: ve(Ne(r).previewStyle.value) }, null, 4)) : Qt("", true), p(Kw, { zones: Ne(c).zones.value, "preview-rect": Ne(r).previewRect.value, "hires-regions": Ne(d).regions.value, onAddZone: k, onUpdateZone: I, onRemoveZone: V, onClearZones: w, onToolChange: E, onDraftChange: P, onAddHiresRegion: g, onUpdateHiresRegion: C, onRemoveHiresRegion: x, onClearHiresRegions: A, onHiresToolChange: D }, null, 8, ["zones", "preview-rect", "hires-regions"])], 64));
...
function Rf(e, t) {
  ...
  if (s <= xi && (s += (xi - s) ** Bf), u <= xi && (u += (xi - u) ** Bf), Math.abs(u - s) < p0) return 0;
  let c;
  if (u > s) {
    const d = (u ** g0 - s ** h0) * S0;
    c = d < Lf ? 0 : d < $f ? d - d * Ff * Ci : d - Ci;
  } else {
    const d = (u ** b0 - s ** y0) * k0;
    c = d > -Lf ? 0 : d > -$f ? d - d * Ff * Ci : d + Ci;
  }
  return c * 100;
}
...
function Zf(e) {
  ...
  return { android: a, ios: l, cordova: o, electron: i, chrome: r, edge: s, firefox: u, opera: c, win: d, mac: f, linux: v, touch: Qw, ssr: t === "ssr" };
}
function Ux(e, t) {
...
async function Jf(e, t, n, a) {
  const l = n ? "scrollLeft" : "scrollTop", o = Rt((a == null ? void 0 : a.options) ?? ah(), t), i = a == null ? void 0 : a.rtl.value, r = (typeof e == "number" ? e : bc(e)) ?? 0, s = o.container === "parent" && r instanceof HTMLElement ? r.parentElement : Gx(o.container), u = Wn() ? o.patterns.instant : typeof o.easing == "function" ? o.easing : o.patterns[o.easing];
...
` + h.map((w) => `  ${w}`).join("") + `
  ...
  function f(h) {
    ...
    if (k) {
      ...
      let I = function() {
        tC(t.stylesheetId, t.cspNonce, u.value);
      };
...
function uh() {
  ...
  return r.run(() => {
    const s = F0(a.defaults), u = Ux(a.display, a.ssr), c = aC(a.theme), d = J0(a.icons), f = nx(a.locale), v = zx(a.date, f), S = Yx(a.goTo, f);
    function m(h) {
...
const sC = an({ __name: "ThemeToggle", setup(e) {
  ...
  return (l, o) => {
    ...
    return De(), gn(d, { elevation: "0", color: "background", border: "b" }, { append: Pe(() => [Ne(n) ? (De(), Re(ge, { key: 0 }, [p(av), p(c, { modelValue: a.value, "onUpdate:modelValue": o[1] || (o[1] = (f) => a.value = f), location: "bottom end", offset: "10" }, { activator: Pe(({ props: f }) => [p(r, K(f, { icon: "mdi-menu", variant: "text", size: "small", class: "menu-ink", "aria-label": "Open navigation menu" }), null, 16)]), default: Pe(() => [p(u, { class: "header-menu-list", density: "compact" }, { default: Pe(() => [(De(), Re(ge, null, Jt(t, (f) => p(s, { key: f.label, href: f.href, title: f.label, onClick: o[0] || (o[0] = (v) => a.value = false) }, null, 8, ["href", "title"])), 64))]), _: 1 })]), _: 1 }, 8, ["modelValue"])], 64)) : (De(), Re(ge, { key: 1 }, [(De(), Re(ge, null, Jt(t, (f) => p(r, { key: f.label, href: f.href, variant: "text", size: "default", class: "nav-ink" }, { default: Pe(() => [Ke(Ie(f.label), 1)]), _: 2 }, 1032, ["href"])), 64)), p(av)], 64))]), default: Pe(() => [p(i, { class: "header-title" }, { default: Pe(() => [...o[2] || (o[2] = [b("span", { class: "title-ink font-weight-bold" }, "Anjin Byte", -1)])]), _: 1 })]), _: 1 });
  };
} }), cC = { class: "text-medium-emphasis text-caption" }, dC = an({ __name: "AppFooter", setup(e) {
  const t = (/* @__PURE__ */ new Date()).getFullYear();
  return (n, a) => {
    const l = je("v-footer");
    return De(), gn(l, { color: "background", border: "t", class: "justify-center" }, { default: Pe(() => [b("span", cC, " \xA9 " + Ie(Ne(t)) + " Taylor Hale. Built with Rust, WebAssembly, and Vue 3. ", 1)]), _: 1 });
  };
  ...
  return (n, a) => {
    ...
    return De(), Re("section", hC, [p(o, { class: "hero-container" }, { default: Pe(() => [b("div", yC, [b("div", bC, [a[2] || (a[2] = b("span", { class: "hero-kicker glass-chip section-kicker" }, "Systems engineer", -1)), b("p", pC, [p(l, { icon: "mdi-map-marker-outline", class: "hero-location-icon" }), Ke(" " + Ie(Ne(Cn).location), 1)]), b("h1", SC, Ie(Ne(Cn).name), 1), b("p", kC, Ie(Ne(Cn).tagline), 1), b("p", wC, Ie(Ne(Cn).bio), 1), b("div", xC, [b("a", CC, [a[0] || (a[0] = Ke(" View selected work ", -1)), p(l, { icon: "mdi-arrow-right", class: "hero-link-icon" })]), a[1] || (a[1] = b("a", { href: "#contact", class: "hero-link" }, "Get in touch", -1))])]), b("aside", _C, [b("section", VC, [a[3] || (a[3] = b("p", { class: "hero-note-label" }, "Capabilities", -1)), b("div", IC, [(De(true), Re(ge, null, Jt(Ne(fC), (i) => (De(), Re("div", { key: i.label, class: "skill-group" }, [b("span", PC, Ie(i.label), 1), b("span", AC, Ie(i.items.join("  \xB7  ")), 1)]))), 128))])]), b("section", TC, [a[4] || (a[4] = b("p", { class: "hero-note-label" }, "Elsewhere", -1)), b("div", DC, [(De(true), Re(ge, null, Jt(Ne(t), (i) => (De(), Re("a", { key: i.label, href: i.href, class: "hero-meta-link", target: "_blank", rel: "noopener noreferrer" }, [p(l, { icon: i.icon, class: "hero-meta-link-icon" }, null, 8, ["icon"]), b("span", null, Ie(i.display ?? i.label), 1)], 8, EC))), 128))])])])])]), _: 1 })]);
  };
} }), BC = Kn(MC, [["__scopeId", "data-v-8d8fb736"]]), Js = { demo: { ariaLabel: "Live demo", icon: "mdi-open-in-new", label: "Demo", priority: 0 }, source: { ariaLabel: "GitHub repository", icon: "mdi-github", label: "Source", priority: 1 }, writeup: { ariaLabel: "Project writeup", icon: "mdi-text-box-outline", label: "Writeup", priority: 2 }, video: { ariaLabel: "Project video", icon: "mdi-play-circle-outline", label: "Video", priority: 3 }, docs: { ariaLabel: "Project documentation", icon: "mdi-file-document-outline", label: "Docs", priority: 4 } };
function $C(e, t) {
...
const LC = { id: "projects", class: "demos-section" }, RC = { key: 0, class: "project-feature glass-panel" }, OC = { class: "project-feature-body" }, NC = { class: "project-feature-title" }, HC = { class: "project-feature-blurb" }, zC = { class: "project-feature-tech" }, WC = { class: "project-feature-actions" }, jC = ["href", "aria-label"], UC = { class: "project-index" }, GC = { class: "project-item-head" }, YC = { class: "project-item-title" }, KC = { key: 0, class: "project-item-links", "aria-label": "Project links" }, qC = ["href", "aria-label", "title"], XC = { class: "project-item-blurb" }, ZC = { class: "project-item-tech" }, JC = an({ __name: "ProjectsSection", setup(e) {
  ...
  return (o, i) => {
    ...
    return De(), Re("section", LC, [p(s, { class: "projects-container" }, { default: Pe(() => [i[1] || (i[1] = b("div", { class: "projects-head" }, [b("div", { class: "projects-heading" }, [b("span", { class: "glass-chip section-kicker" }, "Selected work"), b("h2", { class: "section-heading projects-title" }, "Rendering systems, WASM, and interfaces with texture.")]), b("p", { class: "section-intro projects-intro" }, " Projects spanning graphics, emulation, mesh generation, and interface engineering. ")], -1)), Ne(a) ? (De(), Re("article", RC, [b("div", OC, [i[0] || (i[0] = b("span", { class: "project-feature-label" }, "Featured project", -1)), b("h3", NC, Ie(Ne(a).title), 1), b("p", HC, Ie(Ne(a).blurb), 1), b("div", zC, [(De(true), Re(ge, null, Jt(Ne(a).tech, (u) => (De(), Re("span", { key: u, class: "project-tech-tag" }, Ie(u), 1))), 128))])]), b("div", WC, [(De(true), Re(ge, null, Jt(Ne(a).visibleLinks, (u) => (De(), Re("a", { key: u.kind, href: u.href, target: "_blank", rel: "noopener noreferrer", class: ee(["project-link", { "project-link--demo": u.kind === "demo" }]), "aria-label": u.ariaLabel }, [p(r, { icon: u.icon }, null, 8, ["icon"]), b("span", null, Ie(u.label), 1)], 10, jC))), 128))])])) : Qt("", true), b("div", UC, [(De(true), Re(ge, null, Jt(Ne(l), (u) => (De(), Re("article", { key: u.title, class: "project-item quiet-sheet" }, [b("header", GC, [b("h3", YC, Ie(u.title), 1), u.visibleLinks.length ? (De(), Re("div", KC, [(De(true), Re(ge, null, Jt(u.visibleLinks, (c) => (De(), Re("a", { key: c.kind, href: c.href, target: "_blank", rel: "noopener noreferrer", class: ee(["project-item-link", { "project-item-link--demo": c.kind === "demo" }]), "aria-label": c.ariaLabel, title: c.label }, [p(r, { icon: c.icon }, null, 8, ["icon"])], 10, qC))), 128))])) : Qt("", true)]), b("p", XC, Ie(u.blurb), 1), b("div", ZC, [(De(true), Re(ge, null, Jt(u.tech, (c) => (De(), Re("span", { key: c, class: "project-tech-tag" }, Ie(c), 1))), 128))])]))), 128))])]), _: 1 })]);
  };
} }), QC = Kn(JC, [["__scopeId", "data-v-4a13129b"]]), e1 = { id: "resume", class: "resume-section" }, t1 = { class: "timeline" }, n1 = { class: "entry-rail" }, a1 = { class: "entry-dates glass-chip" }, l1 = { class: "entry quiet-sheet" }, o1 = { class: "entry-head" }, i1 = { class: "entry-titleblock" }, r1 = { class: "entry-role" }, s1 = { class: "entry-subhead" }, u1 = { class: "entry-company" }, c1 = { class: "entry-work-location" }, d1 = { class: "entry-bullets" }, f1 = { key: 0, class: "entry-tech" }, v1 = { class: "entry-tech-items" }, m1 = { class: "entry-head" }, g1 = { class: "entry-titleblock" }, h1 = { class: "entry-role" }, y1 = { class: "entry-company" }, b1 = { class: "entry-meta" }, p1 = { class: "entry-dates" }, S1 = { class: "entry-location" }, k1 = { key: 0, class: "entry-focus" }, w1 = an({ __name: "ResumeSection", setup(e) {
  return (t, n) => {
    const a = je("v-container");
    return De(), Re("section", e1, [p(a, { class: "resume-container" }, { default: Pe(() => [n[2] || (n[2] = b("div", { class: "resume-head" }, [b("div", { class: "resume-heading" }, [b("span", { class: "glass-chip section-kicker" }, "Resume"), b("h2", { class: "section-heading resume-title" }, "Experience")])], -1)), b("ol", t1, [(De(true), Re(ge, null, Jt(Ne(mC), (l) => (De(), Re("li", { key: `${l.company}-${l.dates}`, class: "timeline-row" }, [b("div", n1, [b("span", a1, Ie(l.dates), 1)]), b("article", l1, [b("header", o1, [b("div", i1, [b("h3", r1, Ie(l.role), 1), b("div", s1, [b("p", u1, Ie(l.company), 1), b("span", c1, Ie(l.location), 1)])])]), b("ul", d1, [(De(true), Re(ge, null, Jt(l.highlights, (o, i) => (De(), Re("li", { key: i }, Ie(o), 1))), 128))]), l.tech ? (De(), Re("div", f1, [n[0] || (n[0] = b("span", { class: "entry-tech-label" }, "Stack", -1)), b("span", v1, Ie(l.tech.join("  \xB7  ")), 1)])) : Qt("", true)])]))), 128))]), n[3] || (n[3] = b("div", { class: "edu-head" }, [b("span", { class: "glass-chip section-kicker" }, "Education")], -1)), (De(true), Re(ge, null, Jt(Ne(gC), (l) => (De(), Re("div", { key: `${l.school}-${l.degree}`, class: "education-card glass-panel" }, [b("header", m1, [b("div", g1, [b("h3", h1, Ie(l.degree) + " \u2014 " + Ie(l.field), 1), b("p", y1, Ie(l.school), 1)]), b("div", b1, [b("span", p1, Ie(l.dates), 1), b("span", S1, Ie(l.location), 1)])]), l.focus ? (De(), Re("p", k1, [n[1] || (n[1] = b("span", { class: "entry-tech-label" }, "Focus", -1)), Ke(" " + Ie(l.focus), 1)])) : Qt("", true)]))), 128))]), _: 1 })]);
  };
  ...
  return (t, n) => {
    const a = je("v-icon");
    return De(), Re("div", { class: ee(["contact-strip", { "is-dense": e.dense }]) }, [(De(true), Re(ge, null, Jt(Ne(ch), (l) => (De(), Re("a", { key: l.label, href: l.href, "aria-label": l.label, target: "_blank", rel: "noopener noreferrer", class: "contact-link" }, [p(a, { icon: l.icon, class: "contact-icon" }, null, 8, ["icon"]), b("span", _1, Ie(l.display ?? l.label), 1)], 8, C1))), 128))], 2);
  };
  ...
  return (t, n) => {
    const a = je("v-container");
    return De(), Re("section", P1, [p(a, { class: "contact-container" }, { default: Pe(() => [b("div", A1, [n[0] || (n[0] = b("div", { class: "contact-head" }, [b("span", { class: "glass-chip section-kicker" }, "Contact"), b("h2", { class: "contact-title" }, "Open to interesting problems."), b("p", { class: "contact-copy" }, " Best when the work sits somewhere between systems, interfaces, and practical experimentation. ")], -1)), p(I1, { class: "contact-strip-wrap" })])]), _: 1 })]);
  };
} }), D1 = Kn(T1, [["__scopeId", "data-v-435177e9"]]), E1 = an({ __name: "App", setup(e) {
  return (t, n) => {
    const a = je("v-main"), l = je("v-app");
    return De(), gn(l, null, { default: Pe(() => [p(Jw), p(uC), p(a, null, { default: Pe(() => [p(BC), p(QC), p(x1), p(D1)]), _: 1 }), p(dC)]), _: 1 });
  };
...
const ha = z({ transition: { type: null, default: "fade-transition", validator: (e) => e !== true } }, "transition"), Yt = (e, t) => {
  ...
  let u;
  return il(a) ? u = K(s, c0({ disabled: l, group: o }), i) : u = K({ name: l || !a ? "" : a }, i), ma(r, u, n);
};
function rv(e, t) {
  if (!lc) return;
...
const Dn = { mounted: rv, unmounted: eu, updated: (e, t) => {
  ...
  function V(D) {
    ...
    const T = () => {
      ...
      L || W ? (d.value = W, f.value = L) : !D.complete && c.value === "loading" && M != null ? I = window.setTimeout(T, M) : (D.currentSrc.endsWith(".svg") || D.currentSrc.startsWith("data:image/svg+xml")) && (d.value = 1, f.value = 1);
    };
    T();
  }
...
const Z1 = [null, "prominent", "default", "comfortable", "compact"], gh = z({ absolute: Boolean, collapse: Boolean, collapsePosition: { type: String, default: "start" }, color: String, density: { type: String, default: "default", validator: (e) => Z1.includes(e) }, extended: { type: Boolean, default: null }, extensionHeight: { type: [Number, String], default: 48 }, flat: Boolean, floating: Boolean, height: { type: [Number, String], default: 64 }, image: String, title: String, ...Ht(), ...pe(), ...xt(), ...Zn(), ...it(), ...Me({ tag: "header" }), ...Ue() }, "VToolbar"), tu = J()({ name: "VToolbar", props: gh(), setup(e, t) {
  ...
  return mt({ VBtn: { variant: "text" } }), te(() => {
    ...
    return d.value = e.extended === null ? !!y : e.extended, p(e.tag, { class: ee(["v-toolbar", `v-toolbar--collapse-${e.collapsePosition}`, { "v-toolbar--absolute": e.absolute, "v-toolbar--collapse": e.collapse, "v-toolbar--flat": e.flat, "v-toolbar--floating": e.floating, [`v-toolbar--density-${e.density}`]: true }, a.value, o.value, i.value, s.value, u.value, c.value, e.class]), style: ve([l.value, r.value, e.style]) }, { default: () => [m && b("div", { key: "image", class: "v-toolbar__image" }, [n.image ? p(Be, { key: "image-defaults", disabled: !e.image, defaults: { VImg: { cover: true, src: e.image } } }, n.image) : p(da, { key: "image-img", cover: true, src: e.image }, null)]), p(Be, { defaults: { VTabs: { height: de(f.value) } } }, { default: () => {
      var _a5, _b2, _c2;
...
function Na(e, t) {
  ...
  const d = { register: i, unregister: r, selected: l, select: u, disabled: B(() => e.disabled), prev: () => c(a.length - 1), next: () => c(1), isSelected: (f) => l.value.includes(f), selectedClass: B(() => e.selectedClass), items: B(() => a), getItemIndex: (f) => l_(a, f) };
  return rt(t, d), d;
}
function l_(e, t) {
  const n = yh(e, [t]);
...
const u_ = z({ color: String, disabled: Boolean, start: Boolean, end: Boolean, icon: Ce, opacity: [String, Number], ...pe(), ...Jn(), ...Me({ tag: "i" }), ...Ue() }, "VIcon"), Ye = J()({ name: "VIcon", props: u_(), setup(e, t) {
  ...
  const l = ie(), { themeClasses: o } = wr(), { iconData: i } = K0(() => l.value || e.icon), { sizeClasses: r } = Ql(e), { textColorClasses: s, textColorStyles: u } = Et(() => e.color);
  return te(() => {
    var _a3, _b2;
...
const k_ = function(e, t) {
  ...
  const { radius: o, scale: i, x: r, y: s, centerX: u, centerY: c } = k_(e, t, n), d = `${o * 2}px`;
...
const Ft = { mounted: x_, unmounted: C_, updated: __ }, Ir = z({ active: { type: Boolean, default: void 0 }, activeColor: String, baseColor: String, symbol: { type: null, default: Vc }, flat: Boolean, icon: [Boolean, String, Function, Object], prependIcon: Ce, appendIcon: Ce, block: Boolean, readonly: Boolean, slim: Boolean, stacked: Boolean, spaced: String, ripple: { type: [Boolean, Object], default: true }, text: { type: [String, Number, Boolean], default: void 0 }, ...Ht(), ...pe(), ...gt(), ...kt(), ...xt(), ...Sl(), ...Vr(), ...Zn(), ...eo(), ...it(), ...ci(), ...Jn(), ...Me({ tag: "button" }), ...Ue(), ...bn({ variant: "elevated" }) }, "VBtn"), ze = J()({ name: "VBtn", props: Ir(), emits: { "group:selected": (e) => true }, setup(e, t) {
  let { attrs: n, slots: a } = t;
  const { themeClasses: l } = qe(e), { borderClasses: o } = qt(e), { densityClasses: i } = Lt(e), { dimensionStyles: r } = wt(e), { elevationClasses: s } = It(e), { loaderClasses: u } = ri(e), { locationStyles: c } = Oa(e), { positionClasses: d } = to(e), { roundedClasses: f } = dt(e), { sizeClasses: v, sizeStyles: S } = Ql(e), m = Ma(e, e.symbol, false), y = ui(e, n), h = _(() => {
    var _a3;
...
const A_ = ["success", "info", "warning", "error"], T_ = z({ border: { type: [Boolean, String], validator: (e) => typeof e == "boolean" || ["top", "end", "bottom", "start"].includes(e) }, borderColor: String, closable: Boolean, closeIcon: { type: Ce, default: "$close" }, closeLabel: { type: String, default: "$vuetify.close" }, icon: { type: [Boolean, String, Function, Object], default: null }, modelValue: { type: Boolean, default: true }, prominent: Boolean, title: String, text: String, type: { type: String, validator: (e) => A_.includes(e) }, ...pe(), ...gt(), ...kt(), ...xt(), ...Ih(), ...Zn(), ...eo(), ...it(), ...Me(), ...Ue(), ...bn({ variant: "flat" }) }, "VAlert"), D_ = J()({ name: "VAlert", props: T_(), emits: { "click:close": (e) => true, "update:modelValue": (e) => true }, setup(e, t) {
  ...
  }), { iconSize: i } = Ph(e, () => e.prominent ? 44 : void 0), { themeClasses: r } = qe(e), { colorClasses: s, colorStyles: u, variantClasses: c } = ba(() => ({ color: e.color ?? e.type, variant: e.variant })), { densityClasses: d } = Lt(e), { dimensionStyles: f } = wt(e), { elevationClasses: v } = It(e), { locationStyles: S } = Oa(e), { positionClasses: m } = to(e), { roundedClasses: y } = dt(e), { textColorClasses: h, textColorStyles: k } = Et(() => e.borderColor), { t: I } = Qe(), V = B(() => ({ "aria-label": I(e.closeLabel), onClick(w) {
  ...
  return () => {
    ...
    return l.value && p(e.tag, { class: ee(["v-alert", e.border && { "v-alert--border": !!e.border, [`v-alert--border-${e.border === true ? "start" : e.border}`]: true }, { "v-alert--prominent": e.prominent }, r.value, s.value, d.value, v.value, m.value, y.value, c.value, e.class]), style: ve([u.value, f.value, S.value, e.style]), role: "alert" }, { default: () => {
      var _a3, _b2;
  ...
  let { slots: n } = t;
  const { themeClasses: a } = qe(e), { borderClasses: l } = qt(e), { colorClasses: o, colorStyles: i, variantClasses: r } = ba(e), { densityClasses: s } = Lt(e), { roundedClasses: u } = dt(e), { sizeClasses: c, sizeStyles: d } = Ql(e);
...
const $a = J()({ name: "VSelectionControl", directives: { vRipple: Ft }, inheritAttrs: false, props: Pr(), emits: { "update:modelValue": (e) => true }, setup(e, t) {
  let { attrs: n, slots: a } = t;
  const { group: l, densityClasses: o, icon: i, model: r, textColorClasses: s, textColorStyles: u, backgroundColorClasses: c, backgroundColorStyles: d, trueValue: f } = $_(e), v = Mt(), S = ie(false), m = ie(false), y = q(), h = B(() => e.id || `input-${v}`), k = B(() => !e.disabled && !e.readonly);
...
const F_ = z({ active: Boolean, color: String, messages: { type: [Array, String], default: () => [] }, ...pe(), ...ha({ transition: { component: xc, leaveAbsolute: true, group: true } }) }, "VMessages"), Eh = J()({ name: "VMessages", props: F_(), setup(e, t) {
  ...
  return te(() => p(Yt, { transition: e.transition, tag: "div", class: ee(["v-messages", l.value, e.class]), style: ve([o.value, e.style]) }, { default: () => [e.active && a.value.map((i, r) => b("div", { class: "v-messages__message", key: `${r}-${a.value}` }, [n.message ? n.message({ message: i }) : i]))] })), {};
...
function $h(e) {
  ...
  const a = we(e, "modelValue"), l = _(() => e.validationValue === void 0 ? a.value : e.validationValue), o = ao(e), i = N_(() => e.rules), r = q([]), s = ie(true), u = _(() => !!(ot(a.value === "" ? null : a.value).length || ot(l.value === "" ? null : l.value).length)), c = _(() => {
    var _a3;
...
const Sa = z({ id: String, appendIcon: Ce, baseColor: String, centerAffix: { type: Boolean, default: true }, color: String, glow: Boolean, iconColor: [Boolean, String], prependIcon: Ce, hideDetails: [Boolean, String], hideSpinButtons: Boolean, hint: String, persistentHint: Boolean, messages: { type: [Array, String], default: () => [] }, direction: { type: String, default: "horizontal", validator: (e) => ["horizontal", "vertical"].includes(e) }, "onClick:prepend": Bt(), "onClick:append": Bt(), ...pe(), ...gt(), ...en(kt(), ["maxWidth", "minWidth", "width"]), ...Ue(), ...Bh() }, "VInput"), Ot = J()({ name: "VInput", props: { ...Sa() }, emits: { "update:modelValue": (e) => true }, setup(e, t) {
  ...
  const { densityClasses: o } = Lt(e), { dimensionStyles: i } = wt(e), { themeClasses: r } = qe(e), { rtlClasses: s } = _t(), { InputIcon: u } = di(e), c = Mt(), d = _(() => e.id || `input-${c}`), { errorMessages: f, isDirty: v, isDisabled: S, isReadonly: m, isPristine: y, isValid: h, isValidating: k, reset: I, resetValidation: V, validate: w, validationClasses: g } = $h(e, "v-input", d), C = _(() => {
    var _a3;
...
const Pc = Symbol.for("vuetify:v-slide-group"), Ac = z({ centerActive: Boolean, scrollToActive: { type: Boolean, default: true }, contentClass: null, direction: { type: String, default: "horizontal" }, symbol: { type: null, default: Pc }, nextIcon: { type: Ce, default: "$next" }, prevIcon: { type: Ce, default: "$prev" }, showArrows: { type: [Boolean, String], validator: (e) => typeof e == "boolean" || ["always", "desktop", "mobile", "never"].includes(e) }, ...pe(), ...gl({ mobile: null }), ...Me(), ...pl({ selectedClass: "v-slide-group-item--active" }) }, "VSlideGroup"), Uo = J()({ name: "VSlideGroup", props: Ac(), emits: { "update:modelValue": (e) => true }, setup(e, t) {
  let { slots: n } = t;
  const { isRtl: a } = _t(), { displayClasses: l, mobile: o } = ln(e), i = Na(e, e.symbol), r = ie(false), s = ie(0), u = ie(0), c = ie(0), d = _(() => e.direction === "horizontal"), { resizeRef: f, contentRect: v } = wn(), { resizeRef: S, contentRect: m } = wn(), y = Kx(), h = _(() => ({ container: f.el, duration: 200, easing: "easeOutQuart" })), k = _(() => i.selected.value.length ? i.items.value.findIndex((j) => j.id === i.selected.value[0]) : -1), I = _(() => i.selected.value.length ? i.items.value.findIndex((j) => j.id === i.selected.value[i.selected.value.length - 1]) : -1);
  if (Je) {
    let j = -1;
  ...
  return () => {
    ...
    return f.value && at(p(x, K(m.linkProps, { class: ["v-chip", { "v-chip--disabled": e.disabled, "v-chip--label": e.label, "v-chip--link": h.value, "v-chip--filter": D, "v-chip--pill": e.pill, [`${e.activeClass}`]: e.activeClass && ((_a3 = m.isActive) == null ? void 0 : _a3.value) }, d.value, i.value, I.value, r.value, s.value, u.value, c.value, w.value, v == null ? void 0 : v.selectedClass.value, e.class], style: [V.value, e.style], disabled: e.disabled || void 0, draggable: e.draggable, tabindex: h.value ? 0 : void 0, onClick: g, onKeydown: h.value && !y.value && C }), { default: () => {
      var _a4;
      return [ya(h.value, "v-chip"), D && p(Cc, { key: "filter" }, { default: () => [at(b("div", { class: "v-chip__filter" }, [l.filter ? p(Be, { key: "filter-defaults", disabled: !e.filterIcon, defaults: { VIcon: { icon: e.filterIcon } } }, l.filter) : p(Ye, { key: "filter-icon", icon: e.filterIcon }, null)]), [[Mn, v.isSelected.value]])] }), T && b("div", { key: "prepend", class: "v-chip__prepend" }, [l.prepend ? p(Be, { key: "prepend-defaults", disabled: !M, defaults: { VAvatar: { image: e.prependAvatar, start: true }, VIcon: { icon: e.prependIcon, start: true } } }, l.prepend) : b(ge, null, [e.prependIcon && p(Ye, { key: "prepend-icon", icon: e.prependIcon, start: true }, null), e.prependAvatar && p(hn, { key: "prepend-avatar", image: e.prependAvatar, start: true }, null)])]), b("div", { class: "v-chip__content", "data-no-activator": "" }, [((_a4 = l.default) == null ? void 0 : _a4.call(l, { isSelected: v == null ? void 0 : v.isSelected.value, selectedClass: v == null ? void 0 : v.selectedClass.value, select: v == null ? void 0 : v.select, toggle: v == null ? void 0 : v.toggle, value: v == null ? void 0 : v.value.value, disabled: e.disabled })) ?? Ie(e.text)]), P && b("div", { key: "append", class: "v-chip__append" }, [l.append ? p(Be, { key: "append-defaults", disabled: !A, defaults: { VAvatar: { end: true, image: e.appendAvatar }, VIcon: { end: true, icon: e.appendIcon } } }, l.append) : b(ge, null, [e.appendIcon && p(Ye, { key: "append-icon", end: true, icon: e.appendIcon }, null), e.appendAvatar && p(hn, { key: "append-avatar", end: true, image: e.appendAvatar }, null)])]), E && b("button", K({ key: "close", class: "v-chip__close", type: "button", "data-testid": "close-chip" }, k.value), [l.close ? p(Be, { key: "close-defaults", defaults: { VIcon: { icon: e.closeIcon, size: "x-small" } } }, l.close) : p(Ye, { key: "close-icon", icon: e.closeIcon, size: "x-small" }, null)])];
...
const Tc = (e) => {
  ...
  return te(() => p(e.tag, { class: ee(["v-list-group", { "v-list-group--prepend": r == null ? void 0 : r.hasPrepend.value, "v-list-group--fluid": e.fluid, "v-list-group--subgroup": e.subgroup, "v-list-group--open": a.value }, e.class]), style: ve(e.style) }, { default: () => [n.activator && p(Be, { defaults: S.value }, { default: () => [p(sV, null, { default: () => [n.activator({ props: f.value, isOpen: a.value })] })] }), p(Yt, { transition: { component: Cr }, disabled: !s.value }, { default: () => {
    var _a3, _b2;
  ...
  const { themeClasses: W } = qe(e), { borderClasses: N } = qt(e), { colorClasses: Z, colorStyles: R, variantClasses: $ } = ba(T), { densityClasses: Y } = Lt(e), { dimensionStyles: j } = wt(e), { elevationClasses: O } = It(e), { roundedClasses: U } = dt(D), ae = B(() => e.lines ? `v-list-item--${e.lines}-line` : void 0), ye = B(() => e.ripple !== void 0 && e.ripple && (V == null ? void 0 : V.filterable) ? { keys: ["Enter"] } : e.ripple), ne = _(() => ({ isActive: w.value, select: c, isOpen: d.value, isSelected: f.value, isIndeterminate: v.value, isDisabled: e.disabled }));
  function fe(xe) {
    var _a3, _b2, _c2;
...
const ty = z({ baseColor: String, activeColor: String, activeClass: String, bgColor: String, disabled: Boolean, filterable: Boolean, expandIcon: Ce, collapseIcon: Ce, lines: { type: [Boolean, String], default: "one" }, slim: Boolean, prependGap: [Number, String], indent: [Number, String], nav: Boolean, navigationStrategy: { type: String, default: "focus" }, navigationIndex: Number, "onClick:open": Bt(), "onClick:select": Bt(), "onUpdate:opened": Bt(), ...oV({ selectStrategy: "single-leaf", openStrategy: "list" }), ...Ht(), ...pe(), ...gt(), ...kt(), ...xt(), ...Zh(), ...it(), ...Me(), ...Ue(), ...bn({ variant: "text" }) }, "VList"), Kl = J()({ name: "VList", props: ty(), emits: { "update:selected": (e) => true, "update:activated": (e) => true, "update:opened": (e) => true, "update:navigationIndex": (e) => true, "click:open": (e) => true, "click:activate": (e) => true, "click:select": (e) => true }, setup(e, t) {
  let { attrs: n, slots: a, emit: l } = t;
  const { items: o } = ey(e), { themeClasses: i } = qe(e), { backgroundColorClasses: r, backgroundColorStyles: s } = Xe(() => e.bgColor), { borderClasses: u } = qt(e), { densityClasses: c } = Lt(e), { dimensionStyles: d } = wt(e), { elevationClasses: f } = It(e), { roundedClasses: v } = dt(e), { children: S, open: m, parents: y, select: h, getPath: k } = iV(e, { items: o, returnObject: B(() => e.returnObject), scrollToActive: B(() => e.navigationStrategy === "track") }), I = B(() => e.lines ? `v-list--${e.lines}-line` : void 0), V = B(() => e.activeColor), w = B(() => e.baseColor), g = B(() => e.color), C = B(() => e.selectable || e.activatable), x = we(e, "navigationIndex", -1, (Y) => Y ?? -1), A = Mt();
  ...
  return te(() => {
    ...
    return p(e.tag, { ref: E, class: ee(["v-list", { "v-list--disabled": e.disabled, "v-list--nav": e.nav, "v-list--slim": e.slim }, i.value, r.value, u.value, c.value, f.value, I.value, v.value, e.class]), style: ve([{ "--v-list-indent": de(Y), "--v-list-group-prepend": Y ? "0px" : void 0, "--v-list-prepend-gap": de(e.prependGap) }, s.value, d.value, e.style]), tabindex: e.disabled ? -1 : 0, role: C.value ? "listbox" : "list", "aria-activedescendant": e.navigationStrategy === "track" && x.value >= 0 ? `v-list-item-${A}-${x.value}` : void 0, "aria-multiselectable": j, onFocusin: D, onFocusout: M, onFocus: T, onBlur: L, onKeydown: Z, onMousedown: R }, { default: () => [p(Xh, { items: o.value, returnObject: e.returnObject }, a)] });
...
function EV(e, t) {
  ...
  const c = _(() => e.openOnFocus || e.openOnFocus == null && e.openOnHover), d = _(() => e.openOnClick || e.openOnClick == null && !e.openOnHover && !c.value), { runOpenDelay: f, runCloseDelay: v } = Lc(e, (x) => {
...
const vi = z({ absolute: Boolean, attach: [Boolean, String, Object], closeOnBack: { type: Boolean, default: true }, contained: Boolean, contentClass: null, contentProps: null, disabled: Boolean, opacity: [Number, String], noClickAnimation: Boolean, modelValue: Boolean, persistent: Boolean, scrim: { type: [Boolean, String], default: true }, zIndex: { type: [Number, String], default: 2e3 }, ...DV(), ...pe(), ...kt(), ...Rc(), ...SV(), ...VV(), ...iy(), ...Ue(), ...ha() }, "VOverlay"), Un = J()({ name: "VOverlay", directives: { vClickOutside: uu }, inheritAttrs: false, props: { _disableGlobalStack: Boolean, ...Le(vi(), ["disableInitialFocus"]) }, emits: { "click:outside": (e) => true, "update:modelValue": (e) => true, keydown: (e) => true, afterEnter: () => true, afterLeave: () => true }, setup(e, t) {
  ...
  } }), { themeClasses: d } = qe(e), { rtlClasses: f, isRtl: v } = _t(), { hasContent: S, onAfterLeave: m } = Oc(e, c), y = Xe(() => typeof e.scrim == "string" ? e.scrim : null), { globalTop: h, localTop: k, stackStyles: I } = BV(c, () => e.zIndex, e._disableGlobalStack), { activatorEl: V, activatorRef: w, target: g, targetEl: C, targetRef: x, activatorEvents: A, contentEvents: P, scrimEvents: E } = EV(e, { isActive: c, isTop: k, contentEl: s }), { teleportTarget: D } = $V(() => {
    var _a3, _b2, _c2;
  ...
  const { contentStyles: W, updateLocation: N } = kV(e, { isRtl: v, contentEl: s, target: g, isActive: c });
  IV(e, { root: i, contentEl: s, targetEl: C, target: g, isActive: c, updateLocation: N });
  function Z(ne) {
  ...
  return te(() => {
    var _a3;
    return b(ge, null, [(_a3 = n.activator) == null ? void 0 : _a3.call(n, { isActive: c.value, targetRef: x, props: K({ ref: w }, A.value, e.activatorProps) }), T.value && S.value && p(yS, { disabled: !D.value, to: D.value }, { default: () => [b("div", K({ class: ["v-overlay", { "v-overlay--absolute": e.absolute || e.contained, "v-overlay--active": c.value, "v-overlay--contained": e.contained }, d.value, f.value, e.class], style: [I.value, { "--v-overlay-opacity": e.opacity, top: de(O.value) }, e.style], ref: i, onKeydown: Y }, L, a), [p(RV, K({ color: y, modelValue: c.value && !!e.scrim, ref: r }, E.value), null), p(Yt, { appear: true, persisted: true, transition: e.transition, target: g.value, onAfterEnter: ae, onAfterLeave: ye }, { default: () => {
      var _a4;
  ...
  rt(su, { register() {
    ...
    setTimeout(() => {
      var _a3;
      !c.value.size && !e.persistent && (m == null || ((_a3 = s.value) == null ? void 0 : _a3.contentEl) && !r0(m, s.value.contentEl)) && (a.value = false, u == null ? void 0 : u.closeParents());
    }, 40);
  ...
  return te(() => p(Yt, { transition: e.transition }, { default: () => [at(b("div", { class: ee(["v-counter", { "text-error": e.max && !e.disabled && parseFloat(e.value) > parseFloat(e.max) }, e.class]), style: ve(e.style) }, [n.default ? n.default({ counter: a.value, max: e.max, value: e.value }) : a.value]), [[Mn, e.active]])] })), {};
  ...
  const T = _(() => ({ isActive: S, isFocused: s, controlRef: g, iconColor: A, blur: c, focus: u })), L = B(() => {
    const Z = !S.value;
...
const zV = ["color", "file", "time", "date", "datetime-local", "week", "month"], gi = z({ autofocus: Boolean, counter: [Boolean, Number, String], counterValue: [Number, Function], prefix: String, placeholder: String, persistentPlaceholder: Boolean, persistentCounter: Boolean, suffix: String, role: String, type: { type: String, default: "text" }, modelModifiers: Object, ...fy(), ...Le(Sa(), ["direction"]), ...mi() }, "VTextField"), Gn = J()({ name: "VTextField", directives: { vIntersect: Dn }, inheritAttrs: false, props: gi(), emits: { "click:control": (e) => true, "mousedown:control": (e) => true, "update:focused": (e) => true, "update:modelValue": (e) => true }, setup(e, t) {
  ...
  return te(() => {
    ...
    return p(Ot, K({ ref: v, modelValue: o.value, "onUpdate:modelValue": (T) => o.value = T, class: ["v-text-field", { "v-text-field--prefixed": e.prefix, "v-text-field--suffixed": e.suffix, "v-input--plain-underlined": f.value }, e.class], style: e.style }, A, D, { centerAffix: !f.value, focused: i.value }), { ...l, default: (T) => {
      let { id: L, isDisabled: W, isDirty: N, isReadonly: Z, isValid: R, hasDetails: $, reset: Y } = T;
      return p(La, K({ ref: S, onMousedown: I, onClick: V, "onClick:clear": (j) => w(j, Y), role: e.role }, Le(M, ["onClick:clear"]), { id: L.value, labelId: `${L.value}-label`, active: h.value || N.value, dirty: N.value || e.dirty, disabled: W.value, focused: i.value, details: $.value, error: R.value === false }), { ...l, default: (j) => {
        ...
        return b(ge, null, [e.prefix && b("span", { class: "v-text-field__prefix" }, [b("span", { class: "v-text-field__prefix__text" }, [e.prefix])]), at(l.default ? b("div", { class: ee(O), "data-no-activator": "" }, [l.default({ id: L }), ye]) : ca(ye, { class: O }), [[Dn, u, null, { once: true }]]), e.suffix && b("span", { class: "v-text-field__suffix" }, [b("span", { class: "v-text-field__suffix__text" }, [e.suffix])])]);
      } });
    }, details: x ? (T) => {
      var _a3;
...
function hy(e, t) {
  ...
  function N() {
    ...
    const $ = A - c, Y = Math.sign(P), j = Math.max(0, $ - ks), O = Ze(x(j), 0, t.value.length), U = $ + v.value + ks, ae = Ze(x(U) + 1, O + 1, t.value.length);
...
const YV = z({ items: { type: Array, default: () => [] }, renderless: Boolean, ...gy(), ...pe(), ...kt() }, "VVirtualScroll"), Tr = J()({ name: "VVirtualScroll", props: YV(), setup(e, t) {
  ...
  return $t(() => e.renderless, () => {
    ...
    return e.renderless ? b(ge, null, [b("div", { ref: r, class: "v-virtual-scroll__spacer", style: { paddingTop: de(f.value) } }, null), m, b("div", { class: "v-virtual-scroll__spacer", style: { paddingBottom: de(v.value) } }, null)]) : b("div", { ref: i, class: ee(["v-virtual-scroll", e.class]), onScrollPassive: s, onScrollend: u, style: ve([l.value, e.style]) }, [b("div", { ref: r, class: "v-virtual-scroll__container", style: { paddingTop: de(f.value), paddingBottom: de(v.value) } }, [m])]);
...
function xl(e, t, n, a) {
  ...
  ct(() => {
    const s = typeof n == "function" ? n() : Ne(n), u = typeof s != "string" && typeof s != "number" ? "" : String(s), c = qV(i.value, u, { customKeyFilter: { ...e.customKeyFilter, ...Ne(a == null ? void 0 : a.customKeyFilter) }, default: e.customFilter, filterKeys: e.filterKeys, filterMode: e.filterMode, noFilter: e.noFilter }), d = Ne(t), f = [], v = /* @__PURE__ */ new Map();
    c.forEach((S) => {
...
const Gc = z({ chips: Boolean, closableChips: Boolean, eager: Boolean, hideNoData: Boolean, hideSelected: Boolean, listProps: { type: Object }, menu: Boolean, menuIcon: { type: Ce, default: "$dropdown" }, menuProps: { type: Object }, multiple: Boolean, noDataText: { type: String, default: "$vuetify.noDataText" }, openOnClear: Boolean, itemColor: String, noAutoScroll: Boolean, ...XV(), ...Zh({ itemChildren: false }) }, "Select"), ZV = z({ search: String, ...wl({ filterKeys: ["title"] }), ...Gc(), ...Le(gi({ modelValue: null, role: "combobox" }), ["validationValue", "dirty"]), ...ha({ transition: { component: xr } }) }, "VSelect"), Yc = J()({ name: "VSelect", props: ZV(), emits: { "update:focused": (e) => true, "update:modelValue": (e) => true, "update:menu": (e) => true, "update:search": (e) => true }, setup(e, t) {
  ...
  return re(o, (G, le) => {
    ...
    return p(Gn, K({ ref: l }, _e, { modelValue: k.value, "onUpdate:modelValue": [(me) => k.value = me, oe], focused: o.value, "onUpdate:focused": (me) => o.value = me, validationValue: I.externalValue, counterValue: V.value, dirty: le, onChange: he, class: ["v-autocomplete", `v-autocomplete--${e.multiple ? "multiple" : "single"}`, { "v-autocomplete--active-menu": N.value, "v-autocomplete--chips": !!e.chips, "v-autocomplete--selection-slot": !!E.value, "v-autocomplete--selecting-index": c.value > -1 }, e.class], style: e.style, readonly: w.isReadonly.value, placeholder: le ? void 0 : e.placeholder, "onClick:clear": ye, "onMousedown:control": ne, onKeydown: xe, onBlur: se, "aria-expanded": R.value, "aria-controls": $.value }), { ...n, default: (me) => {
      let { id: Se } = me;
      return b(ge, null, [p(ql, K({ id: Z.value, ref: s, modelValue: N.value, "onUpdate:modelValue": (ke) => N.value = ke, activator: "parent", contentClass: "v-autocomplete__content", disabled: L.value, eager: e.eager, maxHeight: 310, openOnClick: false, closeOnContentClick: false, onAfterEnter: F, onAfterLeave: H }, e.menuProps), { default: () => [p(Fa, { onFocusin: Q, onKeydown: Ae }, { default: () => [n["menu-header"] && b("header", { ref: j }, [n["menu-header"](X)]), G && p(Kl, K({ key: "autocomplete-list", ref: Y, filterable: true, selected: D.value, selectStrategy: e.multiple ? "independent" : "single-independent", onMousedown: (ke) => ke.preventDefault(), onFocusout: ue, tabindex: "-1", selectable: !!x.value.length, "aria-live": "polite", "aria-labelledby": `${Se.value}-label`, "aria-multiselectable": e.multiple, color: e.itemColor ?? e.color }, U, e.listProps), { default: () => {
        var _a3, _b2, _c2;
  ...
  mt({ VBannerActions: { color: m, density: y } }), te(() => {
    ...
    return p(e.tag, { class: ee(["v-banner", { "v-banner--stacked": e.stacked || s.value, "v-banner--sticky": e.sticky, [`v-banner--${e.lines}-line`]: !!e.lines }, S.value, a.value, o.value, i.value, r.value, c.value, f.value, v.value, e.class]), style: ve([l.value, u.value, d.value, e.style]), role: "banner" }, { default: () => {
      var _a3;
  ...
  return Na(e, Vc), mt({ VBtn: { baseColor: B(() => e.baseColor), color: B(() => e.color), density: B(() => e.density), stacked: B(() => e.mode !== "horizontal"), variant: "text" } }, { scoped: true }), te(() => p(e.tag, { class: ee(["v-bottom-navigation", { "v-bottom-navigation--active": f.value, "v-bottom-navigation--grow": e.grow, "v-bottom-navigation--shift": e.mode === "shift" }, a.value, o.value, l.value, r.value, s.value, u.value, e.class]), style: ve([i.value, v.value, { height: de(d.value) }, c.value, e.style]) }, { default: () => [n.default && b("div", { class: "v-bottom-navigation__content" }, [n.default()])] })), {};
  ...
  return te(() => {
    ...
    return p(e.tag, { type: e.tag === "button" ? "button" : void 0, class: ee([{ "v-icon-btn": true, "v-icon-btn--active": l.value, "v-icon-btn--disabled": e.disabled, "v-icon-btn--loading": e.loading, "v-icon-btn--readonly": e.readonly, [`v-icon-btn--${e.size}`]: true }, o.value, u.value, i.value, r.value, s.value, d.value, e.class]), style: ve([{ "--v-icon-btn-rotate": de(e.rotate, "deg"), "--v-icon-btn-height": de(k), "--v-icon-btn-width": de(I) }, c.value, e.style]), tabindex: e.disabled || e.readonly ? -1 : 0, onClick: v }, { default: () => {
      var _a3;
...
function Zc(e) {
  ...
  }), c = _(() => MI(s.value)), d = _(() => tr(o.value, i.value, t.today, c.value)), f = _(() => e.dayFormat ? e.dayFormat : _o(a.current.value, () => ({ timeZone: "UTC", day: "numeric" }))), v = _(() => e.weekdayFormat ? e.weekdayFormat : _o(a.current.value, (V, w) => ({ timeZone: "UTC", weekday: w ? "short" : "long" })));
  function S(V) {
    return vh(V);
  }
  function m(V) {
...
const Yo = { mounted: LI, unmounted: RI }, go = Kt({ name: "VCalendarDaily", directives: { vResize: Yo }, props: { color: String, shortWeekdays: { type: Boolean, default: true }, shortIntervals: { type: Boolean, default: true }, hideHeader: Boolean, ...Mr(), ...My() }, setup(e, t) {
  ...
  function v(M, T) {
    ...
    return b("div", K({ key: M.date, class: ["v-calendar-daily_head-day", i.getRelativeClasses(M)] }, L), [m(M), y(M), S(M, T)]);
  }
  function S(M, T) {
    var _a3;
  ...
  function g() {
    return i.days.value.map((M, T) => {
      ...
      return b("div", K({ key: M.date, class: ["v-calendar-daily__day", i.getRelativeClasses(M)] }, L), [x(T), C(M)]);
    });
  }
  function C(M) {
    var _a3;
  ...
  function A(M) {
    ...
    return b("div", { class: "v-calendar-daily__day-interval", key: M.time, style: ve([{ height: T }, L(M)]) }, [(_a3 = n.interval) == null ? void 0 : _a3.call(n, i.getSlotScope(M))]);
  }
  function P() {
...
const NI = Kt({ name: "VCalendarCategory", props: { categories: { type: [Array, String], default: "" }, categoryText: [String, Function], categoryForInvalid: { type: String, default: "" }, ...Mr(), ...My() }, setup(e, t) {
  ...
  function k(w, g, C) {
    var _a3;
    const x = c(w), A = fn(a, ":day", (P) => ({ nativeEvent: P, ...w }));
...
const Cv = 100, WI = (e, t, n) => {
  ...
  return (l, o, i, r) => {
    ...
    const s = Ra(l), u = Fy(o, s), c = QI(u, s);
    for (const d of c) {
      const f = [];
...
function YI(e, t) {
  for (const n of e) {
    const { visual: a, parent: l } = n, o = Hy(n) + 1, i = l ? l.visual.left : 0, r = Vi - i, s = Math.min(jI, Vi / o), u = KI(n, e), c = r / (o - n.index + 1), d = r / (o - n.index + (n.sibling ? 1 : 0)) * u;
    l && (a.left = n.sibling ? i + c : i + s), a.width = JI(n, e, t) ? Vi - a.left : Math.min(Vi - a.left, d * UI);
  }
}
function KI(e, t) {
...
function tP(e, t, n, a) {
  ...
  const i = e[n], r = e[a], s = ia(i, true), u = r ? ia(r, true) : s, c = Sv(i) ? kv(s, l) : s, d = Sv(r) ? kv(u, l) : u, f = Vt(c), v = Ra(c), S = Vt(d), m = c.hasTime ? 0 : 2359, y = Ra(d) + m, h = !c.hasTime;
...
function sP(e, t, n) {
  ...
  function V(T, L, W, N) {
    const Z = t.event, R = c.value(T.input), $ = S(T.input), Y = T.start.hour < 12 && T.end.hour >= 12, j = EI(T.start, T.end) <= u.value, O = (fe, Ae) => a.getFormatter({ timeZone: "UTC", hour: "numeric", minute: fe.minute > 0 ? "numeric" : void 0 })(fe, true), U = () => O(T.start) + " - " + O(T.end), ae = () => {
    ...
    return at(b("div", K(a.getColorProps({ text: R, background: $ }), ne, N, { ref_for: true, ref: m }), [(Z == null ? void 0 : Z(ye)) ?? w(ae)]), [[Ft, e.eventRipple ?? true]]);
  }
  function w(T) {
  ...
  function g(T) {
    ...
    return b("div", { style: { height: `${L}px` }, "data-date": T.date, ref_for: true, ref: m }, null);
  }
  function C(T) {
    const L = e.eventHeight || 0, W = e.eventMarginBottom || 0, N = fn(n, ":more", (Z) => ({ nativeEvent: Z, ...T }));
    return at(b("div", K({ class: ["v-event-more pl-1", { "v-outside": T.outside }], "data-date": T.date, "data-more": "1", style: { display: "none", height: `${L}px`, marginBottom: `${W}px` }, ref_for: true, ref: m }, N), null), [[Ft, e.eventRipple ?? true]]);
  }
  function x() {
  ...
  function M() {
    if (l.value) return { ...t };
    const T = f.value(s.value, v.value[0], u.value), L = (N) => !!N, W = (N, Z, R, $) => {
...
const uP = J()({ name: "VCalendar", directives: { vResize: Yo }, props: { modelValue: { type: [String, Number, Date], validate: Ol }, categoryDays: { type: [Number, String], default: 1, validate: (e) => isFinite(parseInt(e)) && parseInt(e) > 0 }, categories: { type: [Array, String], default: "" }, categoryText: { type: [String, Function] }, maxDays: { type: Number, default: 7 }, categoryHideDynamic: { type: Boolean }, categoryShowAll: { type: Boolean }, categoryForInvalid: { type: String, default: "" }, ...Mr(), ...rP() }, setup(e, t) {
  let { slots: n, attrs: a, emit: l } = t;
  const o = q(), i = sP(e, n, a), r = q(null), s = q(null), u = _(() => parseInt(String(e.categoryDays)) || 1), c = _(() => $y(e.categories, e.categoryText)), d = _(() => {
  ...
  let { attrs: n, slots: a } = t;
  const { themeClasses: l } = qe(e), { borderClasses: o } = qt(e), { colorClasses: i, colorStyles: r, variantClasses: s } = ba(e), { densityClasses: u } = Lt(e), { dimensionStyles: c } = wt(e), { elevationClasses: d } = It(e), { loaderClasses: f } = ri(e), { locationStyles: v } = Oa(e), { positionClasses: S } = to(e), { roundedClasses: m } = dt(e), y = ui(e, n), h = ie(void 0);
...
const nr = { mounted: kP, unmounted: wP }, Ky = Symbol.for("vuetify:v-window"), qy = Symbol.for("vuetify:v-window-group"), Br = z({ continuous: Boolean, nextIcon: { type: [Boolean, String, Function, Object], default: "$next" }, prevIcon: { type: [Boolean, String, Function, Object], default: "$prev" }, reverse: Boolean, showArrows: { type: [Boolean, String], validator: (e) => typeof e == "boolean" || e === "hover" }, verticalArrows: [Boolean, String], touch: { type: [Object, Boolean], default: void 0 }, direction: { type: String, default: "horizontal" }, modelValue: null, disabled: Boolean, selectedClass: { type: String, default: "v-window-item--active" }, mandatory: { type: [Boolean, String], default: "force" }, crossfade: Boolean, transitionDuration: Number, ...pe(), ...Me(), ...Ue() }, "VWindow"), sl = J()({ name: "VWindow", directives: { vTouch: nr }, props: Br(), emits: { "update:modelValue": (e) => true }, setup(e, t) {
  ...
  return te(() => p(Yt, { transition: f.value, disabled: !o.value }, { default: () => {
    var _a3;
    return [at(b("div", { class: ee(["v-window-item", l.selectedClass.value, e.class]), style: ve(e.style) }, [v.value && ((_a3 = n.default) == null ? void 0 : _a3.call(n))]), [[Mn, l.isSelected.value]])];
  } })), { groupItem: l };
  ...
  }, { deep: true, immediate: true }), Ct(() => y()), te(() => b("div", { ref: d, class: ee(["v-color-picker-canvas", e.class]), style: ve(e.style), onMousedown: v, onTouchstartPassive: v }, [b("canvas", { ref: l, width: o.value, height: i.value }, null), e.color && b("div", { class: ee(["v-color-picker-canvas__dot", { "v-color-picker-canvas__dot--disabled": e.disabled }]), style: ve(c.value) }, null)])), {};
} });
function TP(e, t) {
  if (t) {
    const { a: n, ...a } = e;
...
const Bl = { h: 0, s: 0, v: 0, a: 1 }, mu = { inputProps: { type: "number", min: 0 }, inputs: [{ label: "R", max: 255, step: 1, getValue: (e) => Math.round(e.r), getColor: (e, t) => ({ ...e, r: Number(t) }), localeKey: "redInput" }, { label: "G", max: 255, step: 1, getValue: (e) => Math.round(e.g), getColor: (e, t) => ({ ...e, g: Number(t) }), localeKey: "greenInput" }, { label: "B", max: 255, step: 1, getValue: (e) => Math.round(e.b), getColor: (e, t) => ({ ...e, b: Number(t) }), localeKey: "blueInput" }, { label: "A", max: 1, step: 0.01, getValue: (e) => {
  ...
  return te(() => {
    var _a3;
    return b("div", { class: ee(["v-color-picker-edit", e.class]), style: ve(e.style) }, [(_a3 = o.value) == null ? void 0 : _a3.map((i) => p($P, i, null)), l.value.length > 1 && p(ze, { icon: "$unfold", size: "x-small", variant: "plain", "aria-label": a("$vuetify.colorPicker.ariaLabel.changeFormat"), onClick: () => {
...
const Zy = z({ disabled: { type: Boolean, default: null }, error: Boolean, readonly: { type: Boolean, default: null }, max: { type: [Number, String], default: 100 }, min: { type: [Number, String], default: 0 }, step: { type: [Number, String], default: 0 }, thumbColor: String, thumbLabel: { type: [Boolean, String], default: void 0, validator: (e) => typeof e == "boolean" || e === "always" || e === "hover" }, thumbSize: { type: [Number, String], default: 20 }, showTicks: { type: [Boolean, String], default: false, validator: (e) => typeof e == "boolean" || e === "always" }, ticks: { type: [Array, Object] }, tickSize: { type: [Number, String], default: 2 }, color: String, trackColor: String, trackFillColor: String, trackSize: { type: [Number, String], default: 4 }, direction: { type: String, default: "horizontal", validator: (e) => ["vertical", "horizontal"].includes(e) }, reverse: Boolean, noKeyboard: Boolean, ...it(), ...xt({ elevation: 2 }), ripple: { type: Boolean, default: true } }, "Slider"), Jy = (e) => {
  ...
  return re(() => e.focused, (ne) => {
    ...
    return b("div", { class: ee(["v-slider-thumb", { "v-slider-thumb--focused": e.focused, "v-slider-thumb--pressed": e.focused && V.value }, e.class, i.value]), style: ve([{ "--v-slider-thumb-position": ne, "--v-slider-thumb-size": de(v.value) }, e.style]), role: "slider", tabindex: f.value ? -1 : 0, "aria-label": e.name, "aria-valuemin": r.value, "aria-valuemax": s.value, "aria-valuenow": e.modelValue, "aria-readonly": !!k.value, "aria-orientation": m.value, onKeydown: k.value ? void 0 : ye, onMouseenter: () => {
      C.value = true;
    }, onMouseleave: () => {
  ...
  const { color: l, parsedTicks: o, rounded: i, showTicks: r, tickSize: s, trackColor: u, trackFillColor: c, trackSize: d, vertical: f, min: v, max: S, indexFromEnd: m } = a, { roundedClasses: y } = dt(i), { backgroundColorClasses: h, backgroundColorStyles: k } = Xe(c), { backgroundColorClasses: I, backgroundColorStyles: V } = Xe(u), w = _(() => `inset-${f.value ? "block" : "inline"}-${m.value ? "end" : "start"}`), g = _(() => f.value ? "height" : "width"), C = _(() => ({ [w.value]: "0%", [g.value]: "100%" })), x = _(() => e.stop - e.start), A = _(() => ({ [w.value]: de(e.start, "%"), [g.value]: de(x.value, "%") })), P = _(() => r.value ? (f.value ? o.value.slice().reverse() : o.value).map((D, M) => {
    ...
    return b("div", { key: D.value, class: ee(["v-slider-track__tick", { "v-slider-track__tick--filled": D.position >= e.start && D.position <= e.stop, "v-slider-track__tick--first": D.value === v.value, "v-slider-track__tick--last": D.value === S.value }]), style: { [w.value]: T } }, [(D.label || n["tick-label"]) && b("div", { class: "v-slider-track__tick-label" }, [((_a3 = n["tick-label"]) == null ? void 0 : _a3.call(n, { tick: D, index: M })) ?? D.label])]);
  }) : []);
  ...
  return te(() => {
    ...
    return p(Ot, K({ ref: i, class: ["v-slider", { "v-slider--has-labels": !!n["tick-label"] || k.value, "v-slider--focused": g.value, "v-slider--pressed": f.value, "v-slider--disabled": I.value }, r.value, e.class], style: e.style }, P, E, { focused: g.value }), { ...n, prepend: M ? (T) => {
      var _a3, _b2;
      ...
      return b("div", { class: "v-slider__container", onMousedown: V.value ? void 0 : S, onTouchstartPassive: V.value ? void 0 : m }, [b("input", { id: L.value, name: e.name || L.value, disabled: I.value, readonly: V.value, tabindex: "-1", value: u.value }, null), p(eb, { ref: y, start: 0, stop: A.value }, { "tick-label": n["tick-label"] }), p(yu, K({ ref: o, "aria-describedby": W.value, focused: g.value, noKeyboard: w.value, min: c.value, max: d.value, modelValue: u.value, "onUpdate:modelValue": (N) => u.value = N, position: A.value, elevation: e.elevation, onFocus: C, onBlur: x, ripple: e.ripple, name: e.name }, D), { "thumb-label": n["thumb-label"] })]);
    } });
  }), Pt({ focus: () => {
    var _a3;
...
const fA = Kt({ name: "VColorPickerSwatches", props: cA(), emits: { "update:color": (e) => true }, setup(e, t) {
  ...
  return te(() => b("div", { class: ee(["v-color-picker-swatches", e.class]), style: ve([{ maxHeight: de(e.maxHeight) }, e.style]) }, [b("div", null, [e.swatches.map((o) => b("div", { class: "v-color-picker-swatches__swatch" }, [o.map((i) => {
    ...
    return b("div", { class: ee(["v-color-picker-swatches__color", { "v-color-picker-swatches__color--disabled": e.disabled }]), onClick: () => l(s) }, [b("div", { style: { background: u } }, [e.color && Dt(e.color, s) ? p(Ye, { size: "x-small", icon: "$success", color: B0(i, "#FFFFFF") > 2 ? "white" : "black" }, null) : void 0])]);
  })]))])])), {};
  ...
  return te(() => {
    ...
    return p(Fa, K(o, { color: e.bgColor, class: ["v-picker", { "v-picker--divided": e.divided, "v-picker--landscape": e.landscape, "v-picker--with-actions": !!n.actions }, e.class], style: e.style }), { default: () => {
      var _a3;
      return [!e.hideHeader && b("div", { key: "header", class: ee(["v-picker__header-wrapper", a.value]), style: ve([l.value]) }, [i && p(vA, { key: "picker-title" }, { default: () => {
        var _a4;
  ...
  const a = we(e, "mode"), l = q(null), o = we(e, "modelValue", void 0, (c) => {
    ...
    return d;
  }, (c) => c ? DP(c, e.modelValue) : null), i = _(() => o.value ? { ...o.value, h: l.value ?? o.value.h } : null), { rtlClasses: r } = _t();
  let s = true;
  re(o, (c) => {
    if (!s) {
      s = true;
  ...
  return Jl(() => {
    ...
    return p(Xl, K(c, { class: ["v-color-picker", r.value, e.class], style: [{ "--v-color-picker-color-hsv": Ng({ ...i.value ?? Bl, a: 1 }) }, e.style] }), { ...n, default: () => b(ge, null, [!e.hideCanvas && p(AP, { key: "canvas", color: i.value, "onUpdate:color": u, disabled: e.disabled, readonly: e.readonly, dotSize: e.dotSize, width: e.width, height: e.canvasHeight }, null), (!e.hideSliders || !e.hideInputs) && b("div", { key: "controls", class: "v-color-picker__controls" }, [!e.hideSliders && p(zP, { key: "preview", color: i.value, "onUpdate:color": u, hideAlpha: !a.value.endsWith("a"), disabled: e.disabled, readonly: e.readonly, hideEyeDropper: e.hideEyeDropper, eyeDropperIcon: e.eyeDropperIcon }, null), !e.hideInputs && p(LP, { key: "edit", modes: e.modes, mode: a.value, "onUpdate:mode": (d) => a.value = d, color: i.value, "onUpdate:color": u, disabled: e.disabled, readonly: e.readonly }, null)]), e.showSwatches && p(fA, { key: "swatches", color: i.value, "onUpdate:color": u, maxHeight: e.swatchesMaxHeight, swatches: e.swatches, disabled: e.disabled, readonly: e.readonly }, null)]) });
  }), {};
  ...
  const { items: v, transformIn: S, transformOut: m } = Mc(e), { textColorClasses: y, textColorStyles: h } = Et(() => {
    ...
    var _a4;
    W.value && !X && ((_a4 = u.value) == null ? void 0 : _a4.\u03A8openChildren.size) || X && L.value || (W.value = X);
...
`, ...e.delimiters ?? []].map(Yi).join("|");
  ...
  return re(i, (X, me) => {
    ...
    return p(Gn, K({ ref: o }, Se, { modelValue: P.value, "onUpdate:modelValue": (Ve) => P.value = Ve, focused: i.value, "onUpdate:focused": (Ve) => i.value = Ve, validationValue: I.externalValue, counterValue: E.value, dirty: me, class: ["v-combobox", { "v-combobox--active-menu": N.value, "v-combobox--chips": !!e.chips, "v-combobox--selection-slot": !!C.value, "v-combobox--selecting-index": d.value > -1, [`v-combobox--${e.multiple ? "multiple" : "single"}`]: true }, e.class], style: e.style, readonly: V.isReadonly.value, placeholder: me ? void 0 : e.placeholder, "onClick:clear": Ae, "onMousedown:control": xe, onKeydown: H, onPaste: Q, onBlur: _e, "aria-expanded": R.value, "aria-controls": $.value }), { ...a, default: (Ve) => {
      let { id: Fe } = Ve;
      return b(ge, null, [p(ql, K({ id: Z.value, ref: u, modelValue: N.value, "onUpdate:modelValue": (Ge) => N.value = Ge, activator: "parent", contentClass: "v-combobox__content", disabled: L.value, eager: e.eager, maxHeight: 310, openOnClick: false, closeOnContentClick: false, onAfterEnter: ue, onAfterLeave: oe }, e.menuProps), { default: () => [p(Fa, { onFocusin: G, onKeydown: F }, { default: () => [a["menu-header"] && b("header", { ref: ae }, [a["menu-header"](ke)]), X && p(Kl, K({ key: "combobox-list", ref: U, filterable: true, selected: Y.value, selectStrategy: e.multiple ? "independent" : "single-independent", onMousedown: (Ge) => Ge.preventDefault(), selectable: !!T.value.length, onFocusout: le, tabindex: "-1", "aria-live": "polite", "aria-labelledby": `${Fe.value}-label`, "aria-multiselectable": e.multiple, color: e.itemColor ?? e.color }, ne, e.listProps), { default: () => {
        var _a4, _b2, _c2;
        ...
        if (!(on && !ka)) return b("div", { key: Ge.value, class: ee(["v-combobox__selection", Oe === d.value && ["v-combobox__selection--selected", y.value]]), style: ve(Oe === d.value ? h.value : {}) }, [g.value ? a.chip ? p(Be, { key: "chip-defaults", defaults: { VChip: { closable: w.value, size: "small", text: Ge.title } } }, { default: () => [ka] }) : p(fa, K({ key: "chip", closable: w.value, size: "small", text: Ge.title, disabled: Ge.props.disabled }, lt), null) : ka ?? b("span", { class: "v-combobox__selection-text" }, [Ge.title, e.multiple && Oe < I.value.length - 1 && b("span", { class: "v-combobox__selection-comma" }, [Ke(",")])])]);
      })]);
    }, "append-inner": function() {
      var _a4, _b2;
...
function jr(e) {
  const { initialSortOrder: t, sortBy: n, mustSort: a, multiSort: l, page: o } = e, i = (u, c) => {
    ...
    if (f) f.order === S ? a.value && d.length === 1 ? f.order = t.value : d = d.filter((m) => m.key !== u.key) : f.order = S;
      ...
      const { active: m, mode: y } = _A(l.value, c);
...
const DA = z({ search: String, loading: Boolean, itemsLength: [Number, String], ...pe(), ...IA(), ...fb(), ...mb(), ...nd({ itemsPerPage: 5 }), ...nb(), ...ed(), ...wl(), ...Me(), ...ha({ transition: { component: Ho, hideOnLeave: true } }) }, "VDataIterator"), EA = J()({ name: "VDataIterator", props: DA(), emits: { "update:modelValue": (e) => true, "update:groupBy": (e) => true, "update:page": (e) => true, "update:itemsPerPage": (e) => true, "update:sortBy": (e) => true, "update:options": (e) => true, "update:expanded": (e) => true, "update:currentItems": (e) => true }, setup(e, t) {
  ...
  return te(() => p(e.tag, { class: ee(["v-data-iterator", { "v-data-iterator--loading": e.loading }, e.class]), style: ve(e.style) }, { default: () => {
    ...
    return [(_a3 = n.header) == null ? void 0 : _a3.call(n, O.value), p(Yt, { transition: e.transition }, { default: () => {
      ...
      } }) : b("div", { key: "items" }, [L.value.length ? (_a4 = n.default) == null ? void 0 : _a4.call(n, O.value) : (_b3 = n["no-data"]) == null ? void 0 : _b3.call(n)])];
...
const BA = z({ activeColor: String, start: { type: [Number, String], default: 1 }, modelValue: { type: Number, default: (e) => e.start }, disabled: Boolean, length: { type: [Number, String], default: 1, validator: (e) => e % 1 === 0 }, totalVisible: [Number, String], firstIcon: { type: Ce, default: "$first" }, prevIcon: { type: Ce, default: "$prev" }, nextIcon: { type: Ce, default: "$next" }, lastIcon: { type: Ce, default: "$last" }, ariaLabel: { type: String, default: "$vuetify.pagination.ariaLabel.root" }, pageAriaLabel: { type: String, default: "$vuetify.pagination.ariaLabel.page" }, currentPageAriaLabel: { type: String, default: "$vuetify.pagination.ariaLabel.currentPage" }, firstAriaLabel: { type: String, default: "$vuetify.pagination.ariaLabel.first" }, previousAriaLabel: { type: String, default: "$vuetify.pagination.ariaLabel.previous" }, nextAriaLabel: { type: String, default: "$vuetify.pagination.ariaLabel.next" }, lastAriaLabel: { type: String, default: "$vuetify.pagination.ariaLabel.last" }, ellipsis: { type: String, default: "..." }, showFirstLastPage: Boolean, ...Ht(), ...pe(), ...gt(), ...xt(), ...it(), ...Jn(), ...Me({ tag: "nav" }), ...Ue(), ...bn({ variant: "text" }) }, "VPagination"), pu = J()({ name: "VPagination", props: BA(), emits: { "update:modelValue": (e) => true, first: (e) => true, prev: (e) => true, next: (e) => true, last: (e) => true }, setup(e, t) {
  ...
  let { slots: n } = t;
  const { t: a } = Qe(), { page: l, pageCount: o, startIndex: i, stopIndex: r, itemsLength: s, itemsPerPage: u, setItemsPerPage: c } = kA(), d = _(() => e.itemsPerPageOptions.map((f) => typeof f == "number" ? { value: f, title: f === -1 ? a("$vuetify.dataFooter.itemsPerPageAll") : String(f) } : { ...f, title: isNaN(Number(f.title)) ? a(f.title) : f.title }));
  return te(() => {
    var _a3;
  ...
  return te(() => {
    ...
    return e.loading && (!e.items.length || a.loading) ? b("tr", { class: "v-data-table-rows-loading", key: "loading" }, [b("td", { colspan: l.value.length }, [((_a3 = a.loading) == null ? void 0 : _a3.call(a)) ?? f(e.loadingText)])]) : !e.loading && !e.items.length && !e.hideNoData ? b("tr", { class: "v-data-table-rows-no-data", key: "no-data" }, [b("td", { colspan: l.value.length }, [((_b2 = a["no-data"]) == null ? void 0 : _b2.call(a)) ?? f(e.noDataText)])]) : b(ge, null, [e.items.map((m, y) => {
      ...
      if (m.type === "group") {
        ...
        return a["group-header"] ? a["group-header"](I) : p(HA, K({ key: `group-header_${m.id}`, item: m }, fn(n, ":groupHeader", () => I), S), a);
      }
...
const dd = z({ ...Vb(), hideDefaultBody: Boolean, hideDefaultFooter: Boolean, hideDefaultHeader: Boolean, width: [String, Number], search: String, ...nb(), ...ed(), ...$A(), ...zA(), ...fb(), ...mb(), ...Le(xb(), ["multiSort", "initialSortOrder"]), ...Ib() }, "DataTable"), UA = z({ ...nd(), ...dd(), ...wl(), ...id() }, "VDataTable"), GA = J()({ name: "VDataTable", props: UA(), emits: { "update:modelValue": (e) => true, "update:page": (e) => true, "update:itemsPerPage": (e) => true, "update:sortBy": (e) => true, "update:options": (e) => true, "update:groupBy": (e) => true, "update:expanded": (e) => true, "update:currentItems": (e) => true }, setup(e, t) {
  let { attrs: n, slots: a } = t;
  const { groupBy: l } = td(e), { initialSortOrder: o, sortBy: i, multiSort: r, mustSort: s } = Wr(e), { page: u, itemsPerPage: c } = ad(e), { disableSort: d } = Zl(e), { columns: f, headers: v, sortFunctions: S, sortRawFunctions: m, filterFunctions: y } = sd(e, { groupBy: l, showSelect: B(() => e.showSelect), showExpand: B(() => e.showExpand) }), { items: h } = cd(e, f), k = B(() => e.search), { filteredItems: I } = xl(e, h, k, { transform: (ae) => ae.columns, customKeyFilter: y }), { toggleSort: V } = jr({ initialSortOrder: o, sortBy: i, multiSort: r, mustSort: s, page: u }), { sortByWithGroups: w, opened: g, extractRows: C, isGroupOpen: x, toggleGroup: A } = Rr({ groupBy: l, sortBy: i, disableSort: d }), { sortedItems: P } = od(e, I, w, { transform: (ae) => ({ ...ae.raw, ...ae.columns }), sortFunctions: S, sortRawFunctions: m }), E = _(() => e.pageBy === "auto" ? e.groupBy.length ? "group" : "item" : e.pageBy), { pageCount: D, setItemsPerPage: M, paginatedItems: T } = wA({ pageBy: E, sortedItems: P, paginate: (ae) => {
  ...
  return te(() => {
    ...
    }, bottom: () => a.bottom ? a.bottom(U.value) : !e.hideDefaultFooter && b(ge, null, [p(vn, null, null), p(Ko, ae, { prepend: a["footer.prepend"] })]) });
  }), {};
  ...
  const xe = _(() => ({ sortBy: i.value, toggleSort: k, someSelected: L.value, allSelected: W.value, isSelected: E, select: D, selectAll: M, toggleSelect: T, isExpanded: N, toggleExpand: Z, isGroupOpen: g, toggleGroup: C, items: P.value.map((he) => he.raw), internalItems: P.value, groupedItems: A.value, columns: c.value, headers: d.value }));
  return te(() => {
...
const sT = z({ dense: Boolean, noGutters: Boolean, align: { type: String, default: null, validator: Eb }, ...Mb, justify: { type: String, default: null, validator: Bb }, ...$b, alignContent: { type: String, default: null, validator: Fb }, ...Lb, ...pe(), ...Me() }, "VRow"), uT = J()({ name: "VRow", props: sT(), setup(e, t) {
  ...
  return te(() => {
    ...
    return b("div", { class: ee(["v-date-picker-header", { "v-date-picker-header--clickable": !!e.onClick }, l.value]), style: ve(o.value), onClick: i }, [a.prepend && b("div", { key: "prepend", class: "v-date-picker-header__prepend" }, [a.prepend()]), s && p(Yt, { key: "content", name: e.transition }, { default: () => {
      var _a3;
...
const Nb = z({ color: String, hideWeekdays: Boolean, multiple: [Boolean, Number, String], showWeek: Boolean, readonly: Boolean, transition: { type: String, default: "picker-transition" }, reverseTransition: { type: String, default: "picker-reverse-transition" }, events: { type: [Array, Function, Object], default: () => null }, eventColor: { type: [Array, Function, Object, String], default: () => null }, ...Le(dT(), ["displayValue"]) }, "VDatePickerMonth"), Cu = J()({ name: "VDatePickerMonth", props: Nb(), emits: { "update:modelValue": (e) => true, "update:month": (e) => true, "update:year": (e) => true }, setup(e, t) {
  let { emit: n, slots: a } = t;
  const l = q(), { t: o } = Qe(), { daysInMonth: i, model: r, weekNumbers: s, weekdayLabels: u } = fT(e), c = ml(), d = ie(), f = ie(), v = ie(false), S = B(() => v.value ? e.reverseTransition : e.transition);
...
`) : U;
    ...
    if (s.value !== "month") U.push("prev-month", "next-month", "prev-year", "next-year");
      ...
      let ae = l.date();
      if (ae = l.startOfMonth(ae), ae = l.setMonth(ae, m.value), ae = l.setYear(ae, h.value), u.value) {
  ...
  function N() {
    if (h.value++, c.value) {
      ...
      l.isAfter(ae, c.value) && (m.value = l.getMonth(c.value));
    }
    O();
  }
  function Z() {
    if (h.value--, u.value) {
      ...
      l.isAfter(u.value, ae) && (m.value = l.getMonth(u.value));
    }
    O();
  }
  function R() {
  ...
  return re(r, (U, ae) => {
    ...
    return p(Xl, K(U, { color: v.value, class: ["v-date-picker", `v-date-picker--${s.value}`, { "v-date-picker--show-week": e.showWeek }, i.value, e.class], style: [{ "--v-date-picker-landscape-header-width": de(e.landscapeHeaderWidth) }, e.style] }), { title: () => {
      var _a3;
    ...
    } }) : p(xu, K({ key: "header" }, ye, xe, { onClick: s.value !== "month" ? R : void 0 }), { prepend: a.prepend, append: a.append }), default: () => b(ge, null, [p(wu, K(ae, { disabled: A.value, viewMode: s.value, text: w.value, monthText: g.value, yearText: C.value, "onClick:next": L, "onClick:prev": W, "onClick:nextYear": N, "onClick:prevYear": Z, "onClick:month": $, "onClick:year": Y }), { default: a.controls }), p(Ho, { hideOnLeave: true }, { default: () => [s.value === "months" ? p(_u, K({ key: "date-picker-months" }, fe, { modelValue: m.value, "onUpdate:modelValue": [(he) => m.value = he, j], min: u.value, max: c.value, year: h.value, allowedMonths: E.value }), { month: a.month }) : s.value === "year" ? p(Vu, K({ key: "date-picker-years" }, Ae, { modelValue: h.value, "onUpdate:modelValue": [(he) => h.value = he, O], min: u.value, max: c.value, allowedYears: P.value }), { year: a.year }) : p(Cu, K({ key: "date-picker-month" }, ne, { modelValue: r.value, "onUpdate:modelValue": (he) => r.value = he, month: m.value, "onUpdate:month": [(he) => m.value = he, j], year: h.value, "onUpdate:year": [(he) => h.value = he, O], min: u.value, max: c.value }), { day: a.day })] })]), actions: a.actions });
  }), {};
  ...
  return rt(Xo, a), te(() => {
    ...
    return p(e.tag, { class: ee(["v-expansion-panel", { "v-expansion-panel--active": a.isSelected.value, "v-expansion-panel--before-active": c.value, "v-expansion-panel--after-active": d.value, "v-expansion-panel--disabled": s.value }, r.value, l.value, e.class]), style: ve([o.value, e.style]) }, { default: () => [b("div", { class: ee(["v-expansion-panel__shadow", ...i.value]) }, null), p(Be, { defaults: { VExpansionPanelTitle: { ...S }, VExpansionPanelText: { ...m } } }, { default: () => {
      var _a3;
  ...
  return te(() => {
    ...
    return b("div", { ref: c, class: ee(["v-fab", { "v-fab--absolute": e.absolute, "v-fab--app": !!e.app, "v-fab--extended": e.extended, "v-fab--offset": e.offset, [`v-fab--${s.value}`]: r.value, [`v-fab--${u.value}`]: r.value }, e.class]), style: ve([e.app ? { ...o.value } : { height: e.absolute ? "100%" : "inherit" }, e.style]) }, [b("div", { class: "v-fab__container" }, [p(Yt, { appear: e.appear, transition: e.transition }, { default: () => [at(p(ze, K({ ref: i }, d, { active: void 0, location: void 0 }), n), [[Mn, e.active]])] })])]);
  }), {};
} });
function xT() {
  function e(n) {
...
const IT = z({ chips: Boolean, counter: Boolean, counterSizeString: { type: String, default: "$vuetify.fileInput.counterSize" }, counterString: { type: String, default: "$vuetify.fileInput.counter" }, hideInput: Boolean, multiple: Boolean, showSize: { type: [Boolean, Number, String], default: false, validator: (e) => typeof e == "boolean" || [1e3, 1024].includes(Number(e)) }, truncateLength: { type: [Number, String], default: 22 }, ...Le(Sa({ prependIcon: "$file" }), ["direction"]), modelValue: { type: [Array, Object], default: (e) => e.multiple ? [] : null, validator: (e) => ot(e).every((t) => t != null && typeof t == "object") }, ...CT(), ...mi({ clearable: true }) }, "VFileInput"), PT = J()({ name: "VFileInput", inheritAttrs: false, props: IT(), emits: { "click:control": (e) => true, "mousedown:control": (e) => true, "update:focused": (e) => true, "update:modelValue": (e) => true, rejected: (e) => true }, setup(e, t) {
  let { attrs: n, emit: a, slots: l } = t;
  const { t: o } = Qe(), { filterAccepted: i } = _T(e), r = we(e, "modelValue", e.modelValue, (R) => ot(R), (R) => !e.multiple && Array.isArray(R) ? R[0] : R), { isFocused: s, focus: u, blur: c } = pa(e), d = _(() => typeof e.showSize != "boolean" ? e.showSize : void 0), f = _(() => (r.value ?? []).reduce((R, $) => {
    let { size: Y = 0 } = $;
    return R + Y;
  ...
  return re(r, (R) => {
    ...
    return p(Ot, K({ ref: y, modelValue: e.multiple ? r.value : r.value[0], class: ["v-file-input", { "v-file-input--chips": !!e.chips, "v-file-input--dragging": w.value, "v-file-input--hide": e.hideInput, "v-input--plain-underlined": V.value }, e.class], style: e.style, "onClick:prepend": A }, Y, U, { centerAffix: !V.value, focused: s.value }), { ...l, default: (Ae) => {
      ...
      return p(La, K({ ref: h, prependIcon: e.prependIcon, onMousedown: P, onClick: E, "onClick:prependInner": e["onClick:prependInner"], "onClick:appendInner": e["onClick:appendInner"] }, ae, { id: xe.value, active: I.value || F.value, dirty: F.value || e.dirty, disabled: he.value, focused: s.value, details: ue.value, error: Q.value === false, onDragover: T, onDrop: W }), { ...l, default: (oe) => {
        ...
        }, onChange: N, onDragleave: L, onFocus: x, onBlur: c }, be, j), null), b("div", { class: ee(se) }, [!!((_a3 = r.value) == null ? void 0 : _a3.length) && !e.hideInput && (l.selection ? l.selection({ fileNames: S.value, totalBytes: f.value, totalBytesReadable: v.value }) : e.chips ? S.value.map((G) => p(fa, { key: G, size: "small", text: G }, null)) : S.value.join(", "))])]);
      } });
    }, details: $ ? (Ae) => {
      var _a3, _b2;
      return b(ge, null, [(_a3 = l.details) == null ? void 0 : _a3.call(l, Ae), R && b(ge, null, [b("span", null, null), p(Ar, { active: !!((_b2 = r.value) == null ? void 0 : _b2.length), value: m.value, disabled: e.disabled }, l.counter)])]);
    } : void 0 });
  }), Pt({}, y, h, k);
...
const FT = J()({ name: "VHotkey", props: BT(), setup(e) {
  const { t } = Qe(), { themeClasses: n } = qe(e), { rtlClasses: a } = _t(), { borderClasses: l } = qt(e), { roundedClasses: o } = dt(e), { elevationClasses: i } = It(e), { colorClasses: r, colorStyles: s, variantClasses: u } = ba(() => ({ color: e.color, variant: e.variant === "contained" ? "elevated" : e.variant })), c = _(() => e.platform === "auto" ? typeof navigator < "u" && /macintosh/i.test(navigator.userAgent) : e.platform === "mac"), d = _(() => e.keys ? e.keys.split(" ").map((h) => {
    ...
    const k = d.value.map((I) => {
      ...
      for (const w of I) if (Array.isArray(w)) {
        const g = w[0] === "icon" || w[0] === "symbol" ? Tv(Rt(qb, e.keyMap), "text", String(w[1]), c.value)[1] : w[1];
        V.push(v(g));
  ...
  function S(h) {
    ...
    const k = $T(e.keyMap, String(h[2]), c.value);
    return v(k);
  }
  function m(h, k) {
    ...
    return p(V, { key: k, class: ee(w), style: ve(I ? void 0 : s.value), "aria-hidden": "true", title: S(h) }, { default: () => [h[0] === "icon" ? p(Ye, { icon: h[1], "aria-hidden": "true" }, null) : v(h[1])] });
  }
  function y(h, k) {
  ...
  function h(g) {
    ...
    function x(A) {
      v(g, A), Ee(() => {
        A === "empty" || A === "error" || (A === "ok" && g === "start" && u(d() - m + c()), e.mode !== "manual" && Ee(() => {
          window.requestAnimationFrame(() => {
            window.requestAnimationFrame(() => {
              window.requestAnimationFrame(() => {
                h(g);
  ...
  return te(() => at(p(e.tag, { class: ee(["v-lazy", e.class]), style: ve([a.value, e.style]) }, { default: () => [l.value && p(Yt, { transition: e.transition, appear: true }, { default: () => {
    var _a3;
    return [(_a3 = n.default) == null ? void 0 : _a3.call(n)];
...
function aD() {
  ...
  function a(l) {
    ...
    return { x: Mv(r), y: Mv(s), get direction() {
      ...
      return d > f && u >= 0 ? "right" : d > f && u <= 0 ? "left" : f > d && c >= 0 ? "down" : f > d && c <= 0 ? "up" : lD();
    } };
  }
...
function oD(e) {
  ...
  const r = _(() => ["left", "right"].includes(i.value)), { addMovement: s, endTouch: u, getVelocity: c } = aD();
  let d = false;
...
const iD = ["start", "end", "left", "right", "top", "bottom"], rD = z({ color: String, disableResizeWatcher: Boolean, disableRouteWatcher: Boolean, expandOnHover: Boolean, floating: Boolean, modelValue: { type: Boolean, default: null }, permanent: Boolean, rail: { type: Boolean, default: null }, railWidth: { type: [Number, String], default: 56 }, scrim: { type: [Boolean, String], default: true }, image: String, temporary: Boolean, persistent: Boolean, touchless: Boolean, width: { type: [Number, String], default: 256 }, location: { type: String, default: "start", validator: (e) => iD.includes(e) }, sticky: Boolean, ...Ht(), ...pe(), ...Fc(), ...gl({ mobile: null }), ...xt(), ...hl(), ...it(), ...Le(iy(), ["disableInitialFocus"]), ...Me({ tag: "nav" }), ...Ue() }, "VNavigationDrawer"), sD = J()({ name: "VNavigationDrawer", props: rD(), emits: { "update:modelValue": (e) => true, "update:rail": (e) => true }, setup(e, t) {
  ...
  return mt({ VList: { bgColor: "transparent" } }), te(() => {
    ...
    } }), p(Da, { name: "fade-transition" }, { default: () => [A.value && (E.value || m.value) && !!e.scrim && b("div", K({ class: ["v-navigation-drawer__scrim", Z.backgroundColorClasses.value], style: [R.value, Z.backgroundColorStyles.value], onClick: () => {
...
const vD = z({ controlVariant: { type: String, default: "default" }, inset: Boolean, hideInput: Boolean, modelValue: { type: Number, default: null }, min: { type: Number, default: Number.MIN_SAFE_INTEGER }, max: { type: Number, default: Number.MAX_SAFE_INTEGER }, step: { type: Number, default: 1 }, precision: { type: Number, default: 0 }, minFractionDigits: { type: Number, default: null }, decimalSeparator: { type: String, validator: (e) => !e || e.length === 1 }, ...Le(gi(), ["modelValue", "validationValue"]) }, "VNumberInput"), mD = J()({ name: "VNumberInput", props: { ...vD() }, emits: { "update:focused": (e) => true, "update:modelValue": (e) => true }, setup(e, t) {
  let { slots: n } = t;
  const a = q(), { holdStart: l, holdStop: o } = fD({ toggleUpDown: E }), i = ao(e), r = _(() => i.isDisabled.value || i.isReadonly.value), s = ie(e.focused), { decimalSeparator: u } = Qe(), c = _(() => {
    var _a3;
  ...
  function D(O) {
    var _a3;
    if (!O.data) return;
    const U = O.target, { value: ae, selectionStart: ye, selectionEnd: ne } = U ?? {}, fe = ae ? ae.slice(0, ye) + O.data + ae.slice(ne) : O.data, Ae = s0(fe, e.precision, c.value);
    if (new RegExp(`^-?\\d*${Yi(c.value)}?\\d*$`).test(fe) || (O.preventDefault(), U.value = Ae, Ee(() => m.value = Ae)), e.precision != null) {
      ...
      e.precision === 0 && fe.endsWith(c.value) && (O.preventDefault(), U.value = Ae, Ee(() => m.value = Ae));
    }
  }
  async function M(O) {
  ...
  return te(() => {
    ...
    function ne() {
      return n.decrement ? p(Be, { key: "decrement-defaults", defaults: { VBtn: { disabled: !k.value, height: C.value, size: g.value, icon: w.value, variant: "text" } } }, { default: () => [n.decrement(A)] }) : p(ze, { "aria-hidden": "true", "data-testid": "decrement", disabled: !k.value, height: C.value, icon: w.value, key: "decrement-btn", onClick: T, onPointerdown: N, onPointerup: L, onPointercancel: L, size: g.value, variant: "text", tabindex: "-1" }, null);
    }
    function fe() {
  ...
  let { attrs: n, emit: a, slots: l } = t;
  const { densityClasses: o } = Lt(e), { dimensionStyles: i } = wt(e), { isFocused: r, focus: s, blur: u } = pa(e), c = we(e, "modelValue", "", (E) => E == null ? [] : String(E).split(""), (E) => E.join("")), { t: d } = Qe(), f = _(() => Number(e.length)), v = _(() => Array(f.value).fill(0)), S = q(-1), m = q(), y = q([]), h = _(() => y.value[S.value]);
  let k = false;
  $t(() => e.autofocus, () => {
    const E = Nl();
    E.run(() => {
  ...
  return mt({ VField: { color: B(() => e.color), bgColor: B(() => e.color), baseColor: B(() => e.baseColor), disabled: B(() => e.disabled), error: B(() => e.error), variant: B(() => e.variant), rounded: B(() => e.rounded) } }, { scoped: true }), re(c, (E) => {
    ...
    var _a3;
    const [E, D] = qn(n);
    return b("div", K({ class: ["v-otp-input", { "v-otp-input--divided": !!e.divider }, o.value, e.class], style: [e.style] }, E), [b("div", { ref: m, class: "v-otp-input__content", style: ve([i.value]) }, [v.value.map((M, T) => b(ge, null, [e.divider && T !== 0 && b("span", { class: "v-otp-input__divider" }, [e.divider]), p(La, { focused: r.value && e.focusAll || S.value === T, key: T }, { ...l, loader: void 0, default: () => b("input", { ref: (L) => y.value[T] = L, "aria-label": d(e.label, T + 1), autofocus: T === 0 && e.autofocus, autocomplete: "one-time-code", class: ee(["v-otp-input__field"]), disabled: e.disabled, inputmode: e.type === "number" ? "numeric" : "text", min: e.type === "number" ? 0 : void 0, maxlength: T === 0 ? f.value : "1", placeholder: e.placeholder, type: e.masked ? "password" : e.type === "number" ? "text" : e.type, value: c.value[T], onInput: I, onFocus: (L) => x(L, T), onBlur: A, onKeydown: w, onCompositionstart: () => k = true, onCompositionend: V, onPaste: (L) => g(T, L) }, null) })])), b("input", K({ class: "v-otp-input-input", type: "hidden" }, D, { value: c.value.join("") }), null), p(Un, { contained: true, contentClass: "v-otp-input__loader", modelValue: !!e.loading, persistent: true }, { default: () => {
      var _a4;
...
const bD = z({ scale: { type: [Number, String], default: 0.5 }, ...pe() }, "VParallax"), pD = J()({ name: "VParallax", props: bD(), setup(e, t) {
  ...
  function f() {
    !l.value || Wn() || (cancelAnimationFrame(d), d = requestAnimationFrame(() => {
      ...
      if (!v) return;
      const S = u instanceof Document ? document.documentElement.clientHeight : u.clientHeight, m = u instanceof Document ? window.scrollY : u.scrollTop, y = a.value.getBoundingClientRect().top + m, h = i.value.height, k = y + (h - S) / 2, I = yD((m - k) * c.value), V = Math.max(1, (c.value * (S - h) + h) / h);
  ...
  return te(() => {
    ...
    return p(Ot, K({ class: ["v-slider", "v-range-slider", { "v-slider--has-labels": !!n["tick-label"] || v.value, "v-slider--focused": C.value, "v-slider--pressed": y.value, "v-slider--disabled": w.value }, s.value, e.class], style: e.style, ref: r }, D, M, { focused: C.value }), { ...n, prepend: L ? (W) => {
      var _a3, _b2;
      ...
      return b("div", { class: "v-slider__container", onMousedown: g.value ? void 0 : h, onTouchstartPassive: g.value ? void 0 : k }, [b("input", { id: `${N.value}_start`, name: e.name || N.value, disabled: w.value, readonly: g.value, tabindex: "-1", value: d.value[0] }, null), b("input", { id: `${N.value}_stop`, name: e.name || N.value, disabled: w.value, readonly: g.value, tabindex: "-1", value: d.value[1] }, null), p(eb, { ref: V, start: P.value, stop: E.value }, { "tick-label": n["tick-label"] }), p(yu, K({ ref: o, "aria-describedby": Z.value, focused: C && f.value === ((_a3 = o.value) == null ? void 0 : _a3.$el), modelValue: d.value[0], "onUpdate:modelValue": (R) => d.value = [R, d.value[1]], onFocus: (R) => {
        ...
        A(), f.value = void 0;
      }, min: m.value, max: d.value[1], position: P.value, ripple: e.ripple }, T), { "thumb-label": n["thumb-label"] }), p(yu, K({ ref: i, "aria-describedby": Z.value, focused: C && f.value === ((_b2 = i.value) == null ? void 0 : _b2.$el), modelValue: d.value[1], "onUpdate:modelValue": (R) => d.value = [d.value[0], R], onFocus: (R) => {
        var _a4, _b3, _c2, _d2;
...
const Zb = z({ multiLine: Boolean, text: String, timer: [Boolean, String], timeout: { type: [Number, String], default: 5e3 }, vertical: Boolean, ...Zn({ location: "bottom" }), ...eo(), ...it(), ...bn(), ...Ue(), ...Le(vi({ transition: "v-snackbar-transition" }), ["persistent", "noClickAnimation", "retainFocus", "captureFocus", "disableInitialFocus", "scrim", "scrollStrategy", "stickToTarget", "viewportMargin"]) }, "VSnackbar"), Tu = J()({ name: "VSnackbar", props: Zb(), emits: { "update:modelValue": (e) => true }, setup(e, t) {
  let { slots: n } = t;
  const a = we(e, "modelValue"), { positionClasses: l } = to(e), { scopeId: o } = kl(), { themeClasses: i } = qe(e), { colorClasses: r, colorStyles: s, variantClasses: u } = ba(e), { roundedClasses: c } = dt(e), d = MD(() => Number(e.timeout)), f = q(), v = q(), S = ie(false), m = ie(0), y = q(), h = We(No, void 0);
  $t(() => !!h, () => {
    const E = ih();
    ct(() => {
  ...
  te(() => {
    ...
    return b(ge, null, [i.value && !!r.value && (a.default ? p(Be, { defaults: { VSnackbar: r.value } }, { default: () => [a.default({ item: r.value })] }) : p(Tu, K(S, r.value, { modelValue: o.value, "onUpdate:modelValue": (m) => o.value = m, onAfterLeave: s }), { text: a.text ? () => {
      var _a3;
...
function FD(e, t) {
  ...
  return (n ? `M${l.x} ${a - l.x + 2} L${l.x} ${l.y}` : `M${l.x} ${l.y}`) + e.map((i, r) => {
    ...
    const d = Math.min(Lv(u, i), Lv(s, i)), v = d / 2 < t ? d / 2 : t, S = Rv(u, i, v), m = Rv(s, i, v);
  ...
  return te(() => {
    ...
    return p(Ot, K({ ref: d, class: ["v-switch", { "v-switch--flat": e.flat }, { "v-switch--inset": e.inset }, { "v-switch--indeterminate": l.value }, i.value, e.class] }, k, V, { modelValue: o.value, "onUpdate:modelValue": (g) => o.value = g, id: m.value, focused: r.value, style: e.style }), { ...a, default: (g) => {
      ...
      return p($a, K({ ref: c }, w, { modelValue: o.value, "onUpdate:modelValue": [(M) => o.value = M, y], id: C.value, "aria-describedby": x.value, type: "checkbox", "aria-checked": l.value ? "mixed" : void 0, disabled: A.value, readonly: P.value, onFocus: s, onBlur: u }, I), { ...a, default: (M) => {
        ...
        return b("div", { class: ee(["v-switch__track", f ? void 0 : T.value]), style: ve(L.value), onClick: h }, [a["track-true"] && b("div", { key: "prepend", class: "v-switch__track-true" }, [a["track-true"](D)]), a["track-false"] && b("div", { key: "append", class: "v-switch__track-false" }, [a["track-false"](D)])]);
      }, input: (M) => {
        let { inputNode: T, icon: L, backgroundColorClasses: W, backgroundColorStyles: N } = M;
        return b(ge, null, [T, b("div", { class: ee(["v-switch__thumb", { "v-switch__thumb--filled": L || e.loading }, e.inset || f ? void 0 : W.value]), style: ve(e.inset ? void 0 : N.value) }, [a.thumb ? p(Be, { defaults: { VIcon: { icon: L, size: "x-small" } } }, { default: () => [a.thumb({ ...D, icon: L })] }) : p(wc, null, { default: () => [e.loading ? p(si, { name: "v-switch", active: true, color: E.value === false ? void 0 : v.value }, { default: (Z) => a.loader ? a.loader(Z) : p(Ba, { active: Z.isActive, color: Z.color, indeterminate: true, size: "16", width: "2" }, null) }) : L && p(Ye, { key: String(L), icon: L, size: "x-small" }, null)] })])]);
      } });
    } });
  }), Pt({}, d);
...
const nE = z({ alignTabs: { type: String, default: "start" }, color: String, fixedTabs: Boolean, items: { type: Array, default: () => [] }, stacked: Boolean, bgColor: String, grow: Boolean, height: { type: [Number, String], default: void 0 }, hideSlider: Boolean, inset: Boolean, insetPadding: [String, Number], insetRadius: [String, Number], sliderColor: String, ...en(rp(), ["spaced", "sliderTransition", "sliderTransitionDuration"]), ...Ac({ mandatory: "force", selectedClass: "v-tab-item--selected" }), ...gt(), ...Me() }, "VTabs"), aE = J()({ name: "VTabs", props: nE(), emits: { "update:modelValue": (e) => true }, setup(e, t) {
  let { attrs: n, slots: a } = t;
  const l = we(e, "modelValue"), o = _(() => tE(e.items)), { densityClasses: i } = Lt(e), { backgroundColorClasses: r, backgroundColorStyles: s } = Xe(() => e.bgColor), { scopeId: u } = kl();
  ...
  return re(A, (T) => {
    ...
    return p(Ot, K({ ref: f, modelValue: o.value, "onUpdate:modelValue": (Y) => o.value = Y, class: ["v-textarea v-text-field", { "v-textarea--prefixed": e.prefix, "v-textarea--suffixed": e.suffix, "v-text-field--prefixed": e.prefix, "v-text-field--suffixed": e.suffix, "v-textarea--auto-grow": e.autoGrow, "v-textarea--no-resize": e.noResize || e.autoGrow, "v-input--plain-underlined": E.value }, e.class], style: [{ "--v-textarea-max-height": e.maxHeight ? de(e.maxHeight) : void 0, "--v-textarea-scroll-bar-width": de(y.value) }, e.style] }, W, R, { centerAffix: P.value === 1 && !E.value, focused: i.value }), { ...l, default: (Y) => {
      ...
      return p(La, K({ ref: v, style: { "--v-textarea-control-height": S.value }, onClick: w, onMousedown: g, "onClick:prependInner": e["onClick:prependInner"], "onClick:appendInner": e["onClick:appendInner"] }, $, { id: j.value, active: I.value || U.value, labelId: `${j.value}-label`, centerAffix: P.value === 1 && !E.value, dirty: U.value || e.dirty, disabled: O.value, focused: i.value, details: ne.value, error: ye.value === false }), { ...l, default: (fe) => {
        ...
        return b(ge, null, [e.prefix && b("span", { class: "v-text-field__prefix" }, [e.prefix]), at(b("textarea", K({ ref: (F) => m.value = he.value = F, class: Ae, value: o.value, onInput: x, autofocus: e.autofocus, readonly: ae.value, disabled: O.value, placeholder: e.placeholder, rows: e.rows, name: k.fieldName.value, autocomplete: k.fieldAutocomplete.value, onFocus: V, onBlur: s, "aria-labelledby": `${j.value}-label` }, xe, N), null), [[Dn, { handler: u }, null, { once: true }]]), e.autoGrow && at(b("textarea", { class: ee([Ae, "v-textarea__sizer"]), id: `${xe.id}-sizer`, "onUpdate:modelValue": (F) => o.value = F, ref: A, readonly: true, "aria-hidden": "true" }, null), [[Rk, o.value]]), e.suffix && b("span", { class: "v-text-field__suffix" }, [e.suffix])]);
      } });
    }, details: L ? (Y) => {
      var _a3;
  ...
  bt(R), te(() => b("div", { class: ee([{ "v-time-picker-clock": true, "v-time-picker-clock--indeterminate": e.modelValue == null, "v-time-picker-clock--readonly": e.readonly }]), onMousedown: N, onTouchstart: N, onWheel: C, ref: a }, [b("div", { class: "v-time-picker-clock__inner", ref: l }, [b("div", { class: ee([{ "v-time-picker-clock__hand": true, "v-time-picker-clock__hand--inner": x(e.modelValue) }, c.value]), style: ve([{ transform: `rotate(${e.rotate + y.value * (k.value - e.min)}deg) scaleY(${A(k.value)})` }, d.value]) }, null), V.value.map(($) => {
    const Y = $ === k.value;
    return b("div", { class: ee([{ "v-time-picker-clock__item": true, "v-time-picker-clock__item--active": Y, "v-time-picker-clock__item--disabled": e.disabled || !g($) }, Y && f.value]), style: ve([D($), Y && v.value]) }, [b("span", null, [e.format($)])]);
  })])]));
...
function mp(e) {
  ...
  function l(o, i, r) {
    ...
    const c = o === "hour" ? t.value : o === "minute" ? (v) => n.value(s, v) : (v) => a.value(s, u, v), d = o === "hour" ? (v) => gE(v, r).value : (v) => hE(v, r), f = o === "hour" ? 24 : 60;
...
const yE = z({ ampm: Boolean, color: String, disabled: Boolean, inputHints: Boolean, hour: [Number, String], minute: [Number, String], second: [Number, String], period: String, readonly: Boolean, useSeconds: Boolean, value: Number, viewMode: String, ...vp() }, "VTimePickerControls"), Eu = J()({ name: "VTimePickerControls", props: yE(), emits: { "update:period": (e) => true, "update:viewMode": (e) => true, "update:hour": (e) => true, "update:minute": (e) => true, "update:second": (e) => true }, setup(e, t) {
  ...
  let { emit: n, slots: a } = t;
  const { t: l } = Qe(), { densityClasses: o } = Lt(e), i = q(null), r = q(null), s = q(null), u = q(null), c = q(null), d = q(null), f = we(e, "period", "am"), v = we(e, "viewMode", "hour"), S = q(null), m = q(null), y = _(() => e.format === "ampm"), { isAllowedHour: h, isAllowedMinute: k, isAllowedSecond: I } = mp(e), V = B(() => e.modelValue !== null && i.value === null && r.value === null && (!e.useSeconds || s.value === null));
  function w() {
    const P = g();
  ...
  te(() => {
    ...
    }, header: () => p(Eu, K(E, { ampm: y.value, hour: i.value, minute: r.value, period: f.value, second: s.value, viewMode: v.value, inputHints: e.variant === "input", "onUpdate:hour": (T) => i.value = T, "onUpdate:minute": (T) => r.value = T, "onUpdate:second": (T) => s.value = T, "onUpdate:period": (T) => f.value = T, "onUpdate:viewMode": (T) => v.value = T, ref: S }), null), default: () => p(Du, K(D, { allowedValues: M, double: v.value === "hour" && !y.value, format: v.value === "hour" ? y.value ? fp : (T) => T : (T) => rn(T, 2), max: v.value === "hour" ? y.value && f.value === "am" ? 11 : 23 : 59, min: v.value === "hour" && y.value && f.value === "pm" ? 12 : 0, size: 20, step: v.value === "hour" ? 1 : 5, modelValue: v.value === "hour" ? i.value : v.value === "minute" ? r.value : s.value, onChange: A, onInput: x, ref: m }), null), actions: a.actions });
  });
  ...
  return () => {
    ...
    return ((_a3 = n.default) == null ? void 0 : _a3.call(n)) ?? ((_b2 = e.items) == null ? void 0 : _b2.map((s, u, c) => {
      ...
      } }) : wi(n.item, { props: f, item: s.raw, internalItem: s }, () => s.type === "divider" ? wi(n.divider, { props: s.raw }, () => p(vn, s.props, null)) : s.type === "subheader" ? wi(n.subheader, { props: s.raw }, () => p(lo, s.props, null)) : p(Bu, K(f, { hasCustomPrepend: !!n.prepend, hideActions: e.hideActions, indentLines: k.leaf, value: e.returnObject ? Te(s.raw) : f.value }), I));
    }));
  };
} });
function pp(e) {
...
function ME(e, t) {
  return function(n, a, l) {
    var _a3, _b2, _c2;
    const o = typeof t == "function" ? t(a) : t, i = ((_a3 = a.value) == null ? void 0 : _a3.text) ?? a.value ?? (o == null ? void 0 : o.text), r = il(a.value) ? a.value : {}, s = () => i ?? n.textContent, u = (l.ctx === a.instance.$ ? (_b2 = BE(l, a.instance.$)) == null ? void 0 : _b2.provides : (_c2 = l.ctx) == null ? void 0 : _c2.provides) ?? a.instance.$.provides, c = ma(e, K(o, r), s);
