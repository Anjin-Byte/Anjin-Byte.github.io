...
let h;
let __tla = (async ()=>{
    var O = "/assets/game_of_life_gpu_bg-50NGi1VO.wasm";
    h = class {
        static __wrap(_) {
            _ = _ >>> 0;
...
${e.stack}` : n;
    ...
    var tr = Object.freeze({
        ...
        gpugameoflife_set_transition: Mn,
