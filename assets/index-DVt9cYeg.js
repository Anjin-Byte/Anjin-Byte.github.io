...
function Kk() {
  ...
  function i(s, u) {
    const c = new Worker(new URL("/assets/backgroundRenderer-BS2Yizk8.js", import.meta.url), { type: "module" });
