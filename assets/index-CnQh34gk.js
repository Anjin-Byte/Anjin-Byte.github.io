...
const Ee = {}, zn = [], jt = () => {
}, ou = () => false, rs = (e) => e.charCodeAt(0) === 111 && e.charCodeAt(1) === 110 && (e.charCodeAt(2) > 122 || e.charCodeAt(2) < 97), jo = (e) => e.startsWith("onUpdate:"), je = Object.assign, Wo = (e, t) => {
  const n = e.indexOf(t);
  n > -1 && e.splice(n, 1);
}, dm = Object.prototype.hasOwnProperty, xe = (e, t) => dm.call(e, t), se = Array.isArray, Gn = (e) => ii(e) === "[object Map]", au = (e) => ii(e) === "[object Set]", Ba = (e) => ii(e) === "[object Date]", ue = (e) => typeof e == "function", De = (e) => typeof e == "string", Mt = (e) => typeof e == "symbol", Se = (e) => e !== null && typeof e == "object", lu = (e) => (Se(e) || ue(e)) && ue(e.then) && ue(e.catch), cu = Object.prototype.toString, ii = (e) => cu.call(e), mm = (e) => ii(e).slice(8, -1), uu = (e) => ii(e) === "[object Object]", is = (e) => De(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e, kr = Bo(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"), ss = (e) => {
  const t = /* @__PURE__ */ Object.create(null);
  return ((n) => t[n] || (t[n] = e(n)));
}, hm = /-\w/g, _t = ss((e) => e.replace(hm, (t) => t.slice(1).toUpperCase())), gm = /\B([A-Z])/g, On = ss((e) => e.replace(gm, "-$1").toLowerCase()), fr = ss((e) => e.charAt(0).toUpperCase() + e.slice(1)), Ls = ss((e) => e ? `on${fr(e)}` : ""), dn = (e, t) => !Object.is(e, t), Es = (e, ...t) => {
...
let ja;
const os = () => ja || (ja = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : typeof global < "u" ? global : {});
function He(e) {
  if (se(e)) {
    const t = {};
    for (let n = 0; n < e.length; n++) {
      const r = e[n], i = De(r) ? wm(r) : He(r);
...
function wm(e) {
  const t = {};
  return e.replace(_m, "").split(ym).forEach((n) => {
    if (n) {
      const r = n.split(bm);
...
const Sm = "itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly", Cm = Bo(Sm);
function du(e) {
  return !!e || e === "";
}
function xm(e, t) {
...
function zo(e, t) {
  ...
  if (n = se(e), r = se(t), n || r) return n && r ? xm(e, t) : false;
...
const mu = (e) => !!(e && e.__v_isRef === true), ye = (e) => De(e) ? e : e == null ? "" : se(e) || Se(e) && (e.toString === cu || !ue(e.toString)) ? mu(e) ? ye(e.value) : JSON.stringify(e, hu, 2) : String(e), hu = (e, t) => mu(t) ? hu(e, t.value) : Gn(t) ? { [`Map(${t.size})`]: [...t.entries()].reduce((n, [r, i], s) => (n[Ms(r, s) + " =>"] = i, n), {}) } : au(t) ? { [`Set(${t.size})`]: [...t.values()].map((n) => Ms(n)) } : Mt(t) ? Ms(t) : Se(t) && !se(t) && !uu(t) ? String(t) : t, Ms = (e, t = "") => {
  var n;
...
class pu {
  ...
  run() {
    ...
    this.flags |= 2, Wa(this), _u(this);
    const t = Te, n = Et;
    Te = this, Et = true;
    try {
      return this.fn();
    } finally {
      wu(this), Te = t, Et = n, this.flags &= -3;
    }
  }
  stop() {
    if (this.flags & 1) {
...
function wu(e) {
  ...
  for (; r; ) {
    const i = r.prevDep;
    r.version === -1 ? (r === n && (n = i), Zo(r), Am(r)) : t = r, r.dep.activeLink = r.prevActiveLink, r.prevActiveLink = void 0, r = i;
  }
  e.deps = t, e.depsTail = n;
}
function ro(e) {
  for (let t = e.deps; t; t = t.nextDep) if (t.dep.version !== t.version || t.dep.computed && (Su(t.dep.computed) || t.dep.version !== t.version)) return true;
  return !!e._dirty;
}
function Su(e) {
  if (e.flags & 4 && !(e.flags & 16) || (e.flags &= -17, e.globalVersion === jr) || (e.globalVersion = jr, !e.isSSR && e.flags & 128 && (!e.deps && !e._dirty || !ro(e)))) return;
  e.flags |= 2;
...
function Zo(e, t = false) {
  ...
  if (r && (r.nextSub = i, e.prevSub = void 0), i && (i.prevSub = r, e.nextSub = void 0), n.subs === e && (n.subs = r, !r && n.computed)) {
    n.computed.flags &= -5;
    for (let s = n.computed.deps; s; s = s.nextDep) Zo(s, true);
  }
...
class Ko {
  ...
  track(t) {
    ...
    if (n === void 0 || n.sub !== Te) n = this.activeLink = new Lm(Te, this), Te.deps ? (n.prevDep = Te.depsTail, Te.depsTail.nextDep = n, Te.depsTail = n) : Te.deps = Te.depsTail = n, xu(n);
...
const Di = /* @__PURE__ */ new WeakMap(), Mn = Symbol(""), io = Symbol(""), Wr = Symbol("");
function et(e, t, n) {
  if (Et && Te) {
    let r = Di.get(e);
    r || Di.set(e, r = /* @__PURE__ */ new Map());
    let i = r.get(n);
    i || (r.set(n, i = new Ko()), i.map = r, i.key = n), i.track();
  }
}
function Xt(e, t, n, r, i, s) {
  ...
  if (Go(), t === "clear") o.forEach(a);
  else {
    const l = se(e), u = l && is(n);
    if (l && n === "length") {
      const c = Number(r);
      o.forEach((f, d) => {
        (d === "length" || d === Wr || !Mt(d) && d >= c) && a(f);
      });
    } else switch ((n !== void 0 || o.has(void 0)) && a(o.get(n)), u && a(o.get(Wr)), t) {
      case "add":
        l ? u && a(o.get("length")) : (a(o.get(Mn)), Gn(e) && a(o.get(io)));
        break;
      case "delete":
        l || (a(o.get(Mn)), Gn(e) && a(o.get(io)));
        break;
      case "set":
        Gn(e) && a(o.get(Mn));
        break;
...
function Vn(e) {
  const t = te(e);
  return t === e ? t : (et(t, "iterate", Wr), bt(e) ? t : t.map(kt));
}
function as(e) {
  return et(e = te(e), "iterate", Wr), e;
}
function cn(e, t) {
  return nn(e) ? er(kn(e) ? kt(t) : t) : kt(t);
}
const Mm = { __proto__: null, [Symbol.iterator]() {
  return Ts(this, Symbol.iterator, (e) => cn(this, e));
}, concat(...e) {
  return Vn(this).concat(...e.map((t) => se(t) ? Vn(t) : t));
}, entries() {
  return Ts(this, "entries", (e) => (e[1] = cn(this, e[1]), e));
}, every(e, t) {
  ...
  return Ts(this, "values", (e) => cn(this, e));
} };
function Ts(e, t, n) {
  const r = as(e), i = r[t]();
...
const km = Array.prototype;
function Ut(e, t, n, r, i, s) {
  const o = as(e), a = o !== e && !bt(e), l = o[t];
  if (l !== km[t]) {
    const f = l.apply(e, s);
    return a ? kt(f) : f;
  }
...
function Ps(e, t, n) {
  ...
  et(r, "iterate", Wr);
  const i = r[t](...n);
  return (i === -1 || i === false) && ls(n[0]) ? (n[0] = te(n[0]), r[t](...n)) : i;
}
function _r(e, t, n = []) {
  en(), Go();
...
const Tm = Bo("__proto__,__v_isRef,__isVue"), Au = new Set(Object.getOwnPropertyNames(Symbol).filter((e) => e !== "arguments" && e !== "caller").map((e) => Symbol[e]).filter(Mt));
function Pm(e) {
  Mt(e) || (e = String(e));
  const t = te(this);
...
class Lu {
  ...
  get(t, n, r) {
    ...
    if (n === "__v_raw") return r === (i ? s ? Bm : Tu : s ? ku : Mu).get(t) || Object.getPrototypeOf(t) === Object.getPrototypeOf(r) ? t : void 0;
    const o = se(t);
    if (!i) {
      let l;
      if (o && (l = Mm[n])) return l;
      if (n === "hasOwnProperty") return Pm;
    }
    const a = Reflect.get(t, n, Ve(t) ? t : r);
    if ((Mt(n) ? Au.has(n) : Tm(n)) || (i || et(t, "get", n), s)) return a;
    if (Ve(a)) {
      const l = o && is(n) ? a : a.value;
      return i && Se(l) ? Qn(l) : l;
    }
    return Se(a) ? i ? Qn(a) : Ue(a) : a;
  }
}
class Eu extends Lu {
  constructor(t = false) {
  ...
  has(t, n) {
    ...
    return (!Mt(n) || !Au.has(n)) && et(t, "has", n), r;
  }
  ownKeys(t) {
    return et(t, "iterate", se(t) ? "length" : Mn), Reflect.ownKeys(t);
  }
}
class Rm extends Lu {
  constructor(t = false) {
...
const Im = new Eu(), Om = new Rm(), Vm = new Eu(true);
const so = (e) => e, Si = (e) => Reflect.getPrototypeOf(e);
function Dm(e, t, n) {
  return function(...r) {
    const i = this.__v_raw, s = te(i), o = Gn(s), a = e === "entries" || e === Symbol.iterator && o, l = e === "keys" && o, u = i[e](...r), c = n ? so : t ? er : kt;
    return !t && et(s, "iterate", l ? io : Mn), je(Object.create(u), { next() {
...
const Nm = { get: Yo(false, false) }, Fm = { get: Yo(false, true) }, $m = { get: Yo(true, false) };
const Mu = /* @__PURE__ */ new WeakMap(), ku = /* @__PURE__ */ new WeakMap(), Tu = /* @__PURE__ */ new WeakMap(), Bm = /* @__PURE__ */ new WeakMap();
function jm(e) {
  switch (e) {
    case "Object":
    case "Array":
...
function Wm(e) {
  return e.__v_skip || !Object.isExtensible(e) ? 0 : jm(mm(e));
}
function Ue(e) {
  return nn(e) ? e : qo(e, false, Im, Nm, Mu);
}
function Pu(e) {
  return qo(e, false, Vm, Fm, ku);
}
function Qn(e) {
  return qo(e, true, Om, $m, Tu);
}
...
function zm(e) {
  return !xe(e, "__v_skip") && Object.isExtensible(e) && fu(e, "__v_skip", true), e;
}
const kt = (e) => Se(e) ? Ue(e) : e, er = (e) => Se(e) ? Qn(e) : e;
function Ve(e) {
...
function Ru(e, t) {
  return Ve(e) ? e : new Gm(e, t);
}
class Gm {
  constructor(t, n) {
    this.dep = new Ko(), this.__v_isRef = true, this.__v_isShallow = false, this._rawValue = n ? t : te(t), this._value = n ? t : kt(t), this.__v_isShallow = n;
  }
  get value() {
...
const Um = { get: (e, t, n) => t === "__v_raw" ? e : re(Reflect.get(e, t, n)), set: (e, t, n, r) => {
  const i = e[t];
  return Ve(i) && !Ve(n) ? (i.value = n, true) : Reflect.set(e, t, n, r);
} };
function Iu(e) {
  return kn(e) ? e : new Proxy(e, Um);
}
function Ou(e) {
...
function B(e, t, n) {
  return Ve(e) ? e : ue(e) ? new Km(e) : Se(e) && arguments.length > 1 ? Vu(e, t, n) : X(e);
}
function Vu(e, t, n) {
  return new Zm(e, t, n);
}
class Ym {
  constructor(t, n, r) {
    this.fn = t, this.setter = n, this._value = void 0, this.dep = new Ko(this), this.__v_isRef = true, this.deps = void 0, this.depsTail = void 0, this.flags = 16, this.globalVersion = jr - 1, this.next = void 0, this.effect = this, this.__v_isReadonly = !n, this.isSSR = r;
  }
  notify() {
    if (this.flags |= 16, !(this.flags & 8) && Te !== this) return bu(this, true), true;
  }
  get value() {
...
function qm(e, t, n = false) {
  let r, i;
  return ue(e) ? r = e : (r = e.get, i = e.set), new Ym(r, i, n);
}
const xi = {}, Hi = /* @__PURE__ */ new WeakMap();
let xn;
function Xm(e, t = false, n = xn) {
  if (n) {
    let r = Hi.get(n);
    r || Hi.set(n, r = []), r.push(e);
  }
}
function Jm(e, t, n = Ee) {
  ...
  const S = vu(), v = () => {
    c.stop(), S && S.active && Wo(S.effects, c);
  };
  if (s && t) {
    const _ = t;
    t = (...x) => {
  ...
  const A = (_) => {
    if (!(!(c.flags & 1) || !c.dirty && !_)) if (t) {
      const x = c.run();
      if (i || b || (g ? x.some((E, P) => dn(E, y[P])) : dn(x, y))) {
        d && d();
        const E = xn;
        xn = c;
        try {
          const P = [x, y === xi ? void 0 : g && y[0] === xi ? [] : y, m];
          y = x, l ? l(t, 3, P) : t(...P);
        } finally {
          xn = E;
        }
  ...
  return a && a(A), c = new pu(f), c.scheduler = o ? () => o(A, false) : A, m = (_) => Xm(_, false, c), d = c.onStop = () => {
    const _ = Hi.get(c);
    if (_) {
      if (l) l(_, 4);
...
function Qm(e, t, n, r = true, i = false) {
  if (i) throw e;
  console.error(e);
}
const lt = [];
...
function Xo(e) {
  if (!(e.flags & 1)) {
    ...
    !n || !(e.flags & 2) && t >= zr(n) ? lt.push(e) : lt.splice(eh(t), 0, e), e.flags |= 1, Hu();
  }
}
function Hu() {
  Ni || (Ni = Du.then(Fu));
...
function th(e) {
  se(e) ? Un.push(...e) : un && e.id === -1 ? un.splice(Fn + 1, 0, e) : e.flags & 1 || (Un.push(e), e.flags |= 1), Hu();
}
function Ga(e, t, n = Nt + 1) {
  for (; n < lt.length; n++) {
    const r = lt[n];
    if (r && r.flags & 2) {
...
function Nu(e) {
  if (Un.length) {
    const t = [...new Set(Un)].sort((n, r) => zr(n) - zr(r));
    if (Un.length = 0, un) {
      un.push(...t);
      return;
    }
...
function Fu(e) {
  try {
    ...
    Nt = -1, lt.length = 0, Nu(), Ni = null, (lt.length || Un.length) && Fu();
  }
}
let Ke = null, $u = null;
function Fi(e) {
  const t = Ke;
  return Ke = e, $u = e && e.type.__scopeId || null, t;
}
function $e(e, t = Ke, n) {
  if (!t || e._n) return e;
  const r = (...i) => {
...
const nh = Symbol.for("v-scx"), rh = () => Me(nh);
function gn(e, t) {
  return Jo(e, null, t);
}
function le(e, t, n) {
...
function ih(e, t, n) {
  const r = this.proxy, i = De(e) ? e.includes(".") ? Bu(r, e) : () => r[e] : e.bind(r, r);
  let s;
  ue(t) ? s = t : (s = t.handler, n = t);
  const o = ui(this), a = Jo(i, s.bind(r), n);
  return o(), a;
}
function Bu(e, t) {
  const n = t.split(".");
...
const ju = Symbol("_vte"), Wu = (e) => e.__isTeleport, Rr = (e) => e && (e.disabled || e.disabled === ""), Ua = (e) => e && (e.defer || e.defer === ""), Za = (e) => typeof SVGElement < "u" && e instanceof SVGElement, Ka = (e) => typeof MathMLElement == "function" && e instanceof MathMLElement, oo = (e, t) => {
  const n = e && e.to;
  ...
  if (e == null) {
    ...
    const P = (D, R) => {
      ...
      D && (o !== "svg" && Za(D) ? o = "svg" : o !== "mathml" && Ka(D) && (o = "mathml"), i && i.isCE && (i.ce._teleportTargets || (i.ce._teleportTargets = /* @__PURE__ */ new Set())).add(D), v || (P(D, R), Ti(t, false)));
    };
    v && (P(n, E), Ti(t, true)), Ua(t.props) ? (t.el.__isMounted = false, Xe(() => {
      w(), delete t.el.__isMounted;
    }, s)) : w();
  } else {
    if (Ua(t.props) && e.el.__isMounted === false) {
      Xe(() => {
    ...
    const x = t.anchor = e.anchor, E = t.target = e.target, P = t.targetAnchor = e.targetAnchor, w = Rr(e.props), D = w ? n : E, R = w ? x : P;
    if (o === "svg" || Za(E) ? o = "svg" : (o === "mathml" || Ka(E)) && (o = "mathml"), _ ? (d(e.dynamicChildren, _, D, i, s, o, a), ra(e, t, true)) : l || f(e, t, D, R, i, s, o, a, false), v) w ? t.props && e.props && t.props.to !== e.props.to && (t.props.to = e.props.to) : Ai(t, n, x, u, 1);
...
function sh(e, t, n, r, i, s, { o: { nextSibling: o, parentNode: a, querySelector: l, insert: u, createText: c } }, f) {
  function d(S, v) {
    let y = v;
    for (; y; ) {
      if (y && y.nodeType === 8) {
  ...
  const b = t.target = oo(t.props, l), g = Rr(t.props);
  if (b) {
    const S = b._lpa || b.firstChild;
    t.shapeFlag & 16 && (g ? (m(e, t), d(b, S), t.targetAnchor || ao(b, t, c, u, a(e) === b ? e : null)) : (t.anchor = o(e), d(b, S), t.targetAnchor || ao(b, t, c, u), f(S && o(S), t, b, n, r, i, s))), Ti(t, g);
...
function ao(e, t, n, r, i = null) {
  ...
  return s[ju] = o, e && (r(s, e, i), r(o, e, i)), o;
}
const Ft = Symbol("_leaveCb"), wr = Symbol("_enterCb");
function Gu() {
...
const St = [Function, Array], Uu = { mode: String, appear: Boolean, persisted: Boolean, onBeforeEnter: St, onEnter: St, onAfterEnter: St, onEnterCancelled: St, onBeforeLeave: St, onLeave: St, onAfterLeave: St, onLeaveCancelled: St, onBeforeAppear: St, onAppear: St, onAfterAppear: St, onAppearCancelled: St }, Zu = (e) => {
  const t = e.subTree;
  return t.component ? Zu(t.component) : t;
}, ah = { name: "BaseTransition", props: Uu, setup(e, { slots: t }) {
  const n = ci(), r = Gu();
  return () => {
    const i = t.default && Qo(t.default(), true);
    if (!i || !i.length) return;
    const s = Ku(i), o = te(e), { mode: a } = o;
    if (r.isLeaving) return Rs(s);
    const l = Ya(s);
    if (!l) return Rs(s);
    let u = Gr(l, o, r, n, (f) => u = f);
    l.type !== tt && In(l, u);
    let c = n.subTree && Ya(n.subTree);
    if (c && c.type !== tt && !Ln(c, l) && Zu(n).type !== tt) {
      let f = Gr(c, o, r, n);
...
function Gr(e, t, n, r, i) {
  const { appear: s, mode: o, persisted: a = false, onBeforeEnter: l, onEnter: u, onAfterEnter: c, onEnterCancelled: f, onBeforeLeave: d, onLeave: m, onAfterLeave: b, onLeaveCancelled: g, onBeforeAppear: S, onAppear: v, onAfterAppear: y, onAppearCancelled: A } = t, _ = String(e.key), x = Yu(n, e), E = (D, R) => {
    D && Tt(D, r, 9, R);
  }, P = (D, R) => {
    const N = R[1];
    ...
    if (x[_] === e) return;
    let R = u, N = c, M = f;
    if (!n.isMounted) if (s) R = v || u, N = y || c, M = A || f;
    else return;
    let $ = false;
    D[wr] = (Z) => {
      $ || ($ = true, Z ? E(M, [D]) : E(N, [D]), w.delayedLeave && w.delayedLeave(), D[wr] = void 0);
    };
    const Y = D[wr].bind(null, false);
    R ? P(R, [D, Y]) : Y();
  }, leave(D, R) {
    const N = String(e.key);
    if (D[wr] && D[wr](true), n.isUnmounting) return R();
    E(d, [D]);
    let M = false;
    D[Ft] = (Y) => {
    ...
    const R = Gr(D, t, n, r, i);
    return i && i(R), R;
  } };
  return w;
}
function Rs(e) {
  if (us(e)) return e = hn(e), e.children = null, e;
}
function Ya(e) {
  if (!us(e)) return Wu(e.type) && e.children ? Ku(e.children) : e;
...
function Qo(e, t = false, n) {
  let r = [], i = 0;
  for (let s = 0; s < e.length; s++) {
    let o = e[s];
    const a = n == null ? o.key : String(n) + String(o.key != null ? o.key : s);
    o.type === _e ? (o.patchFlag & 128 && i++, r = r.concat(Qo(o.children, t, a))) : (t || o.type !== tt) && r.push(a != null ? hn(o, { key: a }) : o);
  }
...
function Ir(e, t, n, r, i = false) {
  ...
  const s = r.shapeFlag & 4 ? hs(r.component) : r.el, o = i ? null : s, { i: a, r: l } = e, u = t && t.r, c = a.refs === Ee ? a.refs = {} : a.refs, f = a.setupState, d = te(f), m = f === Ee ? ou : (g) => qa(c, g) ? false : xe(d, g), b = (g, S) => !(S && qa(c, S));
  if (u != null && u !== l) {
    if (Xa(t), De(u)) c[u] = null, m(u) && (f[u] = null);
    else if (Ve(u)) {
      const g = t;
...
function Xa(e) {
  const t = $i.get(e);
  t && (t.flags |= 8, $i.delete(e));
}
os().requestIdleCallback;
os().cancelIdleCallback;
const Zn = (e) => !!e.type.__asyncLoader, us = (e) => e.type.__isKeepAlive;
function ch(e, t) {
  Ju(e, "a", t);
}
function Xu(e, t) {
...
function Ju(e, t, n = nt) {
  ...
  if (fs(t, r, n), n) {
    let i = n.parent;
    for (; i && i.parent; ) us(i.parent.vnode) && uh(r, t, n, i), i = i.parent;
  }
}
function uh(e, t, n, r) {
  const i = fs(t, e, r, true);
  ai(() => {
    Wo(r[t], i);
  }, n);
}
function fs(e, t, n = nt, r = false) {
  if (n) {
...
const rn = (e) => (t, n = nt) => {
  (!Kr || e === "sp") && fs(e, (...r) => t(...r), n);
}, ds = rn("bm"), Wt = rn("m"), fh = rn("bu"), ea = rn("u"), zt = rn("bum"), ai = rn("um"), dh = rn("sp"), mh = rn("rtg"), hh = rn("rtc");
function gh(e, t = nt) {
  fs("ec", e, t);
}
const Qu = "components";
function ef(e, t) {
  return tf(Qu, e, true, t) || e;
}
const vh = Symbol.for("v-ndc");
function ph(e) {
  return De(e) && tf(Qu, e, false) || e;
}
function tf(e, t, n = true, r = false) {
  const i = Ke || nt;
  if (i) {
    const s = i.type;
    {
      const a = t1(s, false);
      if (a && (a === t || a === _t(t) || a === fr(_t(t)))) return s;
    }
    const o = Ja(i[e] || s[e], t) || Ja(i.appContext[e], t);
    return !o && r ? s : o;
  }
}
function Ja(e, t) {
  return e && (e[t] || e[_t(t)] || e[fr(_t(t))]);
}
function ht(e, t, n, r) {
  let i;
  const s = n, o = se(e);
  if (o || De(e)) {
    const a = o && kn(e);
    let l = false, u = false;
    a && (l = !bt(e), u = nn(e), e = as(e)), i = new Array(e.length);
    for (let c = 0, f = e.length; c < f; c++) i[c] = t(l ? u ? er(kt(e[c])) : kt(e[c]) : e[c], c, void 0, s);
...
function yh(e, t, n = {}, r, i) {
  if (Ke.ce || Ke.parent && Zn(Ke.parent) && Ke.parent.ce) {
    ...
    return ce(), nr(_e, null, [T("slot", n, r)], u ? -2 : 64);
  }
  let s = e[t];
  s && s._c && (s._d = false), ce();
  const o = s && nf(s(n)), a = n.key || o && o.key, l = nr(_e, { key: (a && !Mt(a) ? a : `_${t}`) + (!o && r ? "_fb" : "") }, o || [], o && e._ === 1 ? 64 : -2);
  return s && s._c && (s._d = true), l;
}
function nf(e) {
  return e.some((t) => Zr(t) ? !(t.type === tt || t.type === _e && !nf(t.children)) : true) ? e : null;
}
const lo = (e) => e ? Sf(e) ? hs(e) : lo(e.parent) : null, Or = je(/* @__PURE__ */ Object.create(null), { $: (e) => e, $el: (e) => e.vnode.el, $data: (e) => e.data, $props: (e) => e.props, $attrs: (e) => e.attrs, $slots: (e) => e.slots, $refs: (e) => e.refs, $parent: (e) => lo(e.parent), $root: (e) => lo(e.root), $host: (e) => e.ce, $emit: (e) => e.emit, $options: (e) => sf(e), $forceUpdate: (e) => e.f || (e.f = () => {
  Xo(e.update);
}), $nextTick: (e) => e.n || (e.n = dt.bind(e.proxy)), $watch: (e) => ih.bind(e) }), Is = (e, t) => e !== Ee && !e.__isScriptSetup && xe(e, t), bh = { get({ _: e }, t) {
  ...
  return Is(i, t) ? (i[t] = n, true) : r !== Ee && xe(r, t) ? (r[t] = n, true) : xe(e.props, t) || t[0] === "$" && t.slice(1) in e ? false : (s[t] = n, true);
}, has({ _: { data: e, setupState: t, accessCache: n, ctx: r, appContext: i, props: s, type: o } }, a) {
  let l;
  return !!(n[a] || e !== Ee && a[0] !== "$" && xe(e, a) || Is(t, a) || xe(s, a) || xe(r, a) || xe(Or, a) || xe(i.config.globalProperties, a) || (l = o.__cssModules) && l[a]);
...
function _h(e) {
  ...
  co = false, t.beforeCreate && el(t.beforeCreate, e, "bc");
  const { data: i, computed: s, methods: o, watch: a, provide: l, inject: u, created: c, beforeMount: f, mounted: d, beforeUpdate: m, updated: b, activated: g, deactivated: S, beforeDestroy: v, beforeUnmount: y, destroyed: A, unmounted: _, render: x, renderTracked: E, renderTriggered: P, errorCaptured: w, serverPrefetch: D, expose: R, inheritAttrs: N, components: M, directives: $, filters: Y } = t;
  ...
  if (co = true, s) for (const Q in s) {
    const ae = s[Q], Oe = ue(ae) ? ae.bind(n, n) : ue(ae.get) ? ae.get.bind(n, n) : jt, we = !ue(ae) && ue(ae.set) ? ae.set.bind(n) : jt, oe = H({ get: Oe, set: we });
    Object.defineProperty(r, Q, { enumerable: true, configurable: true, get: () => oe.value, set: (he) => oe.value = he });
  }
  if (a) for (const Q in a) rf(a[Q], r, n, Q);
  if (l) {
  ...
  if (J(ds, f), J(Wt, d), J(fh, m), J(ea, b), J(ch, g), J(Xu, S), J(gh, w), J(hh, E), J(mh, P), J(zt, y), J(ai, _), J(dh, D), se(R)) if (R.length) {
    const Q = e.exposed || (e.exposed = {});
    R.forEach((ae) => {
      Object.defineProperty(Q, ae, { get: () => n[ae], set: (Oe) => n[ae] = Oe, enumerable: true });
    });
  } else e.exposed || (e.exposed = {});
  x && e.render === jt && (e.render = x), N != null && (e.inheritAttrs = N), M && (e.components = M), $ && (e.directives = $), D && qu(e);
}
function wh(e, t, n = jt) {
  ...
  for (const r in e) {
    const i = e[r];
    let s;
    Se(i) ? "default" in i ? s = Me(i.from || r, i.default, true) : s = Me(i.from || r) : s = Me(i), Ve(s) ? Object.defineProperty(t, r, { enumerable: true, configurable: true, get: () => s.value, set: (o) => s.value = o }) : t[r] = s;
  }
}
function el(e, t, n) {
...
function rf(e, t, n, r) {
  let i = r.includes(".") ? Bu(n, r) : () => n[r];
  if (De(e)) {
    const s = t[e];
    ue(s) && le(i, s);
  } else if (ue(e)) le(i, e.bind(n));
  else if (Se(e)) if (se(e)) e.forEach((s) => rf(s, t, n, r));
  else {
...
function sf(e) {
  ...
  let l;
  return a ? l = a : !i.length && !n && !r ? l = t : (l = {}, i.length && i.forEach((u) => Bi(l, u, o, true)), Bi(l, t, o)), Se(t) && s.set(t, l), l;
}
function Bi(e, t, n, r = false) {
  const { mixins: i, extends: s } = t;
  s && Bi(e, s, n, true), i && i.forEach((o) => Bi(e, o, n, true));
...
const Sh = { data: tl, props: nl, emits: nl, methods: Mr, computed: Mr, beforeCreate: ot, created: ot, beforeMount: ot, mounted: ot, beforeUpdate: ot, updated: ot, beforeDestroy: ot, beforeUnmount: ot, destroyed: ot, unmounted: ot, activated: ot, deactivated: ot, errorCaptured: ot, serverPrefetch: ot, components: Mr, directives: Mr, watch: xh, provide: tl, inject: Ch };
function tl(e, t) {
  return t ? e ? function() {
...
function nl(e, t) {
  return e ? se(e) && se(t) ? [.../* @__PURE__ */ new Set([...e, ...t])] : je(/* @__PURE__ */ Object.create(null), Qa(e), Qa(t ?? {})) : t;
}
function xh(e, t) {
  if (!e) return t;
  if (!t) return e;
...
function Lh(e, t) {
  return function(r, i = null) {
    ...
    const s = of(), o = /* @__PURE__ */ new WeakSet(), a = [];
    let l = false;
    const u = s.app = { _uid: Ah++, _component: r, _props: i, _container: null, _context: s, _instance: null, version: r1, get config() {
      return s.config;
    }, set config(c) {
    }, use(c, ...f) {
      ...
      if (!l) {
        const m = u._ceVNode || T(r, i);
        return m.appContext = s, d === true ? d = "svg" : d === false && (d = void 0), e(m, c, d), l = true, u._container = c, c.__vue_app__ = u, hs(m.component);
      }
    }, onUnmount(c) {
      a.push(c);
    }, unmount() {
...
function Mh(e, t, ...n) {
  ...
  let i = n;
  const s = t.startsWith("update:"), o = s && Eh(r, t.slice(7));
  o && (o.trim && (i = n.map((c) => De(c) ? c.trim() : c)), o.number && (i = n.map(vm)));
  let a, l = r[a = Ls(t)] || r[a = Ls(_t(t))];
  !l && s && (l = r[a = Ls(On(t))]), l && Tt(l, e, 6, i);
  const u = r[a + "Once"];
  if (u) {
...
function af(e, t, n = false) {
  const r = n ? kh : t.emitsCache, i = r.get(e);
...
function ms(e, t) {
  return !e || !rs(t) ? false : (t = t.slice(2).replace(/Once$/, ""), xe(e, t[0].toLowerCase() + t.slice(1)) || xe(e, On(t)) || xe(e, t));
}
function rl(e) {
  const { type: t, vnode: n, proxy: r, withProxy: i, propsOptions: [s], slots: o, attrs: a, emit: l, render: u, renderCache: c, props: f, data: d, setupState: m, ctx: b, inheritAttrs: g } = e, S = Fi(e);
  let v, y;
  try {
    if (n.shapeFlag & 4) {
      const _ = i || r, x = _;
    ...
    Vr.length = 0, cs(_, e, 1), v = T(tt);
  }
  let A = v;
  if (y && g !== false) {
    const _ = Object.keys(y), { shapeFlag: x } = A;
    _.length && x & 7 && (s && _.some(jo) && (y = Ph(y, s)), A = hn(A, y, false, true));
  }
  return n.dirs && (A = hn(A, null, false, true), A.dirs = A.dirs ? A.dirs.concat(n.dirs) : n.dirs), n.transition && In(A, n.transition), v = A, Fi(S), v;
}
const Th = (e) => {
  let t;
  ...
  const n = {};
  for (const r in e) (!jo(r) || !(r.slice(9) in t)) && (n[r] = e[r]);
  return n;
};
function Rh(e, t, n) {
  ...
  if (n && l >= 0) {
    ...
    if (l & 16) return r ? il(r, o, u) : !!o;
    if (l & 8) {
      const c = t.dynamicProps;
      for (let f = 0; f < c.length; f++) {
        const d = c[f];
        if (lf(o, r, d) && !ms(u, d)) return true;
      }
    }
  } else return (i || a) && (!a || !a.$stable) ? true : r === o ? false : r ? o ? il(r, o, u) : true : !!o;
  return false;
}
function il(e, t, n) {
  ...
  for (let i = 0; i < r.length; i++) {
    const s = r[i];
    if (lf(t, e, s) && !ms(n, s)) return true;
  }
  return false;
}
function lf(e, t, n) {
...
const cf = {}, uf = () => Object.create(cf), ff = (e) => Object.getPrototypeOf(e) === cf;
function Oh(e, t, n, r = false) {
  const i = {}, s = uf();
  e.propsDefaults = /* @__PURE__ */ Object.create(null), df(e, t, i, s);
  for (const o in e.propsOptions[0]) o in i || (i[o] = void 0);
  n ? e.props = r ? i : Pu(i) : e.type.props ? e.props = i : e.props = s, e.attrs = s;
}
function Vh(e, t, n, r) {
  ...
  if ((r || o > 0) && !(o & 16)) {
    if (o & 8) {
      ...
      for (let f = 0; f < c.length; f++) {
        let d = c[f];
        if (ms(e.emitsOptions, d)) continue;
        const m = t[d];
        if (l) if (xe(s, d)) m !== s[d] && (s[d] = m, u = true);
        else {
          const b = _t(d);
          i[b] = fo(l, a, b, m, e, false);
        }
    ...
    df(e, t, i, s) && (u = true);
    let c;
    for (const f in a) (!t || !xe(t, f) && ((c = On(f)) === f || !xe(t, c))) && (l ? n && (n[f] !== void 0 || n[c] !== void 0) && (i[f] = fo(l, a, f, void 0, e, true)) : delete i[f]);
...
function df(e, t, n, r) {
  ...
  if (t) for (let l in t) {
    ...
    const u = t[l];
    let c;
    i && xe(i, c = _t(l)) ? !s || !s.includes(c) ? n[c] = u : (a || (a = {}))[c] = u : ms(e.emitsOptions, l) || (!(l in r) || u !== r[l]) && (r[l] = u, o = true);
  }
  if (s) {
    const l = te(n), u = a || Ee;
    for (let c = 0; c < s.length; c++) {
      const f = s[c];
      n[f] = fo(i, l, f, u[f], e, !xe(u, f));
    }
  }
  return o;
}
...
function mf(e, t, n = false) {
  const r = n ? Dh : t.propsCache, i = r.get(e);
  if (i) return i;
  const s = e.props, o = {}, a = [];
  let l = false;
  if (!ue(e)) {
...
const ta = (e) => e === "_" || e === "_ctx" || e === "$stable", na = (e) => se(e) ? e.map($t) : [$t(e)], Hh = (e, t, n) => {
  if (t._n) return t;
  const r = $e((...i) => na(t(...i)), n);
  return r._c = false, r;
}, hf = (e, t, n) => {
  const r = e._ctx;
  for (const i in e) {
  ...
  for (const r in t) (n || !ta(r)) && (e[r] = t[r]);
}, Nh = (e, t, n) => {
  const r = e.slots = uf();
  if (e.vnode.shapeFlag & 32) {
    const i = t._;
    i ? (vf(r, t, n), n && fu(r, "_", i, true)) : hf(t, r);
  } else t && gf(e, t);
}, Fh = (e, t, n) => {
  ...
  if (r.shapeFlag & 32) {
    const a = t._;
    a ? n && a === 1 ? s = false : vf(i, t, n) : (s = !t.$stable, hf(t, i)), o = t;
  } else t && (gf(e, t), o = { default: 1 });
  if (s) for (const a in i) !ta(a) && o[a] == null && delete i[a];
}, Xe = zh;
function $h(e) {
  return Bh(e);
}
function Bh(e, t) {
  const n = os();
  n.__VUE__ = true;
  const { insert: r, remove: i, patchProp: s, createElement: o, createText: a, createComment: l, setText: u, setElementText: c, parentNode: f, nextSibling: d, setScopeId: m = jt, insertStaticContent: b } = e, g = (h, p, C, I = null, V = null, O = null, K = void 0, G = null, W = !!p.dynamicChildren) => {
    if (h === p) return;
    h && !Ln(h, p) && (I = L(h), he(h, V, O, true), h = null), p.patchFlag === -2 && (W = false, p.dynamicChildren = null);
    const { type: F, ref: ie, shapeFlag: q } = p;
    switch (F) {
      case li:
        S(h, p, C, I);
        break;
    ...
    ie != null && V ? Ir(ie, h && h.ref, O, p || h, !p) : ie == null && h && h.ref != null && Ir(h.ref, null, O, h, true);
  }, S = (h, p, C, I) => {
    ...
    if (W = h.el = o(h.type, O, ie && ie.is, ie), q & 8 ? c(W, h.children) : q & 16 && w(h.children, W, null, I, V, Os(h, O), K, G), fe && yn(h, null, I, "created"), P(W, h, h.scopeId, K, I), ie) {
      for (const ke in ie) ke !== "value" && !kr(ke) && s(W, ke, null, ie[ke], O, I);
      "value" in ie && s(W, "value", null, ie.value, O), (F = ie.onVnodeBeforeMount) && Dt(F, I, h);
    }
    fe && yn(h, null, I, "beforeMount");
    const be = jh(V, ee);
    be && ee.beforeEnter(W), r(W, p, C), ((F = ie && ie.onVnodeMounted) || be || fe) && Xe(() => {
    ...
    if (V) {
      let O = V.subTree;
      if (p === O || bf(O.type) && (O.ssContent === p || O.ssFallback === p)) {
        const K = V.vnode;
        P(h, K, K.scopeId, K.slotScopeIds, V.parent);
      }
    }
  }, w = (h, p, C, I, V, O, K, G, W = 0) => {
    for (let F = W; F < h.length; F++) {
      const ie = h[F] = G ? qt(h[F]) : $t(h[F]);
      g(null, ie, p, C, I, V, O, K, G);
    }
  }, D = (h, p, C, I, V, O, K) => {
    const G = p.el = h.el;
    let { patchFlag: W, dynamicChildren: F, dirs: ie } = p;
    W |= h.patchFlag & 16;
    const q = h.props || Ee, ee = p.props || Ee;
    let fe;
    if (C && bn(C, false), (fe = ee.onVnodeBeforeUpdate) && Dt(fe, C, p, h), ie && yn(p, h, C, "beforeUpdate"), C && bn(C, true), (q.innerHTML && ee.innerHTML == null || q.textContent && ee.textContent == null) && c(G, ""), F ? R(h.dynamicChildren, F, G, C, I, Os(p, V), O) : K || ae(h, p, G, null, C, I, Os(p, V), O, false), W > 0) {
      if (W & 16) N(G, q, ee, C, V);
      else if (W & 2 && q.class !== ee.class && s(G, "class", null, ee.class, V), W & 4 && s(G, "style", q.style, ee.style, V), W & 8) {
        const be = p.dynamicProps;
        for (let ke = 0; ke < be.length; ke++) {
          const Ae = be[ke], ut = q[Ae], ft = ee[Ae];
          (ft !== ut || Ae === "value") && s(G, Ae, ut, ft, V, C);
        }
      }
    ...
    for (let G = 0; G < p.length; G++) {
      const W = h[G], F = p[G], ie = W.el && (W.type === _e || !Ln(W, F) || W.shapeFlag & 198) ? f(W.el) : C;
      g(W, F, ie, null, I, V, O, K, true);
    }
  }, N = (h, p, C, I, V) => {
    if (p !== C) {
      if (p !== Ee) for (const O in p) !kr(O) && !(O in C) && s(h, O, p[O], null, V, I);
      for (const O in C) {
        if (kr(O)) continue;
        const K = C[O], G = p[O];
        K !== G && O !== "value" && s(h, O, G, K, V, I);
      }
      "value" in C && s(h, "value", p.value, C.value, V);
    }
  }, M = (h, p, C, I, V, O, K, G, W) => {
    const F = p.el = h ? h.el : a(""), ie = p.anchor = h ? h.anchor : a("");
    let { patchFlag: q, dynamicChildren: ee, slotScopeIds: fe } = p;
    fe && (G = G ? G.concat(fe) : fe), h == null ? (r(F, C, I), r(ie, C, I), w(p.children || [], C, ie, V, O, K, G, W)) : q > 0 && q & 64 && ee && h.dynamicChildren && h.dynamicChildren.length === ee.length ? (R(h.dynamicChildren, ee, C, V, O, K, G), (p.key != null || V && p === V.subTree) && ra(h, p, true)) : ae(h, p, C, ie, V, O, K, G, W);
  }, $ = (h, p, C, I, V, O, K, G, W) => {
    p.slotScopeIds = G, h == null ? p.shapeFlag & 512 ? V.ctx.activate(p, C, I, K, W) : Y(p, C, I, V, O, K, W) : Z(h, p, W);
  }, Y = (h, p, C, I, V, O, K) => {
    const G = h.component = qh(h, I, V);
    if (us(h) && (G.ctx.renderer = U), Xh(G, false, K), G.asyncDep) {
      if (V && V.registerDep(G, J, K), !h.el) {
        const W = G.subTree = T(tt);
    ...
    const G = () => {
      if (h.isMounted) {
        ...
        let Ae = q, ut;
        bn(h, false), q ? (q.el = ke.el, Q(h, q, K)) : q = ke, ee && Es(ee), (ut = q.props && q.props.onVnodeBeforeUpdate) && Dt(ut, be, q, ke), bn(h, true);
        const ft = rl(h), It = h.subTree;
        ...
        bn(h, false), be && Es(be), !It && (q = fe && fe.onVnodeBeforeMount) && Dt(q, Ae, p), bn(h, true);
        {
          ut.ce && ut.ce._hasShadowRoot() && ut.ce._injectChildStyle(ft);
          const Ot = h.subTree = rl(h);
    ...
    h.scope.on();
    const W = h.effect = new pu(G);
    h.scope.off();
    const F = h.update = W.run.bind(W), ie = h.job = W.runIfDirty.bind(W);
    ie.i = h, ie.id = h.uid, W.scheduler = () => Xo(ie), bn(h, true), F();
  }, Q = (h, p, C) => {
    p.component = h;
    const I = h.vnode.props;
    h.vnode = p, h.next = null, Vh(h, p.props, I, C), Fh(h, p.children, C), en(), Ga(h), tn();
  }, ae = (h, p, C, I, V, O, K, G, W = false) => {
    const F = h && h.children, ie = h ? h.shapeFlag : 0, q = p.children, { patchFlag: ee, shapeFlag: fe } = p;
    if (ee > 0) {
      if (ee & 128) {
    ...
    fe & 8 ? (ie & 16 && Ne(F, V, O), q !== F && c(C, q)) : ie & 16 ? fe & 16 ? we(F, q, C, I, V, O, K, G, W) : Ne(F, V, O, true) : (ie & 8 && c(C, ""), fe & 16 && w(q, C, I, V, O, K, G, W));
  }, Oe = (h, p, C, I, V, O, K, G, W) => {
    h = h || zn, p = p || zn;
    const F = h.length, ie = p.length, q = Math.min(F, ie);
    let ee;
    for (ee = 0; ee < q; ee++) {
      const fe = p[ee] = W ? qt(p[ee]) : $t(p[ee]);
      g(h[ee], fe, C, null, V, O, K, G, W);
    }
    F > ie ? Ne(h, V, O, true, false, q) : w(p, C, I, V, O, K, G, W, q);
    ...
    if (F > q) {
      ...
      for (F = fe; F <= q; F++) {
        ...
        Vt === void 0 ? he(mt, V, O, true) : (br[Vt - be] = F + 1, Vt >= Ot ? Ot = Vt : It = true, g(mt, p[Vt], C, null, V, O, K, G, W), ut++);
      }
      const Na = It ? Wh(br) : zn;
      for (Ae = Na.length - 1, F = ft - 1; F >= 0; F--) {
        const mt = be + F, Vt = p[mt], Fa = p[mt + 1], $a = mt + 1 < ie ? Fa.el || yf(Fa) : I;
        br[F] === 0 ? g(null, Vt, C, $a, V, O, K, G, W) : It && (Ae < 0 || F !== Na[Ae] ? oe(Vt, C, $a, 2) : Ae--);
      }
    }
  }, oe = (h, p, C, I, V = null) => {
    const { el: O, type: K, transition: G, children: W, shapeFlag: F } = h;
    if (F & 6) {
      oe(h.component.subTree, p, C, I);
      return;
    }
    if (F & 128) {
    ...
    if (K === _e) {
      r(O, p, C);
      for (let q = 0; q < W.length; q++) oe(W[q], p, C, I);
      r(h.anchor, p, C);
      return;
    }
    if (K === Vs) {
    ...
    const { type: O, props: K, ref: G, children: W, dynamicChildren: F, shapeFlag: ie, patchFlag: q, dirs: ee, cacheIndex: fe } = h;
    if (q === -2 && (V = false), G != null && (en(), Ir(G, null, C, h, true), tn()), fe != null && (p.renderCache[fe] = void 0), ie & 256) {
      p.ctx.deactivate(h);
      return;
    }
    const be = ie & 1 && ee, ke = !Zn(h);
    let Ae;
    if (ke && (Ae = K && K.onVnodeBeforeUnmount) && Dt(Ae, p, h), ie & 6) Ge(h.component, C, I);
    else {
      if (ie & 128) {
        h.suspense.unmount(C, I);
        return;
      }
      be && yn(h, null, p, "beforeUnmount"), ie & 64 ? h.type.remove(h, p, C, U, I) : F && !F.hasOnce && (O !== _e || q > 0 && q & 64) ? Ne(F, p, C, false, true) : (O === _e && q & 384 || !V && ie & 16) && Ne(W, p, C), I && de(h);
    }
    ...
    ol(W), ol(F), I && Es(I), V.stop(), O && (O.flags |= 8, he(K, h, p, C)), G && Xe(G, p), Xe(() => {
      h.isUnmounted = true;
    }, p);
    ...
    const p = d(h.anchor || h.el), C = p && p[ju];
    return C ? d(C) : p;
  };
  let j = false;
  const z = (h, p, C) => {
    let I;
    h == null ? p._vnode && (he(p._vnode, null, null, true), I = p._vnode.component) : g(p._vnode || null, h, p, null, null, null, C), p._vnode = h, j || (j = true, Ga(I), Nu(), j = false);
  }, U = { p: g, um: he, m: oe, r: de, mt: Y, mc: w, pc: ae, pbc: R, n: L, o: e };
...
function ra(e, t, n = false) {
  ...
  if (se(r) && se(i)) for (let s = 0; s < r.length; s++) {
    const o = r[s];
    let a = i[s];
    a.shapeFlag & 1 && !a.dynamicChildren && ((a.patchFlag <= 0 || a.patchFlag === 32) && (a = i[s] = qt(i[s]), a.el = o.el), !n && a.patchFlag !== -2 && ra(o, a)), a.type === li && (a.patchFlag === -1 && (a = i[s] = qt(a)), a.el = o.el), a.type === tt && !a.el && (a.el = o.el);
  }
}
function Wh(e) {
  const t = e.slice(), n = [0];
...
const _e = Symbol.for("v-fgt"), li = Symbol.for("v-txt"), tt = Symbol.for("v-cmt"), Vs = Symbol.for("v-stc"), Vr = [];
let vt = null;
function ce(e = false) {
  Vr.push(vt = e ? null : []);
}
...
function _f(e) {
  return e.dynamicChildren = Ur > 0 ? vt || zn : null, Gh(), Ur > 0 && vt && vt.push(e), e;
}
function me(e, t, n, r, i, s) {
  return _f(k(e, t, n, r, i, s, true));
}
function nr(e, t, n, r, i) {
  return _f(T(e, t, n, r, i, true));
}
function Zr(e) {
...
const wf = ({ key: e }) => e ?? null, Pi = ({ ref: e, ref_key: t, ref_for: n }) => (typeof e == "number" && (e = "" + e), e != null ? De(e) || Ve(e) || ue(e) ? { i: Ke, r: e, k: t, f: !!n } : e : null);
function k(e, t = null, n = null, r = 0, i = null, s = e === _e ? 0 : 1, o = false, a = false) {
  const l = { __v_isVNode: true, __v_skip: true, type: e, props: t, key: t && wf(t), ref: t && Pi(t), scopeId: $u, slotScopeIds: null, children: n, component: null, suspense: null, ssContent: null, ssFallback: null, dirs: null, transition: null, el: null, anchor: null, target: null, targetStart: null, targetAnchor: null, staticCount: 0, shapeFlag: s, patchFlag: r, dynamicProps: i, dynamicChildren: null, appContext: null, ctx: Ke };
  return a ? (ia(l, n), s & 128 && e.normalize(l)) : n && (l.shapeFlag |= De(n) ? 8 : 16), Ur > 0 && !o && vt && (l.patchFlag > 0 || s & 6) && l.patchFlag !== 32 && vt.push(l), l;
}
const T = Uh;
function Uh(e, t = null, n = null, r = 0, i = null, s = false) {
  if ((!e || e === vh) && (e = tt), Zr(e)) {
    const a = hn(e, t, true);
    return n && ia(a, n), Ur > 0 && !s && vt && (a.shapeFlag & 6 ? vt[vt.indexOf(e)] = a : vt.push(a)), a.patchFlag = -2, a;
  }
  if (n1(e) && (e = e.__vccOpts), t) {
    t = Zh(t);
    let { class: a, style: l } = t;
    a && !De(a) && (t.class = Le(a)), Se(l) && (ls(l) && !se(l) && (l = je({}, l)), t.style = He(l));
  }
  const o = De(e) ? 1 : bf(e) ? 128 : Wu(e) ? 64 : Se(e) ? 4 : ue(e) ? 2 : 0;
  return k(e, t, n, r, i, o, s, true);
}
function Zh(e) {
  return e ? ls(e) || ff(e) ? je({}, e) : e : null;
}
...
function Yn(e = " ", t = 0) {
  return T(li, null, e, t);
}
function rr(e = "", t = false) {
  return t ? (ce(), nr(tt, null, e)) : T(tt, null, e);
}
function $t(e) {
  return e == null || typeof e == "boolean" ? T(tt) : se(e) ? T(_e, null, e.slice()) : Zr(e) ? qt(e) : T(li, null, String(e));
}
function qt(e) {
...
function ia(e, t) {
  ...
  if (t == null) t = null;
    ...
    const i = t.default;
    i && (i._c && (i._d = false), ia(e, i()), i._c && (i._d = true));
    return;
  } else {
    n = 32;
    const i = t._;
    !i && !ff(t) ? t._ctx = Ke : i === 3 && Ke && (Ke.slots._ === 1 ? t._ = 1 : (t._ = 2, e.patchFlag |= 1024));
  }
  else ue(t) ? (t = { default: t, _ctx: Ke }, n = 32) : (t = String(t), r & 64 ? (n = 16, t = [Yn(t)]) : n = 8);
...
let Yh = 0;
function qh(e, t, n) {
  const r = e.type, i = (t ? t.appContext : e.appContext) || Kh, s = { uid: Yh++, vnode: e, type: r, parent: t, appContext: i, root: null, next: null, subTree: null, effect: null, update: null, job: null, scope: new gu(true), render: null, proxy: null, exposed: null, exposeProxy: null, withProxy: null, provides: t ? t.provides : Object.create(i.provides), ids: t ? t.ids : ["", 0, 0], accessCache: null, renderCache: [], components: null, directives: null, propsOptions: mf(r, i), emitsOptions: af(r, i), emit: null, emitted: null, propsDefaults: Ee, inheritAttrs: r.inheritAttrs, ctx: Ee, data: Ee, props: Ee, attrs: Ee, slots: Ee, refs: Ee, setupState: Ee, setupContext: null, suspense: n, suspenseId: n ? n.pendingId : 0, asyncDep: null, asyncResolved: false, isMounted: false, isUnmounted: false, isDeactivated: false, bc: null, c: null, bm: null, m: null, bu: null, u: null, um: null, bum: null, da: null, a: null, rtg: null, rtc: null, ec: null, sp: null };
  return s.ctx = { _: s }, s.root = t ? t.root : s, s.emit = Mh.bind(null, s), e.ce && e.ce(s), s;
}
let nt = null;
const ci = () => nt || Ke;
let Wi, mo;
{
  ...
  Wi = t("__VUE_INSTANCE_SETTERS__", (n) => nt = n), mo = t("__VUE_SSR_SETTERS__", (n) => Kr = n);
}
const ui = (e) => {
  const t = nt;
...
function Xh(e, t = false, n = false) {
  t && mo(t);
  const { props: r, children: i } = e.vnode, s = Sf(e);
  Oh(e, r, s, t), Nh(e, i, n || t);
  const o = s ? Jh(e, t) : void 0;
  return t && mo(false), o;
}
function Jh(e, t) {
  const n = e.type;
  ...
  if (r) {
    en();
    const i = e.setupContext = r.length > 1 ? e1(e) : null, s = ui(e), o = si(r, e, 0, [e.props, i]), a = lu(o);
    if (tn(), s(), (a || e.sp) && !Zn(e) && qu(e), a) {
      if (o.then(al, al), t) return o.then((l) => {
        ll(e, l);
      }).catch((l) => {
        cs(l, e, 0);
      });
...
function ll(e, t, n) {
  ue(t) ? e.type.__ssrInlineRender ? e.ssrRender = t : e.render = t : Se(t) && (e.setupState = Iu(t)), Cf(e);
}
function Cf(e, t, n) {
  const r = e.type;
...
function hs(e) {
  return e.exposed ? e.exposeProxy || (e.exposeProxy = new Proxy(Iu(zm(e.exposed)), { get(t, n) {
...
const H = (e, t) => qm(e, t, Kr);
function vn(e, t, n) {
  try {
    ji(-1);
    const r = arguments.length;
    return r === 2 ? Se(t) && !se(t) ? Zr(t) ? T(e, null, [t]) : T(e, t) : T(e, null, t) : (r > 3 ? n = Array.prototype.slice.call(arguments, 2) : r === 3 && Zr(n) && (n = [n]), T(e, t, n));
  } finally {
    ji(1);
  }
}
...
if (cl) try {
  ho = cl.createPolicy("vue", { createHTML: (e) => e });
} catch {
}
const xf = ho ? (e) => ho.createHTML(e) : (e) => e, i1 = "http://www.w3.org/2000/svg", s1 = "http://www.w3.org/1998/Math/MathML", Yt = typeof document < "u" ? document : null, ul = Yt && Yt.createElement("template"), o1 = { insert: (e, t, n) => {
  t.insertBefore(e, n || null);
}, remove: (e) => {
  const t = e.parentNode;
  t && t.removeChild(e);
}, createElement: (e, t, n, r) => {
  const i = t === "svg" ? Yt.createElementNS(i1, e) : t === "mathml" ? Yt.createElementNS(s1, e) : n ? Yt.createElement(e, { is: n }) : Yt.createElement(e);
  ...
  if (i && (i === s || i.nextSibling)) for (; t.insertBefore(i.cloneNode(true), n), !(i === s || !(i = i.nextSibling)); ) ;
    ...
    ul.innerHTML = xf(r === "svg" ? `<svg>${e}</svg>` : r === "mathml" ? `<math>${e}</math>` : e);
    const a = ul.content;
    if (r === "svg" || r === "mathml") {
...
} }, on = "transition", Sr = "animation", ir = Symbol("_vtc"), Af = { name: String, type: String, css: { type: Boolean, default: true }, duration: [String, Number, Object], enterFromClass: String, enterActiveClass: String, enterToClass: String, appearFromClass: String, appearActiveClass: String, appearToClass: String, leaveFromClass: String, leaveActiveClass: String, leaveToClass: String }, Lf = je({}, Uu, Af), a1 = (e) => (e.displayName = "Transition", e.props = Lf, e), sr = a1((e, { slots: t }) => vn(lh, Ef(e), t)), _n = (e, t = []) => {
  se(e) ? e.forEach((n) => n(...t)) : e && e(...t);
}, fl = (e) => e ? se(e) ? e.some((t) => t.length > 1) : e.length > 1 : false;
function Ef(e) {
  const t = {};
  for (const M in e) M in Af || (t[M] = e[M]);
  if (e.css === false) return t;
  const { name: n = "v", type: r, duration: i, enterFromClass: s = `${n}-enter-from`, enterActiveClass: o = `${n}-enter-active`, enterToClass: a = `${n}-enter-to`, appearFromClass: l = s, appearActiveClass: u = o, appearToClass: c = a, leaveFromClass: f = `${n}-leave-from`, leaveActiveClass: d = `${n}-leave-active`, leaveToClass: m = `${n}-leave-to` } = e, b = l1(i), g = b && b[0], S = b && b[1], { onBeforeEnter: v, onEnter: y, onEnterCancelled: A, onLeave: _, onLeaveCancelled: x, onBeforeAppear: E = v, onAppear: P = y, onAppearCancelled: w = A } = t, D = (M, $, Y, Z) => {
    M._enterCancelled = Z, ln(M, $ ? c : a), ln(M, $ ? u : o), Y && Y();
  }, R = (M, $) => {
    M._isLeaving = false, ln(M, f), ln(M, m), ln(M, d), $ && $();
  }, N = (M) => ($, Y) => {
    const Z = M ? P : y, J = () => D($, M, Y);
    _n(Z, [$, J]), dl(() => {
      ln($, M ? l : s), Ht($, M ? c : a), fl(Z) || ml($, r, g, J);
    });
  };
  return je(t, { onBeforeEnter(M) {
    _n(v, [M]), Ht(M, s), Ht(M, o);
  }, onBeforeAppear(M) {
    _n(E, [M]), Ht(M, l), Ht(M, u);
  }, onEnter: N(false), onAppear: N(true), onLeave(M, $) {
    M._isLeaving = true;
    const Y = () => R(M, $);
    Ht(M, f), M._enterCancelled ? (Ht(M, d), go(M)) : (go(M), Ht(M, d)), dl(() => {
      M._isLeaving && (ln(M, f), Ht(M, m), fl(_) || ml(M, r, S, Y));
    }), _n(_, [M, Y]);
  }, onEnterCancelled(M) {
...
function l1(e) {
  ...
  if (Se(e)) return [Ds(e.enter), Ds(e.leave)];
  {
    const t = Ds(e);
    return [t, t];
  }
...
function Ht(e, t) {
  t.split(/\s+/).forEach((n) => n && e.classList.add(n)), (e[ir] || (e[ir] = /* @__PURE__ */ new Set())).add(t);
}
function ln(e, t) {
...
let c1 = 0;
function ml(e, t, n, r) {
  const i = e._endId = ++c1, s = () => {
    i === e._endId && r();
  };
  if (n != null) return setTimeout(s, n);
  const { type: o, timeout: a, propCount: l } = Mf(e, t);
  if (!o) return r();
  const u = o + "end";
  let c = 0;
  const f = () => {
...
function Mf(e, t) {
  const n = window.getComputedStyle(e), r = (b) => (n[b] || "").split(", "), i = r(`${on}Delay`), s = r(`${on}Duration`), o = hl(i, s), a = r(`${Sr}Delay`), l = r(`${Sr}Duration`), u = hl(a, l);
  let c = null, f = 0, d = 0;
...
const zi = Symbol("_vod"), kf = Symbol("_vsh"), sa = { name: "show", beforeMount(e, { value: t }, { transition: n }) {
  e[zi] = e.style.display === "none" ? "" : e.style.display, n && t ? n.beforeEnter(e) : Cr(e, t);
...
function m1(e, t, n) {
  ...
  if (n && !i) {
    ...
    else for (const o in t) n[o] == null && Ri(r, o, "");
    for (const o in n) o === "display" && (s = true), Ri(r, o, n[o]);
  } else if (i) {
    if (t !== n) {
      const o = r[f1];
      o && (n += ";" + o), r.cssText = n, s = d1.test(n);
    }
...
function Ri(e, t, n) {
  if (se(n)) n.forEach((r) => Ri(e, t, r));
  else if (n == null && (n = ""), t.startsWith("--")) e.setProperty(t, n);
  else {
    const r = h1(e, t);
    vl.test(n) ? e.setProperty(On(r), n.replace(vl, ""), "important") : e[r] = n;
  }
}
const pl = ["Webkit", "Moz", "ms"], Hs = {};
function h1(e, t) {
  const n = Hs[t];
  if (n) return n;
  let r = _t(t);
...
function bl(e, t, n, r, i, s = Cm(t)) {
  r && t.startsWith("xlink:") ? n == null ? e.removeAttributeNS(yl, t.slice(6, t.length)) : e.setAttributeNS(yl, t, n) : n == null || s && !du(n) ? e.removeAttribute(t) : e.setAttribute(t, s ? "" : Mt(n) ? String(n) : n);
}
function _l(e, t, n, r, i) {
  ...
  if (n === "" || n == null) {
    const a = typeof e[t];
    a === "boolean" ? n = du(n) : n == null && a === "string" ? (n = "", o = true) : a === "number" && (n = 0, o = true);
  }
  try {
    e[t] = n;
  } catch {
...
function y1(e) {
  ...
  if (Sl.test(e)) {
    t = {};
    let r;
    for (; r = e.match(Sl); ) e = e.slice(0, e.length - r[0].length), t[r[0].toLowerCase()] = true;
  }
  return [e[2] === ":" ? e.slice(3) : On(e.slice(2)), t];
}
let Ns = 0;
const b1 = Promise.resolve(), _1 = () => Ns || (b1.then(() => Ns = 0), Ns = Date.now());
function w1(e, t) {
  const n = (r) => {
...
const Cl = (e) => e.charCodeAt(0) === 111 && e.charCodeAt(1) === 110 && e.charCodeAt(2) > 96 && e.charCodeAt(2) < 123, C1 = (e, t, n, r, i, s) => {
  const o = i === "svg";
  t === "class" ? u1(e, r, o) : t === "style" ? m1(e, n, r) : rs(t) ? jo(t) || p1(e, t, n, r, s) : (t[0] === "." ? (t = t.slice(1), true) : t[0] === "^" ? (t = t.slice(1), false) : x1(e, t, r, o)) ? (_l(e, t, r), !e.tagName.includes("-") && (t === "value" || t === "checked" || t === "selected") && bl(e, t, r, o, s, t !== "value")) : e._isVueCE && (/[A-Z]/.test(t) || !De(r)) ? _l(e, _t(t), r, s, t) : (t === "true-value" ? e._trueValue = r : t === "false-value" && (e._falseValue = r), bl(e, t, r, o));
};
function x1(e, t, n, r) {
  if (r) return !!(t === "innerHTML" || t === "textContent" || t in e && Cl(t) && ue(n));
  if (t === "spellcheck" || t === "draggable" || t === "translate" || t === "autocorrect" || t === "sandbox" && e.tagName === "IFRAME" || t === "form" || t === "list" && e.tagName === "INPUT" || t === "type" && e.tagName === "TEXTAREA") return false;
  if (t === "width" || t === "height") {
    const i = e.tagName;
    if (i === "IMG" || i === "VIDEO" || i === "CANVAS" || i === "SOURCE") return false;
  }
  return Cl(t) && De(n) ? false : t in e;
}
const Tf = /* @__PURE__ */ new WeakMap(), Pf = /* @__PURE__ */ new WeakMap(), Gi = Symbol("_moveCb"), xl = Symbol("_enterCb"), A1 = (e) => (delete e.props.mode, e), L1 = A1({ name: "TransitionGroup", props: je({}, Lf, { tag: String, moveClass: String }), setup(e, { slots: t }) {
  const n = ci(), r = Gu();
  let i, s;
  return ea(() => {
    if (!i.length) return;
    const o = e.moveClass || `${e.name || "v"}-move`;
    if (!T1(i[0].el, n.vnode.el, o)) {
      i = [];
      return;
    }
    i.forEach(E1), i.forEach(M1);
    const a = i.filter(k1);
    go(n.vnode.el), a.forEach((l) => {
      const u = l.el, c = u.style;
      Ht(u, o), c.transform = c.webkitTransform = c.transitionDuration = "";
      const f = u[Gi] = (d) => {
        d && d.target !== u || (!d || d.propertyName.endsWith("transform")) && (u.removeEventListener("transitionend", f), u[Gi] = null, ln(u, o));
      };
    ...
    if (i = [], s) for (let u = 0; u < s.length; u++) {
      const c = s[u];
      c.el && c.el instanceof Element && (i.push(c), In(c, Gr(c, a, r, n)), Tf.set(c, Rf(c.el)));
    }
    s = t.default ? Qo(t.default()) : [];
...
function k1(e) {
  const t = Tf.get(e), n = Pf.get(e), r = t.left - n.left, i = t.top - n.top;
  if (r || i) {
...
function aa(e) {
  const t = `[${e}]`;
  return { debug: Ll, info: Ll, warn: (...n) => console.warn(t, ...n), error: (...n) => console.error(t, ...n) };
}
const El = 5;
function D1(e, t, n) {
  const r = t * n, i = Math.max(1, Math.round(e / (r * El)));
  return e / (i * El);
}
function If(e, t, n) {
...
const Of = 1, $1 = `gol.gridBlankZones.v${Of}`, B1 = 128;
function j1(e, t, n, r) {
...
function Z1(e) {
  const t = e && typeof e == "object" ? e : {}, n = typeof t.style == "string" && z1.has(t.style) ? t.style : "none", r = Fs(Bn(t.widthCells) ?? 1, 1, 4), i = typeof t.opacity == "number" ? t.opacity : 1, s = Fs(i, 0, 1), o = { style: n, widthCells: r, opacity: s };
  if (n === "fade") {
    const a = typeof t.fadeStrength == "number" ? t.fadeStrength : 0.6;
    o.fadeStrength = Fs(a, 0, 1);
  }
...
function Vf(e, t = Date.now()) {
  ...
  const n = e, r = Bn(n.x1), i = Bn(n.y1), s = Bn(n.x2), o = Bn(n.y2);
  if (r === null || i === null || s === null || o === null) return null;
  const a = Math.min(r, s), l = Math.max(r, s), u = Math.min(i, o), c = Math.max(i, o);
  return { id: typeof n.id == "string" && n.id.length > 0 ? n.id : G1(), x1: a, y1: u, x2: l, y2: c, mode: U1(n.mode), edge: Z1(n.edge), enabled: K1(n.enabled), createdAt: Ml(n.createdAt, t), updatedAt: Ml(n.updatedAt, t) };
}
function Df(e, t = Date.now()) {
  return j1(e, Vf, B1, t);
}
function $s() {
...
function Y1(e) {
  return { load() {
    ...
    $s() && localStorage.removeItem(e.key);
  } };
}
const la = Y1({ key: $1, version: Of, normalize: Df, itemsKey: "zones" }), q1 = la.load, X1 = la.save, J1 = la.clear;
function Q1(e) {
...
function eg(e = {}) {
  const { items: t, setItems: n, addItem: r, updateItem: i, removeItem: s, clearItems: o, syncFromWorker: a } = Q1({ storage: { load: q1, save: X1, clear: J1 }, normalize: Df, normalizeOne: Vf, onSet: e.onSetZones, onAdd: e.onAddZone, onUpdate: e.onUpdateZone, onRemove: e.onRemoveZone, onClear: e.onClearZones });
  return { zones: t, setZones: n, addZone: r, updateZone: i, removeZone: s, clearZones: o, syncFromWorker: a };
}
const kl = aa("WorkerBridge");
function tg() {
  let e = null;
  ...
  function r(l, u) {
    if (e) try {
      ...
      kl.error("Worker postMessage failed:", c instanceof Error ? c.message : String(c));
    }
  }
  function i(l, u) {
  ...
  function o(l, u, c) {
    ...
    f.onmessage = (d) => s(d.data), f.onerror = (d) => {
      kl.error("Worker uncaught exception:", d.message, `at ${d.filename}:${d.lineno}`);
...
const Bs = 5, ng = /* @__PURE__ */ new Set(["A", "BUTTON", "INPUT", "SELECT", "TEXTAREA", "LABEL"]), rg = '.zone-panel, .v-overlay-container, [data-grid-ignore-click="true"]';
function ig(e, t) {
  function n() {
    const l = e.value;
  ...
  function o(l, u) {
    const c = (d) => Math.floor(d / Bs) * Bs, f = (d) => c(d) + (Bs - 1);
  ...
  return { makeSnapshot: n, pointerToCell: i, cellToScreen: N1, cellSpanToCssPx: F1, normalizeRect: s, snapRectToMajor: o, isInteractiveTarget: a, wrapXToWorld: r };
}
function sg() {
  let e = 0;
  function t(r) {
...
function js([e, t, n], r = 1, i = 1) {
  const s = t * r;
  return i === 1 ? `oklch(${e.toFixed(4)} ${s.toFixed(4)} ${n.toFixed(2)})` : `oklch(${e.toFixed(4)} ${s.toFixed(4)} ${n.toFixed(2)} / ${i.toFixed(3)})`;
}
const Hf = "theme-preference";
function ag() {
  var _a2;
  if (typeof window > "u") return "system";
  const e = (_a2 = window.localStorage) == null ? void 0 : _a2.getItem(Hf);
  return e === "light" || e === "dark" || e === "system" ? e : "system";
}
const Yr = X(ag()), Nf = X(typeof window < "u" && window.matchMedia ? window.matchMedia("(prefers-color-scheme: dark)").matches : false);
...
le(Yr, (e) => {
  var _a2;
  typeof window < "u" && ((_a2 = window.localStorage) == null ? void 0 : _a2.setItem(Hf, e));
});
const vo = H(() => Yr.value === "light" ? Tl : Yr.value === "dark" || Nf.value ? Pl : Tl);
if (typeof window < "u" && (document == null ? void 0 : document.documentElement)) {
  const e = (t) => {
    ...
    n.dataset.themeMode = t.surface[0] > 0.5 ? "light" : "dark", r("--theme-surface", Lt(t.surface)), r("--theme-ink", Lt(t.ink)), r("--theme-ink-secondary", Lt(wn(t.surface, t.ink, t.ink_secondary_t))), r("--theme-ink-tertiary", Lt(wn(t.surface, t.ink, t.ink_tertiary_t))), r("--theme-text-primary", Lt(t.ink)), r("--theme-text-secondary", Lt(wn(t.surface, t.ink, t.ink_secondary_t))), r("--theme-text-tertiary", Lt(wn(t.surface, t.ink, t.ink_tertiary_t))), r("--theme-grid-minor", Lt(wn(t.surface, t.ink, t.minor_t))), r("--theme-grid-major", Lt(wn(t.surface, t.ink, t.major_t))), r("--theme-grid-border", Lt(wn(t.surface, t.ink, t.border_t))), r("--theme-accent", js(t.accent, t.accent_chroma_scale)), r("--theme-accent-ring", js(t.accent, t.accent_chroma_scale, 0.45)), r("--theme-selection-bg", js(t.accent, t.accent_chroma_scale, 0.2)), r("color-scheme", t.surface[0] > 0.5 ? "light" : "dark");
...
function fg(e) {
  ...
  return { initialize: P, revealCanvas: w, teardown: D };
}
const dg = aa("AppBackground");
function mg(e) {
...
function Lg(e, t) {
  const n = t.zoom, r = Ag(e, t.panelMaxWidth), i = t.panelHeight ?? e.h;
  return { col: Dl(e.w, r, n, t.gutterX), row: Dl(e.h, i, n, t.gutterY) };
}
function fi(e, t) {
...
const Mg = 1200, Hl = 0.55, kg = 0.7, Tg = 0.7, Nl = 0.5, Fl = 40, Pg = 240, Rg = 0.14, Ig = 0.7, Og = 6, Li = 18, Vg = 0.01;
function Dg(e, t, n) {
  return { x: e.x + (t.x - e.x) * n, y: e.y + (t.y - e.y) * n, zoom: e.zoom + (t.zoom - e.zoom) * n };
}
function Hg(e, t, n = Vg) {
...
const $g = 0.18, Bg = 1;
function Gf(e) {
  return Lg(e, { panelMaxWidth: Mg, gutterX: Hl * e.w, gutterY: Hl * e.h, zoom: 1 });
}
const di = X({ w: 1, h: 1 });
function Uf() {
  const e = vs(gs.id), t = fi(e, Gf(di.value));
  return { x: t.x, y: t.y, zoom: e.zoom ?? 1 };
}
const Ct = X(Uf()), qn = X(Uf()), ps = X(false), ca = X(gs.id), ua = X(0), Zf = X(typeof window < "u" && window.matchMedia ? window.matchMedia("(prefers-reduced-motion: reduce)").matches : false);
if (typeof window < "u" && window.matchMedia) {
...
const fa = H(() => Gf(di.value));
let Tn = 0;
function Kf() {
  if (Ct.value = Dg(Ct.value, qn.value, $g), Hg(Ct.value, qn.value)) {
    Ct.value = { ...qn.value }, ps.value = false, Tn = 0;
    return;
  }
  Tn = requestAnimationFrame(Kf);
}
function jg() {
  Tn === 0 && (ps.value = true, Tn = requestAnimationFrame(Kf));
}
function Wg() {
  Tn !== 0 && (cancelAnimationFrame(Tn), Tn = 0), ps.value = false;
}
function da(e, t, n) {
  Wg();
  const r = n ?? Ct.value.zoom;
  Ct.value = { x: e, y: t, zoom: r }, qn.value = { x: e, y: t, zoom: r };
}
function Yf(e, t, n = {}) {
...
function zg(e, t = {}) {
  ca.value = e, ua.value = 0;
  const n = vs(e), r = fi(n, fa.value);
  Yf(r.x, r.y, { zoom: n.zoom, snap: t.snap });
}
function Gg() {
  ca.value = null;
}
...
function Zg(e) {
  ua.value = Math.max(0, e);
}
le(fa, (e) => {
  const t = ca.value;
  if (t === null) return;
  const n = vs(t), r = fi(n, e);
  da(r.x, r.y, n.zoom ?? Ct.value.zoom);
});
const Kg = H(() => ({ transform: Ng(Ct.value, di.value) })), Yg = H(() => Fg({ x: Ct.value.x, y: Ct.value.y + ua.value, zoom: Ct.value.zoom }, typeof window < "u" ? window.devicePixelRatio : 1, Bg));
function mr() {
  return { camera: Ct, isAnimating: ps, viewport: di, spacing: fa, cameraStyle: Kg, worldOffsetDevicePx: Yg, panTo: Yf, panToWaypoint: zg, snapTo: da, releaseAnchor: Gg, setViewport: Ug, setCaptureScroll: Zg };
}
const $l = 0.1;
function qg(e) {
  const { worldOffsetDevicePx: t } = mr();
  let n = Number.NaN, r = Number.NaN;
  le(t, ({ x: i, y: s }) => {
    Math.abs(i - n) < $l && Math.abs(s - r) < $l || (n = i, r = s, e.post({ type: "camera", x: i, y: s }));
  });
}
function qf(e, t) {
  t = Array.isArray(t) ? t.slice(0, -1).map((n) => `'${n}'`).join(", ") + ` or '${t.at(-1)}'` : `'${t}'`;
}
const Ie = typeof window < "u", ma = Ie && "IntersectionObserver" in window, Xg = Ie && ("ontouchstart" in window || window.navigator.maxTouchPoints > 0), Xf = Ie && "matchMedia" in window && typeof window.matchMedia == "function", Ui = () => Xf && window.matchMedia("(prefers-reduced-motion: reduce)").matches;
function Bl(e, t, n) {
  Jg(e, t), t.set(e, n);
}
function Jg(e, t) {
...
function po(e, t, n) {
  return e == null || !t || typeof t != "string" ? n : e[t] !== void 0 ? e[t] : (t = t.replace(/\[(\w+)\]/g, ".$1"), t = t.replace(/^\./, ""), Qf(e, t.split("."), n));
}
function xr(e, t, n) {
  ...
  if (Array.isArray(t)) return Qf(e, t, n);
  if (typeof t != "function") return n;
  const r = t(e, n);
...
const tv = /^on[^a-z]/, td = (e) => tv.test(e);
function ha(e) {
...
function nd(e) {
  return e.map((t) => t.type === _e ? nd(t.children) : t).flat();
}
function Pn() {
...
class rv {
  constructor(t) {
    Bl(this, Dn, []), Bl(this, Sn, 0), this.size = t;
  }
  get isFull() {
    return Zt(Dn, this).length === this.size;
  }
  push(t) {
    Zt(Dn, this)[Zt(Sn, this)] = t, jl(Sn, this, (Zt(Sn, this) + 1) % this.size);
  }
  values() {
    return Zt(Dn, this).slice(Zt(Sn, this)).concat(Zt(Dn, this).slice(0, Zt(Sn, this)));
  }
  clear() {
    Zt(Dn, this).length = 0, jl(Sn, this, 0);
  }
}
function ga(e) {
  const t = Ue({});
...
function Ul(e, t) {
  return t = "on" + fr(t), !!(e[t] || e[`${t}Once`] || e[`${t}Capture`] || e[`${t}OnceCapture`] || e[`${t}CaptureOnce`]);
}
function Xn(e) {
...
function bo() {
  ...
  return Object.defineProperty(t, "value", { enumerable: true, get: () => e.value, set: (n) => e.value = n }), Object.defineProperty(t, "el", { enumerable: true, get: () => Qg(e.value) }), t;
}
function or(e) {
...
const sd = ["top", "bottom"], lv = ["start", "end", "left", "right"];
function _o(e, t) {
  let [n, r] = e.split(" ");
  return r || (r = Ki(sd, n) ? "start" : Ki(lv, n) ? "top" : "center"), { side: Zl(n, t), align: Zl(r, t) };
}
function Zl(e, t) {
  ...
  Object.keys(t).forEach((n) => {
    if (td(n)) {
      ...
      if (t[n] == null) i == null ? void 0 : i.forEach((s) => {
        ...
        s.add([r, t[n]]), Ii.has(e) || Ii.set(e, s);
      }
...
const Hn = 2.4, Xl = 0.2126729, Jl = 0.7151522, Ql = 0.072175, dv = 0.55, mv = 0.58, hv = 0.57, gv = 0.62, Ei = 0.03, ec = 1.45, vv = 5e-4, pv = 1.25, yv = 1.25, tc = 0.078, nc = 12.82051282051282, Mi = 0.06, rc = 1e-3;
function ic(e, t) {
  const n = (e.r / 255) ** Hn, r = (e.g / 255) ** Hn, i = (e.b / 255) ** Hn, s = (t.r / 255) ** Hn, o = (t.g / 255) ** Hn, a = (t.b / 255) ** Hn;
  let l = n * Xl + r * Jl + i * Ql, u = s * Xl + o * Jl + a * Ql;
  if (l <= Ei && (l += (Ei - l) ** ec), u <= Ei && (u += (Ei - u) ** ec), Math.abs(u - l) < vv) return 0;
  let c;
  if (u > l) {
    const f = (u ** dv - l ** mv) * pv;
    c = f < rc ? 0 : f < tc ? f - f * nc * Mi : f - Mi;
  } else {
    const f = (u ** gv - l ** hv) * yv;
    c = f > -rc ? 0 : f > -tc ? f - f * nc * Mi : f + Mi;
  }
  return c * 100;
}
const Yi = 0.20689655172413793, bv = (e) => e > Yi ** 3 ? Math.cbrt(e) : e / (3 * Yi ** 2) + 4 / 29, _v = (e) => e > Yi ? e ** 3 : 3 * Yi ** 2 * (e - 4 / 29);
function ld(e) {
  const t = bv, n = t(e[1]);
...
const wv = [[3.2406, -1.5372, -0.4986], [-0.9689, 1.8758, 0.0415], [0.0557, -0.204, 1.057]], Sv = (e) => e <= 31308e-7 ? e * 12.92 : 1.055 * e ** (1 / 2.4) - 0.055, Cv = [[0.4124, 0.3576, 0.1805], [0.2126, 0.7152, 0.0722], [0.0193, 0.1192, 0.9505]], xv = (e) => e <= 0.04045 ? e / 12.92 : ((e + 0.055) / 1.055) ** 2.4;
function ud(e) {
  const t = Array(3), n = Sv, r = wv;
  for (let i = 0; i < 3; ++i) t[i] = Math.round(Zi(n(r[i][0] * e[0] + r[i][1] * e[1] + r[i][2] * e[2])) * 255);
  return { r: t[0], g: t[1], b: t[2] };
}
function va(e) {
  let { r: t, g: n, b: r } = e;
  const i = [0, 0, 0], s = xv, o = Cv;
...
const sc = /^(?<fn>(?:rgb|hsl)a?)\((?<values>.+)\)/, Lv = { rgb: (e, t, n, r) => ({ r: e, g: t, b: n, a: r }), rgba: (e, t, n, r) => ({ r: e, g: t, b: n, a: r }), hsl: (e, t, n, r) => oc({ h: e, s: t, l: n, a: r }), hsla: (e, t, n, r) => oc({ h: e, s: t, l: n, a: r }), hsv: (e, t, n, r) => qr({ h: e, s: t, v: n, a: r }), hsva: (e, t, n, r) => qr({ h: e, s: t, v: n, a: r }) };
function Bt(e) {
  if (typeof e == "number") return { r: (e & 16711680) >> 16, g: (e & 65280) >> 8, b: e & 255 };
  if (typeof e == "string" && sc.test(e)) {
    const { groups: t } = e.match(sc), { fn: n, values: r } = t, i = r.split(/,\s*|\s*\/\s*|\s+/).map((s, o) => s.endsWith("%") || o > 0 && o < 3 && ["hsl", "hsla", "hsv", "hsva"].includes(n) ? parseFloat(s) / 100 : parseFloat(s));
    return Lv[n](...i);
  } else if (typeof e == "string") {
    let t = e.startsWith("#") ? e.slice(1) : e;
    return [3, 4].includes(t.length) ? t = t.split("").map((n) => n + n).join("") : [6, 8].includes(t.length), Mv(t);
  } else if (typeof e == "object") {
    if (Ws(e, ["r", "g", "b"])) return e;
    if (Ws(e, ["h", "s", "l"])) return qr(fd(e));
    if (Ws(e, ["h", "s", "v"])) return qr(e);
  }
...
function Ev(e) {
  ...
  return `#${[ki(t), ki(n), ki(r), i !== void 0 ? ki(Math.round(i * 255)) : ""].join("")}`;
}
function Mv(e) {
  e = kv(e);
  let [t, n, r, i] = nv(e, 2).map((s) => parseInt(s, 16));
...
function dd(e) {
  const t = Math.abs(ic(Bt(0), Bt(e)));
  return Math.abs(ic(Bt(16777215), Bt(e))) > Math.min(t, 50) ? "#fff" : "#000";
}
function ne(e, t) {
...
const ar = Symbol.for("vuetify:defaults");
function Ov(e) {
  return X(e);
}
function pa() {
...
function Dv() {
  let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, t = arguments.length > 1 ? arguments[1] : void 0, n = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : pa();
  ...
  function a() {
    const l = Iv(ar, r);
    it(ar, H(() => o.value ? pt((l == null ? void 0 : l.value) ?? {}, o.value) : l == null ? void 0 : l.value));
  }
...
function hr(e) {
  ...
  if (e._setup) {
    ...
    e.filterProps = function(r) {
      ...
      const { props: o, provideSubDefaults: a } = Dv(r, r._as ?? e.name, s), l = e._setup(o, i);
      return a(), l;
    };
  }
  return e;
...
function Hv(e) {
  ...
  return Pe()({ name: n ?? fr(_t(e.replace(/__/g, "-"))), props: { tag: { type: String, default: t }, ...qe() }, setup(r, i) {
    let { slots: s } = i;
    return () => {
      var _a2;
...
function Jn(e, t) {
  ...
  const i = Fv(e, t, n);
  return i || (Nv(e, t, n, true), r.every((s) => Jn(e[s], t[s], n)));
}
function md(e) {
...
function qi(e, t) {
  ...
  for (; e && (ba(e) && n.push(e), e !== t); ) e = e.parentElement;
  return n;
}
function ba(e) {
...
const Gv = [null, "default", "comfortable", "compact"], vi = ne({ density: { type: String, default: "default", validator: (e) => Gv.includes(e) } }, "density");
function pi(e) {
  let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : pn();
  return { densityClasses: B(() => `${t}--density-${e.density}`) };
}
const ys = ne({ elevation: { type: [Number, String], validator(e) {
  const t = parseInt(e);
...
function Uv() {
  var _a2, _b2;
  let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : cc();
  const t = cc();
...
function uc(e, t) {
  ...
  for (const [s, o] of Object.entries(e.colors)) {
    const a = Bt(o);
    i.push(`--${t}theme-${s}: ${a.r},${a.g},${a.b}`), s.startsWith("on-") || i.push(`--${t}theme-${s}-overlay-multiplier: ${Rv(o) > 0.18 ? n : r}`);
  }
...
function Zv(e, t, n) {
  ...
  if (n) for (const i of ["lighten", "darken"]) {
    const s = i === "lighten" ? Tv : Pv;
    for (const o of ed(n[i], 1)) r[`${e}-${i}-${o}`] = Ev(s(Bt(t), o));
  }
  return r;
}
function Kv(e, t) {
...
function Qv(e) {
  const t = Uv(e), n = ve(t.defaultTheme), r = X(t.themes), i = ve("light"), s = H({ get() {
    ...
    for (const [y, A] of Object.entries(r.value)) {
      const _ = { ...A.colors, ...Kv(A.colors, t.variations) };
      v[y] = { ...A, colors: { ..._, ...Yv(_) } };
    }
    return v;
  }), a = B(() => o.value[s.value]), l = B(() => n.value === "system"), u = H(() => {
    var _a2;
    const v = [], y = t.unimportant ? "" : " !important", A = t.scoped ? t.prefix : "";
    ((_a2 = a.value) == null ? void 0 : _a2.dark) && Cn(v, ":root", ["color-scheme: dark"], t.scope), Cn(v, ":root", uc(a.value, t.prefix), t.scope);
    for (const [x, E] of Object.entries(o.value)) Cn(v, `.${t.prefix}theme--${x}`, [`color-scheme: ${E.dark ? "dark" : "normal"}`, ...uc(E, t.prefix)], t.scope);
    if (t.utilities) {
      const x = [], E = [], P = new Set(Object.values(o.value).flatMap((w) => Object.keys(w.colors)));
      for (const w of P) w.startsWith("on-") ? Cn(E, `.${w}`, [`color: rgb(var(--${t.prefix}theme-${w}))${y}`], t.scope) : (Cn(x, `.${A}bg-${w}`, [`--${t.prefix}theme-overlay-multiplier: var(--${t.prefix}theme-${w}-overlay-multiplier)`, `background-color: rgb(var(--${t.prefix}theme-${w}))${y}`, `color: rgb(var(--${t.prefix}theme-on-${w}))${y}`], t.scope), Cn(E, `.${A}text-${w}`, [`color: rgb(var(--${t.prefix}theme-${w}))${y}`], t.scope), Cn(E, `.${A}border-${w}`, [`--${t.prefix}border-color: var(--${t.prefix}theme-${w})`], t.scope));
...
` + v.map((x) => `  ${x}`).join("") + `
  ...
  if (Xf) {
    ...
    y(), v.addEventListener("change", y, { passive: true }), vu() && ct(() => {
  ...
  function d(v) {
    ...
    if (y) {
      ...
      let A = function() {
        Xv(t.stylesheetId, t.cspNonce, u.value);
      };
...
function _a(e) {
  return ga(() => {
    const { class: t, style: n } = np(e);
    return { colorClasses: t, colorStyles: n };
  });
}
function Jr(e) {
  const { colorClasses: t, colorStyles: n } = _a(() => ({ text: rt(e) }));
  return { textColorClasses: t, textColorStyles: n };
}
function wa(e) {
  const { colorClasses: t, colorStyles: n } = _a(() => ({ background: rt(e) }));
...
function np(e) {
  ...
  if (t.background) if (wo(t.background)) {
    if (r.backgroundColor = t.background, !t.text && Av(t.background)) {
...
const rp = ["elevated", "flat", "tonal", "outlined", "text", "plain"];
function Sa(e, t) {
  return k(_e, null, [e && k("span", { key: "overlay", class: Le(`${t}__overlay`) }, null), k("span", { key: "underlay", class: Le(`${t}__underlay`) }, null)]);
}
const yi = ne({ color: String, variant: { type: String, default: "elevated", validator: (e) => rp.includes(e) } }, "variant");
function Ca(e) {
  let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : pn();
  const n = B(() => {
    const { variant: s } = rt(e);
    return `${t}--variant-${s}`;
  }), { colorClasses: r, colorStyles: i } = _a(() => {
...
const hd = ne({ baseColor: String, divided: Boolean, direction: { type: String, default: "horizontal" }, ...hi(), ...qe(), ...vi(), ...ys(), ...gr(), ...Rt(), ...Gt(), ...yi() }, "VBtnGroup"), fc = Pe()({ name: "VBtnGroup", props: hd(), setup(e, t) {
  let { slots: n } = t;
  const { themeClasses: r } = sn(e), { densityClasses: i } = pi(e), { borderClasses: s } = gi(e), { elevationClasses: o } = bs(e), { roundedClasses: a } = vr(e);
  ya({ VBtn: { height: B(() => e.direction === "horizontal" ? "auto" : null), baseColor: B(() => e.baseColor), color: B(() => e.color), density: B(() => e.density), flat: true, variant: B(() => e.variant) } }), ze(() => T(e.tag, { class: Le(["v-btn-group", `v-btn-group--${e.direction}`, { "v-btn-group--divided": e.divided }, r.value, s.value, i.value, o.value, a.value, e.class]), style: He(e.style) }, n));
} });
function _s(e, t) {
  let n;
  function r() {
...
function Qt(e, t, n) {
  ...
  const s = Ze("useProxiedModel"), o = X(e[t] !== void 0 ? e[t] : n), a = Pn(t), u = H(a !== t ? () => {
    var _a2, _b2, _c2, _d2;
...
const ip = ne({ modelValue: { type: null, default: void 0 }, multiple: Boolean, mandatory: [Boolean, String], max: Number, selectedClass: String, disabled: Boolean }, "group"), sp = ne({ value: null, disabled: Boolean, selectedClass: String }, "group-item");
function op(e, t) {
  ...
  const o = B(() => e.value), a = H(() => !!(s.disabled.value || e.disabled));
  function l() {
  ...
  l(), zt(() => u());
  const c = H(() => s.isSelected(i)), f = H(() => s.items.value[0].id === i), d = H(() => s.items.value[s.items.value.length - 1].id === i), m = H(() => c.value && [s.selectedClass.value, e.selectedClass]);
  return le(c, (b) => {
...
function ap(e, t) {
  let n = false;
  const r = Ue([]), i = Qt(e, "modelValue", [], (d) => d === void 0 ? [] : gd(r, d === null ? [null] : ha(d)), (d) => {
    const m = cp(r, d);
    return e.multiple ? m : m[0];
  }), s = Ze("useGroup");
  function o(d, m) {
    const b = d, g = Symbol.for(`${t.description}:id`), v = jn(g, s == null ? void 0 : s.vnode).indexOf(m);
  ...
  const f = { register: o, unregister: a, selected: i, select: u, disabled: B(() => e.disabled), prev: () => c(r.length - 1), next: () => c(1), isSelected: (d) => i.value.includes(d), selectedClass: B(() => e.selectedClass), items: B(() => r), getItemIndex: (d) => lp(r, d) };
  return it(t, f), f;
}
function lp(e, t) {
  const n = gd(e, [t]);
...
function gd(e, t) {
  const n = [];
  return t.forEach((r) => {
    const i = e.find((o) => Jn(r, o.value)), s = e[r];
...
const vd = Symbol.for("vuetify:v-btn-toggle"), up = ne({ ...hd(), ...ip() }, "VBtnToggle"), fp = Pe()({ name: "VBtnToggle", props: up(), emits: { "update:modelValue": (e) => true }, setup(e, t) {
  let { slots: n } = t;
  const { isSelected: r, next: i, prev: s, select: o, selected: a } = ap(e, vd);
  return ze(() => {
    const l = fc.filterProps(e);
    return T(fc, Re({ class: ["v-btn-toggle", e.class] }, l, { style: e.style }), { default: () => {
      var _a2;
      return [(_a2 = n.default) == null ? void 0 : _a2.call(n, { isSelected: r, next: i, prev: s, select: o, selected: a })];
    } });
  }), { next: i, prev: s, select: o };
} }), dp = ne({ defaults: Object, disabled: Boolean, reset: [Number, String], root: [Boolean, String], scoped: Boolean }, "VDefaultsProvider"), mn = Pe(false)({ name: "VDefaultsProvider", props: dp(), setup(e, t) {
  let { slots: n } = t;
  const { defaults: r, disabled: i, reset: s, root: o, scoped: a } = Ou(e);
  return ya(r, { reset: s, root: o, scoped: a, disabled: i }), () => {
    var _a2;
    return (_a2 = n.default) == null ? void 0 : _a2.call(n);
  };
} }), yt = [String, Function, Object, Array], Co = Symbol.for("vuetify:icons"), ws = ne({ icon: { type: yt }, tag: { type: [String, Object, Function], required: true } }, "icon"), dc = Pe()({ name: "VComponentIcon", props: ws(), setup(e, t) {
  let { slots: n } = t;
  return () => {
    const r = e.icon;
    return T(e.tag, null, { default: () => {
      var _a2;
      return [e.icon ? T(r, null, null) : (_a2 = n.default) == null ? void 0 : _a2.call(n)];
    } });
  };
} }), xa = hr({ name: "VSvgIcon", inheritAttrs: false, props: ws(), setup(e, t) {
  let { attrs: n } = t;
  return () => T(e.tag, Re(n, { style: null }), { default: () => [k("svg", { class: "v-icon__svg", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", role: "img", "aria-hidden": "true" }, [Array.isArray(e.icon) ? e.icon.map((r) => Array.isArray(r) ? k("path", { d: r[0], "fill-opacity": r[1] }, null) : k("path", { d: r }, null)) : k("path", { d: e.icon }, null)])] });
} });
hr({ name: "VLigatureIcon", props: ws(), setup(e) {
  return () => T(e.tag, null, { default: () => [e.icon] });
} });
const pd = hr({ name: "VClassIcon", props: ws(), setup(e) {
  return () => T(e.tag, { class: Le(e.icon) }, null);
} }), mp = (e) => {
  const t = Me(Co);
  ...
  return { iconData: H(() => {
    var _a2;
    const r = rt(e);
    if (!r) return { component: dc };
    let i = r;
    if (typeof i == "string" && (i = i.trim(), i.startsWith("$") && (i = (_a2 = t.aliases) == null ? void 0 : _a2[i.slice(1)])), Array.isArray(i)) return { component: xa, icon: i };
    if (typeof i != "string") return { component: dc, icon: i };
...
}, hp = ["x-small", "small", "default", "large", "x-large"], Ss = ne({ size: { type: [String, Number], default: "default" } }, "size");
function Cs(e) {
  let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : pn();
  return ga(() => {
    const n = e.size;
    let r, i;
    return Ki(hp, n) ? r = `${t}--size-${n}` : n && (i = { width: pe(n), height: pe(n) }), { sizeClasses: r, sizeStyles: i };
  });
}
const gp = ne({ color: String, disabled: Boolean, start: Boolean, end: Boolean, icon: yt, opacity: [String, Number], ...qe(), ...Ss(), ...Rt({ tag: "i" }), ...Gt() }, "VIcon"), st = Pe()({ name: "VIcon", props: gp(), setup(e, t) {
  let { attrs: n, slots: r } = t;
  const i = ve(), { themeClasses: s } = ep(), { iconData: o } = mp(() => i.value || e.icon), { sizeClasses: a } = Cs(e), { textColorClasses: l, textColorStyles: u } = Jr(() => e.color);
  return ze(() => {
    var _a2, _b2;
    const c = (_a2 = r.default) == null ? void 0 : _a2.call(r);
    c && (i.value = (_b2 = nd(c).filter((d) => d.type === li && d.children && typeof d.children == "string")[0]) == null ? void 0 : _b2.children);
    const f = !!(n.onClick || n.onClickOnce);
    return T(o.value.component, { tag: e.tag, icon: o.value.icon, class: Le(["v-icon", "notranslate", s.value, a.value, l.value, { "v-icon--clickable": f, "v-icon--disabled": e.disabled, "v-icon--start": e.start, "v-icon--end": e.end }, e.class]), style: He([{ "--v-icon-opacity": e.opacity }, a.value ? void 0 : { fontSize: pe(e.size), height: pe(e.size), width: pe(e.size) }, u.value, e.style]), role: f ? "button" : void 0, "aria-hidden": !f, tabindex: f ? e.disabled ? -1 : 0 : void 0 }, { default: () => [c] });
  }), {};
} });
function vp(e, t) {
...
function yd(e) {
  ...
  return { resizeRef: n, contentRect: Qn(r) };
}
const pp = ne({ reveal: { type: [Boolean, Object], default: false } }, "reveal");
function yp(e) {
...
const bp = ne({ bgColor: String, color: String, indeterminate: [Boolean, String], rounded: Boolean, modelValue: { type: [Number, String], default: 0 }, rotate: { type: [Number, String], default: 0 }, width: { type: [Number, String], default: 4 }, ...qe(), ...pp(), ...Ss(), ...Rt({ tag: "div" }), ...Gt() }, "VProgressCircular"), _p = Pe()({ name: "VProgressCircular", props: bp(), setup(e, t) {
  let { slots: n } = t;
  const r = 20, i = 2 * Math.PI * r, s = X(), { themeClasses: o } = sn(e), { sizeClasses: a, sizeStyles: l } = Cs(e), { textColorClasses: u, textColorStyles: c } = Jr(() => e.color), { textColorClasses: f, textColorStyles: d } = Jr(() => e.bgColor), { intersectionRef: m, isIntersecting: b } = vp(), { resizeRef: g, contentRect: S } = yd(), { state: v, duration: y } = yp(e), A = B(() => v.value === "initial" ? 0 : Zi(parseFloat(e.modelValue), 0, 100)), _ = B(() => Number(e.width)), x = B(() => l.value ? Number(e.size) : S.value ? S.value.width : Math.max(_.value, 32)), E = B(() => r / (1 - _.value / x.value) * 2), P = B(() => _.value / x.value * E.value), w = B(() => {
    const R = (100 - A.value) / 100 * i;
    return e.rounded && A.value > 0 && A.value < 100 ? pe(Math.min(i - 0.01, R + P.value)) : pe(R);
  }), D = H(() => {
    const R = Number(e.rotate);
    return e.rounded ? R + P.value / 2 / i * 360 : R;
  });
  return gn(() => {
    m.value = s.value, g.value = s.value;
  }), ze(() => T(e.tag, { ref: s, class: Le(["v-progress-circular", { "v-progress-circular--indeterminate": !!e.indeterminate, "v-progress-circular--visible": b.value, "v-progress-circular--disable-shrink": e.indeterminate && (e.indeterminate === "disable-shrink" || Ui()), "v-progress-circular--revealing": ["initial", "pending"].includes(v.value) }, o.value, a.value, u.value, e.class]), style: He([l.value, c.value, { "--progress-reveal-duration": `${y.value}ms` }, e.style]), role: "progressbar", "aria-valuemin": "0", "aria-valuemax": "100", "aria-valuenow": e.indeterminate ? void 0 : A.value }, { default: () => [k("svg", { style: { transform: `rotate(calc(-90deg + ${D.value}deg))` }, xmlns: "http://www.w3.org/2000/svg", viewBox: `0 0 ${E.value} ${E.value}` }, [k("circle", { class: Le(["v-progress-circular__underlay", f.value]), style: He(d.value), fill: "transparent", cx: "50%", cy: "50%", r, "stroke-width": P.value, "stroke-dasharray": i, "stroke-dashoffset": 0 }, null), k("circle", { class: "v-progress-circular__overlay", fill: "transparent", cx: "50%", cy: "50%", r, "stroke-width": P.value, "stroke-dasharray": i, "stroke-dashoffset": w.value, "stroke-linecap": e.rounded ? "round" : void 0 }, null)]), n.default && k("div", { class: "v-progress-circular__content" }, [n.default({ value: A.value })])] })), {};
...
function wd(e) {
  return (t) => {
    const n = Us(t, "locale", e.current), r = Us(t, "fallback", e.fallback), i = Us(t, "messages", e.messages);
    return { name: "vuetify", current: n, fallback: r, messages: i, decimalSeparator: B(() => _d(n, r)), t: bd(n, r, i), n: Aa(n, r), provide: wd({ current: n, fallback: r, messages: i }) };
  };
}
function Sp(e) {
  const t = ve((e == null ? void 0 : e.locale) ?? "en"), n = ve((e == null ? void 0 : e.fallback) ?? "en"), r = X({ en: wp, ...e == null ? void 0 : e.messages });
  return { name: "vuetify", current: t, fallback: n, messages: r, decimalSeparator: B(() => (e == null ? void 0 : e.decimalSeparator) ?? _d(t, n)), t: bd(t, n, r), n: Aa(t, n), provide: wd({ current: t, fallback: n, messages: r }) };
}
...
function xp(e) {
  const t = (e == null ? void 0 : e.adapter) && Cp(e == null ? void 0 : e.adapter) ? e == null ? void 0 : e.adapter : Sp(e), n = Lp(t, e);
  return { ...t, ...n };
}
function Ap() {
...
function Lp(e, t) {
  const n = X((t == null ? void 0 : t.rtl) ?? Ap()), r = H(() => n.value[e.current.value] ?? false);
...
const gc = { center: "center", top: "bottom", bottom: "top", left: "right", right: "left" }, Ep = ne({ location: String }, "location");
function Mp(e) {
  ...
  return { locationStyles: H(() => {
    ...
    const l = {};
    return s !== "center" && (t ? l[gc[s]] = `calc(100% - ${a(s)}px)` : l[s] = 0), o !== "center" ? t ? l[gc[o]] = `calc(100% - ${a(o)}px)` : l[o] = 0 : (s === "center" ? l.top = l.left = "50%" : l[{ top: "left", bottom: "left", left: "top", right: "top" }[s]] = "50%", l.transform = { top: "translateX(-50%)", bottom: "translateX(-50%)", left: "translateY(-50%)", right: "translateY(-50%)", center: "translate(-50%, -50%)" }[s]), l;
  }) };
}
const kp = ne({ loading: [Boolean, String] }, "loader");
function Tp(e) {
  let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : pn();
  return { loaderClasses: B(() => ({ [`${t}--loading`]: e.loading })) };
}
const Pp = ["static", "relative", "fixed", "absolute", "sticky"], Rp = ne({ position: { type: String, validator: (e) => Pp.includes(e) } }, "position");
function Ip(e) {
  let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : pn();
...
function Sd(e, t) {
  const n = ph("RouterLink"), r = B(() => !!(e.href || e.to)), i = H(() => (r == null ? void 0 : r.value) || Ul(t, "click") || Ul(e, "click"));
  ...
  const s = n.useLink({ to: B(() => e.to || ""), replace: B(() => e.replace) }), o = H(() => e.to ? s : void 0), a = Op(), l = H(() => {
    var _a2, _b2, _c2;
    return o.value ? e.exact ? a.value ? ((_a2 = o.value.isExactActive) == null ? void 0 : _a2.value) && Jn(o.value.route.value.query, a.value.query) : ((_b2 = o.value.isExactActive) == null ? void 0 : _b2.value) ?? false : ((_c2 = o.value.isActive) == null ? void 0 : _c2.value) ?? false : false;
  }), u = H(() => {
    var _a2;
...
const Cd = ne({ href: String, replace: Boolean, to: [String, Object], exact: Boolean }, "router");
let Zs = false;
function Dp(e, t) {
  let n = false, r, i;
  Ie && (e == null ? void 0 : e.beforeEach) && (dt(() => {
    window.addEventListener("popstate", s), r = e.beforeEach((o, a, l) => {
      Zs ? n ? t(l) : l() : setTimeout(() => n ? t(l) : l()), Zs = true;
...
const Ao = Symbol("rippleStop"), Np = 80;
function vc(e, t) {
...
const Fp = function(e, t) {
  ...
  const { radius: s, scale: o, x: a, y: l, centerX: u, centerY: c } = Fp(e, t, n), f = `${s * 2}px`;
  i.className = "v-ripple__animation", i.style.width = f, i.style.height = f, t.appendChild(r);
  const d = window.getComputedStyle(t);
  d && d.position === "static" && (t.style.position = "relative", t.dataset.previousPosition = "static"), i.classList.add("v-ripple__animation--enter"), i.classList.add("v-ripple__animation--visible"), vc(i, `translate(${a}, ${l}) scale3d(${o},${o},${o})`), i.dataset.activated = String(performance.now()), requestAnimationFrame(() => {
    requestAnimationFrame(() => {
      i.classList.remove("v-ripple__animation--enter"), i.classList.add("v-ripple__animation--in"), vc(i, `translate(${u}, ${c}) scale3d(1,1,1)`);
    });
  });
}, hide(e) {
  var _a2;
...
function Qr(e) {
  ...
  if (!(!(n == null ? void 0 : n._ripple) || n._ripple.touched || e[Ao])) {
    ...
    if (t.center = n._ripple.centered || xd(e), n._ripple.class && (t.class = n._ripple.class), Lo(e)) {
...
function kd(e, t, n) {
  const { value: r, modifiers: i } = t, s = Ad(r);
  s || Xi.hide(e), e._ripple = e._ripple ?? {}, e._ripple.enabled = s, e._ripple.centered = i.center, e._ripple.circle = i.circle;
  const o = yo(r) ? r : {};
  o.class && (e._ripple.class = o.class);
  const a = o.keys ?? ["Enter", "Space"];
  if (e._ripple.keyDownHandler = (l) => $p(l, a), s && !n) {
    if (i.stop) {
      e.addEventListener("touchstart", Ji, { passive: true }), e.addEventListener("mousedown", Ji);
      return;
    }
    e.addEventListener("touchstart", Qr, { passive: true }), e.addEventListener("touchend", gt, { passive: true }), e.addEventListener("touchmove", Ld, { passive: true }), e.addEventListener("touchcancel", gt), e.addEventListener("mousedown", Qr), e.addEventListener("mouseup", gt), e.addEventListener("mouseleave", gt), e.addEventListener("keydown", e._ripple.keyDownHandler), e.addEventListener("keyup", Ed), e.addEventListener("blur", Md), e.addEventListener("dragstart", gt, { passive: true });
  } else !s && n && Td(e);
}
function Td(e) {
  var _a2;
  e.removeEventListener("touchstart", Ji), e.removeEventListener("mousedown", Ji), e.removeEventListener("touchstart", Qr), e.removeEventListener("touchend", gt), e.removeEventListener("touchmove", Ld), e.removeEventListener("touchcancel", gt), e.removeEventListener("mousedown", Qr), e.removeEventListener("mouseup", gt), e.removeEventListener("mouseleave", gt), ((_a2 = e._ripple) == null ? void 0 : _a2.keyDownHandler) && e.removeEventListener("keydown", e._ripple.keyDownHandler), e.removeEventListener("keyup", Ed), e.removeEventListener("blur", Md), e.removeEventListener("dragstart", gt);
}
function Bp(e, t) {
  kd(e, t, false);
}
function jp(e) {
  Td(e), delete e._ripple;
}
function Wp(e, t) {
  if (t.value === t.oldValue) return;
  const n = Ad(t.oldValue);
  kd(e, t, n);
}
const Eo = { mounted: Bp, unmounted: jp, updated: Wp }, zp = ne({ active: { type: Boolean, default: void 0 }, activeColor: String, baseColor: String, symbol: { type: null, default: vd }, flat: Boolean, icon: [Boolean, String, Function, Object], prependIcon: yt, appendIcon: yt, block: Boolean, readonly: Boolean, slim: Boolean, stacked: Boolean, spaced: String, ripple: { type: [Boolean, Object], default: true }, text: { type: [String, Number, Boolean], default: void 0 }, ...hi(), ...qe(), ...vi(), ...pr(), ...ys(), ...sp(), ...kp(), ...Ep(), ...Rp(), ...gr(), ...Cd(), ...Ss(), ...Rt({ tag: "button" }), ...Gt(), ...yi({ variant: "elevated" }) }, "VBtn"), Oi = Pe()({ name: "VBtn", props: zp(), emits: { "group:selected": (e) => true }, setup(e, t) {
  let { attrs: n, slots: r } = t;
  const { themeClasses: i } = sn(e), { borderClasses: s } = gi(e), { densityClasses: o } = pi(e), { dimensionStyles: a } = yr(e), { elevationClasses: l } = bs(e), { loaderClasses: u } = Tp(e), { locationStyles: c } = Mp(e), { positionClasses: f } = Ip(e), { roundedClasses: d } = vr(e), { sizeClasses: m, sizeStyles: b } = Cs(e), g = op(e, e.symbol, false), S = Sd(e, n), v = H(() => {
    var _a2;
  ...
  }), { colorClasses: _, colorStyles: x, variantClasses: E } = Ca(A), P = H(() => (g == null ? void 0 : g.disabled.value) || e.disabled), w = B(() => e.variant === "elevated" && !(e.disabled || e.flat || e.border)), D = H(() => {
    if (!(e.value === void 0 || typeof e.value == "symbol")) return Object(e.value) === e.value ? JSON.stringify(e.value, null, 0) : e.value;
  });
  function R(N) {
    var _a2, _b2;
    P.value || S.isLink.value && (N.metaKey || N.ctrlKey || N.shiftKey || N.button !== 0 || n.target === "_blank") || (S.isRouterLink.value ? (_b2 = (_a2 = S.navigate).value) == null ? void 0 : _b2.call(_a2, N) : g == null ? void 0 : g.toggle());
  }
  return Hp(S, g == null ? void 0 : g.select), ze(() => {
    const N = S.isLink.value ? "a" : e.tag, M = !!(e.prependIcon || r.prepend), $ = !!(e.appendIcon || r.append), Y = !!(e.icon && e.icon !== true);
    return tr(T(N, Re(S.linkProps, { type: N === "a" ? void 0 : "button", class: ["v-btn", g == null ? void 0 : g.selectedClass.value, { "v-btn--active": v.value, "v-btn--block": e.block, "v-btn--disabled": P.value, "v-btn--elevated": w.value, "v-btn--flat": e.flat, "v-btn--icon": !!e.icon, "v-btn--loading": e.loading, "v-btn--readonly": e.readonly, "v-btn--slim": e.slim, "v-btn--stacked": e.stacked }, e.spaced ? ["v-btn--spaced", `v-btn--spaced-${e.spaced}`] : [], i.value, s.value, _.value, o.value, l.value, u.value, f.value, d.value, m.value, E.value, e.class], style: [x.value, a.value, c.value, b.value, e.style], "aria-busy": e.loading ? true : void 0, disabled: P.value && N !== "a" || void 0, tabindex: e.loading || e.readonly ? -1 : void 0, onClick: R, value: D.value }), { default: () => {
      var _a2;
      return [Sa(true, "v-btn"), !e.icon && M && k("span", { key: "prepend", class: "v-btn__prepend" }, [r.prepend ? T(mn, { key: "prepend-defaults", disabled: !e.prependIcon, defaults: { VIcon: { icon: e.prependIcon } } }, r.prepend) : T(st, { key: "prepend-icon", icon: e.prependIcon }, null)]), k("span", { class: "v-btn__content", "data-no-activator": "" }, [!r.default && Y ? T(st, { key: "content-icon", icon: e.icon }, null) : T(mn, { key: "content-defaults", disabled: !Y, defaults: { VIcon: { icon: e.icon } } }, { default: () => {
        var _a3;
        return [((_a3 = r.default) == null ? void 0 : _a3.call(r)) ?? ye(e.text)];
      } })]), !e.icon && $ && k("span", { key: "append", class: "v-btn__append" }, [r.append ? T(mn, { key: "append-defaults", disabled: !e.appendIcon, defaults: { VIcon: { icon: e.appendIcon } } }, r.append) : T(st, { key: "append-icon", icon: e.appendIcon }, null)]), !!e.loading && k("span", { key: "loader", class: "v-btn__loader" }, [((_a2 = r.loader) == null ? void 0 : _a2.call(r)) ?? T(_p, { color: typeof e.loading == "boolean" ? void 0 : e.loading, indeterminate: true, width: "2" }, null)])];
    } }), [[Eo, !P.value && e.ripple, "", { center: !!e.icon }]]);
  }), { group: g };
} }), Gp = ["dotted", "dashed", "solid", "double"], Up = ne({ color: String, contentOffset: [Number, String, Array], gradient: Boolean, inset: Boolean, length: [Number, String], opacity: [Number, String], thickness: [Number, String], vertical: Boolean, variant: { type: String, default: "solid", validator: (e) => Gp.includes(e) }, ...qe(), ...Gt() }, "VDivider"), Zp = Pe()({ name: "VDivider", props: Up(), setup(e, t) {
  let { attrs: n, slots: r } = t;
  const { themeClasses: i } = sn(e), { textColorClasses: s, textColorStyles: o } = Jr(() => e.color), a = H(() => {
    const u = {};
...
} }), Kp = ne({ fluid: { type: Boolean, default: false }, ...qe(), ...pr(), ...Rt() }, "VContainer"), _i = Pe()({ name: "VContainer", props: Kp(), setup(e, t) {
  let { slots: n } = t;
  const { rtlClasses: r } = bi(), { dimensionStyles: i } = yr(e);
  return ze(() => T(e.tag, { class: Le(["v-container", { "v-container--fluid": e.fluid }, r.value, e.class]), style: He([i.value, e.style]) }, n)), {};
} }), Mo = Symbol.for("vuetify:display"), pc = { mobileBreakpoint: "lg", thresholds: { xs: 0, sm: 600, md: 960, lg: 1280, xl: 1920, xxl: 2560 } }, Yp = function() {
...
function _c(e) {
  ...
  return { android: r, ios: i, cordova: s, electron: o, chrome: a, edge: l, firefox: u, opera: c, win: f, mac: d, linux: m, touch: Xg, ssr: t === "ssr" };
}
function qp(e, t) {
  const { thresholds: n, mobileBreakpoint: r } = Yp(e), i = ve(bc(t)), s = ve(_c(t)), o = Ue({}), a = ve(yc(t));
  function l() {
    i.value = bc(), a.value = yc();
  }
  function u() {
    l(), s.value = _c();
  }
...
const Jp = ne({ disabled: Boolean, group: Boolean, hideOnLeave: Boolean, leaveAbsolute: Boolean, mode: String, origin: String }, "transition");
function wt(e, t, n) {
  return Pe()({ name: e, props: Jp({ mode: n, origin: t }), setup(r, i) {
    let { slots: s } = i;
...
function La(e, t) {
  ...
  return Pe()({ name: e, props: { mode: { type: String, default: n }, disabled: { type: Boolean, default: Ui() }, group: Boolean, hideOnLeave: Boolean }, setup(r, i) {
    let { slots: s } = i;
    const o = r.group ? oa : sr;
...
const Qp = ne({ target: [Object, Array] }, "v-dialog-transition"), Ks = /* @__PURE__ */ new WeakMap(), ey = Pe()({ name: "VDialogTransition", props: Qp(), setup(e, t) {
  let { slots: n } = t;
  const r = { onBeforeEnter(i) {
    ...
    const o = Sc(e.target, i), { x: a, y: l, sx: u, sy: c, speed: f } = o;
    if (Ks.set(i, o), Ui()) An(i, [{ opacity: 0 }, {}], { duration: 125 * f, easing: ac }).finished.then(() => s());
    else {
      const d = An(i, [{ transform: `translate(${a}px, ${l}px) scale(${u}, ${c})`, opacity: 0 }, {}], { duration: 225 * f, easing: ac });
      (_a2 = wc(i)) == null ? void 0 : _a2.forEach((m) => {
    ...
    let o;
    !Ks.has(i) || Array.isArray(e.target) || e.target.offsetParent || e.target.getClientRects().length ? o = Sc(e.target, i) : o = Ks.get(i);
    const { x: a, y: l, sx: u, sy: c, speed: f } = o;
    Ui() ? An(i, [{}, { opacity: 0 }], { duration: 85 * f, easing: lc }).finished.then(() => s()) : (An(i, [{}, { transform: `translate(${a}px, ${l}px) scale(${u}, ${c})`, opacity: 0 }], { duration: 125 * f, easing: lc }).finished.then(() => s()), (_a2 = wc(i)) == null ? void 0 : _a2.forEach((m) => {
      An(m, [{}, { opacity: 0, offset: 0.2 }, { opacity: 0 }], { duration: 250 * f, easing: So });
    }));
  }, onAfterLeave(i) {
    i.style.removeProperty("pointer-events");
  } };
  return () => e.target ? T(sr, Re({ name: "dialog-transition" }, r, { css: false }), n) : T(sr, { name: "dialog-transition" }, n);
} });
function wc(e) {
  var _a2;
...
function Sc(e, t) {
  const n = od(e), r = ad(t), [i, s] = getComputedStyle(t).transformOrigin.split(" ").map((v) => parseFloat(v)), [o, a] = getComputedStyle(t).getPropertyValue("--v-overlay-anchor-origin").split(" ");
...
const ty = La("expand-transition", Ea());
La("expand-x-transition", Ea("", "x"));
La("expand-both-transition", Ea("", "both"));
function ny(e) {
...
const Pd = ne({ aspectRatio: [String, Number], contentClass: null, inline: Boolean, ...qe(), ...pr() }, "VResponsive"), Cc = Pe()({ name: "VResponsive", props: Pd(), setup(e, t) {
  let { slots: n } = t;
  const { aspectStyles: r } = ny(e), { dimensionStyles: i } = yr(e);
  return ze(() => {
    var _a2;
...
} }), Rd = ne({ transition: { type: null, default: "fade-transition", validator: (e) => e !== true } }, "transition"), Wn = (e, t) => {
  let { slots: n } = t;
  const { transition: r, disabled: i, group: s, ...o } = e, { component: a = s ? oa : sr, ...l } = yo(r) ? r : {};
  let u;
  return yo(r) ? u = Re(l, av({ disabled: i, group: s }), o) : u = Re({ name: i || !r ? "" : r }, o), vn(a, u, n);
};
function xc(e, t) {
  if (!ma) return;
  const n = t.modifiers || {}, r = t.value, { handler: i, options: s } = typeof r == "object" ? r : { handler: r, options: {} }, o = new IntersectionObserver(function() {
    ...
    i && (!n.quiet || u.init) && (!n.once || c || u.init) && i(c, a, l), c && n.once ? ko(e, t) : u.init = true;
  }, s);
...
const Ac = { mounted: xc, unmounted: ko, updated: (e, t) => {
  var _a2;
  ((_a2 = e._observe) == null ? void 0 : _a2[t.instance.$.uid]) && (ko(e, t), xc(e, t));
} }, ry = ne({ absolute: Boolean, alt: String, cover: Boolean, color: String, draggable: { type: [Boolean, String], default: void 0 }, eager: Boolean, gradient: String, imageClass: null, lazySrc: String, options: { type: Object, default: () => ({ root: void 0, rootMargin: void 0, threshold: void 0 }) }, sizes: String, src: { type: [String, Object], default: "" }, crossorigin: String, referrerpolicy: String, srcset: String, position: String, ...Pd(), ...qe(), ...gr(), ...Rd() }, "VImg"), iy = Pe()({ name: "VImg", directives: { vIntersect: Ac }, props: ry(), emits: { loadstart: (e) => true, load: (e) => true, error: (e) => true }, setup(e, t) {
  let { emit: n, slots: r } = t;
  const { backgroundColorClasses: i, backgroundColorStyles: s } = wa(() => e.color), { roundedClasses: o } = vr(e), a = Ze("VImg"), l = ve(""), u = X(), c = ve(e.eager ? "loading" : "idle"), f = ve(), d = ve(), m = H(() => e.src && typeof e.src == "object" ? { src: e.src.src, srcset: e.srcset || e.src.srcset, lazySrc: e.lazySrc || e.src.lazySrc, aspect: Number(e.aspectRatio || e.src.aspect || 0) } : { src: e.src, srcset: e.srcset, lazySrc: e.lazySrc, aspect: Number(e.aspectRatio || 0) }), b = H(() => m.value.aspect || f.value / d.value || 0);
  le(() => e.src, () => {
    g(c.value !== "idle");
  }), le(b, (M, $) => {
    !M && $ && u.value && _(u.value);
  ...
  const x = B(() => ({ "v-img__img--cover": e.cover, "v-img__img--contain": !e.cover })), E = () => {
    ...
    return T(Wn, { transition: e.transition, appear: true }, { default: () => [tr($ ? k("picture", { class: "v-img__picture" }, [$, M]) : M, [[sa, c.value === "loaded"]])] });
  }, P = () => T(Wn, { transition: e.transition }, { default: () => [m.value.lazySrc && c.value !== "loaded" && k("img", { class: Le(["v-img__img", "v-img__img--preload", x.value]), style: { objectPosition: e.position }, crossorigin: e.crossorigin, src: m.value.lazySrc, alt: e.alt, referrerpolicy: e.referrerpolicy, draggable: e.draggable }, null)] }), w = () => r.placeholder ? T(Wn, { transition: e.transition, appear: true }, { default: () => [(c.value === "loading" || c.value === "error" && !r.error) && k("div", { class: "v-img__placeholder" }, [r.placeholder()])] }) : null, D = () => r.error ? T(Wn, { transition: e.transition, appear: true }, { default: () => [c.value === "error" && k("div", { class: "v-img__error" }, [r.error()])] }) : null, R = () => e.gradient ? k("div", { class: "v-img__gradient", style: { backgroundImage: `linear-gradient(${e.gradient})` } }, null) : null, N = ve(false);
  {
    const M = le(b, ($) => {
      $ && (requestAnimationFrame(() => {
        requestAnimationFrame(() => {
  ...
  return ze(() => {
    const M = Cc.filterProps(e);
    return tr(T(Cc, Re({ class: ["v-img", { "v-img--absolute": e.absolute, "v-img--booting": !N.value, "v-img--fit-content": e.width === "fit-content" }, i.value, o.value, e.class], style: [{ width: pe(e.width === "auto" ? f.value : e.width) }, s.value, e.style] }, M, { aspectRatio: b.value, "aria-label": e.alt, role: e.alt ? "img" : void 0 }), { additional: () => k(_e, null, [T(E, null, null), T(P, null, null), T(R, null, null), T(w, null, null), T(D, null, null)]), default: r.default }), [[Ac, { handler: g, options: e.options }, null, { once: true }]]);
  }), { currentSrc: l, image: u, state: c, naturalWidth: f, naturalHeight: d };
} }), sy = ne({ start: Boolean, end: Boolean, icon: yt, image: String, text: String, ...hi(), ...qe(), ...vi(), ...gr(), ...Ss(), ...Rt(), ...Gt(), ...yi({ variant: "flat" }) }, "VAvatar"), Lc = Pe()({ name: "VAvatar", props: sy(), setup(e, t) {
  let { slots: n } = t;
  const { themeClasses: r } = sn(e), { borderClasses: i } = gi(e), { colorClasses: s, colorStyles: o, variantClasses: a } = Ca(e), { densityClasses: l } = pi(e), { roundedClasses: u } = vr(e), { sizeClasses: c, sizeStyles: f } = Cs(e);
  return ze(() => T(e.tag, { class: Le(["v-avatar", { "v-avatar--start": e.start, "v-avatar--end": e.end }, r.value, i.value, s.value, l.value, u.value, c.value, a.value, e.class]), style: He([o.value, f.value, e.style]) }, { default: () => [n.default ? T(mn, { key: "content-defaults", defaults: { VImg: { cover: true, src: e.image }, VIcon: { icon: e.icon } } }, { default: () => [n.default()] }) : e.image ? T(iy, { key: "image", src: e.image, alt: "", cover: true }, null) : e.icon ? T(st, { key: "icon", icon: e.icon }, null) : e.text, Sa(false, "v-avatar")] })), {};
...
function Id(e) {
  ...
  return e[Ys] = n, new Proxy(e, { get(i, s) {
    ...
    if (!(typeof s == "symbol" || s.startsWith("$") || s.startsWith("__"))) {
      ...
      for (const a of n) {
        const l = a.value && a.value[Ys];
        if (!l) continue;
        const u = l.slice();
        for (; u.length; ) {
          const c = u.shift(), f = qs(c.value, s);
          if (f) return f;
          const d = c.value && c.value[Ys];
          d && u.push(...d);
        }
      }
    }
...
const oy = Symbol.for("vuetify:goto");
function ay() {
  return { container: void 0, duration: 300, layout: false, offset: 0, easing: "easeInOutCubic", patterns: $v };
}
function ly(e, t) {
...
function Od() {
  ...
  const t = Me(To, { filterable: false, hasPrepend: ve(false), updateHasPrepend: () => null, trackingIndex: ve(-1), navigationStrategy: ve("focus"), uid: "" }), { filterable: n, trackingIndex: r = t.trackingIndex, navigationStrategy: i = t.navigationStrategy, uid: s = t.uid || oi() } = e, o = { filterable: t.filterable || n, hasPrepend: ve(false), updateHasPrepend: (a) => {
...
const Ma = (e) => {
  const t = { activate: (n) => {
    ...
    if (n != null) for (const o of ha(n)) s = t.activate({ id: o, value: true, activated: new Set(s), children: r, parents: i });
    return s;
  }, out: (n) => Array.from(n) };
  return t;
}, Dd = (e) => {
  ...
  return r;
}, select: () => null }, dy = { open: Hd.open, select: (e) => {
  let { id: t, value: n, opened: r, parents: i } = e;
  if (!n) return r;
  const s = [];
  let o = i.get(t);
  ...
  const n = { select: Ta(e).select, in: (r, i, s, o) => {
  ...
  return n;
}, lr = Symbol.for("vuetify:nested"), Fd = { id: ve(), root: { itemsRegistration: X("render"), register: () => null, unregister: () => null, updateDisabled: () => null, children: X(/* @__PURE__ */ new Map()), parents: X(/* @__PURE__ */ new Map()), disabled: X(/* @__PURE__ */ new Set()), open: () => null, openOnSelect: () => null, activate: () => null, select: () => null, activatable: X(false), scrollToActive: X(false), selectable: X(false), opened: X(/* @__PURE__ */ new Set()), activated: X(/* @__PURE__ */ new Set()), selected: X(/* @__PURE__ */ new Map()), selectedValues: X([]), getPath: () => [] } }, py = ne({ activatable: Boolean, selectable: Boolean, activeStrategy: [String, Function, Object], selectStrategy: [String, Function, Object], openStrategy: [String, Object], opened: null, activated: null, selected: null, mandatory: Boolean, itemsRegistration: { type: String, default: "render" } }, "nested"), yy = (e, t) => {
  ...
  function g(x) {
    const E = [];
    let P = te(x);
    for (; P !== void 0; ) E.unshift(P), P = a.value.get(P);
    return E;
  }
  ...
  function A() {
    const x = /* @__PURE__ */ new Map(), E = /* @__PURE__ */ new Map(), P = /* @__PURE__ */ new Set(), w = rt(r) ? (N) => te(N.raw) : (N) => N.value, D = [...n.value];
    let R = 0;
    for (; R < D.length; ) {
      const N = D[R++], M = w(N);
      if (N.children) {
      ...
      N.props.disabled && P.add(M);
    }
    o.value = E, a.value = x, l.value = P;
  }
  const _ = { id: ve(), root: { opened: u, activatable: B(() => e.activatable), scrollToActive: B(() => rt(i)), selectable: B(() => e.selectable), activated: m, selected: b, selectedValues: H(() => {
    const x = [];
    for (const [E, P] of b.value.entries()) P === "on" && x.push(E);
    return x;
  }), itemsRegistration: B(() => e.itemsRegistration), register: (x, E, P, w) => {
    if (v.has(x)) {
      g(x).map(String).join(" -> "), g(E).concat(x).map(String).join(" -> ");
      return;
    } else v.add(x);
    E && x !== E && a.value.set(x, E), P && l.value.add(x), w && o.value.set(x, []), E != null && o.value.set(E, [...o.value.get(E) || [], x]), y();
  }, unregister: (x) => {
    if (s) return;
    v.delete(x), o.value.delete(x), l.value.delete(x);
    const E = a.value.get(x);
    if (E) {
      const P = o.value.get(E) ?? [];
      o.value.set(E, P.filter((w) => w !== x));
    }
    a.value.delete(x), y();
  }, updateDisabled: (x, E) => {
    E ? l.value.add(x) : l.value.delete(x);
  }, open: (x, E, P) => {
    S.emit("click:open", { id: x, value: E, path: g(x), event: P });
    const w = d.value.open({ id: x, value: E, opened: new Set(u.value), children: o.value, parents: a.value, event: P });
    w && (u.value = w);
  }, openOnSelect: (x, E, P) => {
    const w = d.value.select({ id: x, value: E, selected: new Map(b.value), opened: new Set(u.value), children: o.value, parents: a.value, event: P });
    w && (u.value = w);
  }, select: (x, E, P) => {
    S.emit("click:select", { id: x, value: E, path: g(x), event: P });
    const w = f.value.select({ id: x, value: E, selected: new Map(b.value), children: o.value, parents: a.value, disabled: l.value, event: P });
    w && (b.value = w), _.root.openOnSelect(x, E, P);
  }, activate: (x, E, P) => {
    if (!e.activatable) return _.root.select(x, true, P);
    S.emit("click:activate", { id: x, value: E, path: g(x), event: P });
    const w = c.value.activate({ id: x, value: E, activated: new Set(m.value), children: o.value, parents: a.value, event: P });
  ...
  return it(lr, _), _.root;
}, $d = (e, t, n) => {
  const r = Me(lr, Fd), i = Symbol("nested item"), s = H(() => {
    const a = te(rt(e));
    return a !== void 0 ? a : i;
  }), o = { ...r, id: s, open: (a, l) => r.root.open(s.value, a, l), openOnSelect: (a, l) => r.root.openOnSelect(s.value, a, l), isOpen: H(() => r.root.opened.value.has(s.value)), parent: H(() => r.root.parents.value.get(s.value)), activate: (a, l) => r.root.activate(s.value, a, l), isActivated: H(() => r.root.activated.value.has(s.value)), scrollToActive: r.root.scrollToActive, select: (a, l) => r.root.select(s.value, a, l), isSelected: H(() => r.root.selected.value.get(s.value) === "on"), isIndeterminate: H(() => r.root.selected.value.get(s.value) === "indeterminate"), isLeaf: H(() => !r.root.children.value.get(s.value)), isGroupActivator: r.isGroupActivator };
  return ds(() => {
...
function _y() {
  ...
  }), { ssrBootStyles: B(() => e.value ? void 0 : { transition: "none !important" }), isBooted: Qn(e) };
}
const wy = hr({ name: "VListGroupActivator", setup(e, t) {
  let { slots: n } = t;
  return by(), () => {
    var _a2;
    return (_a2 = n.default) == null ? void 0 : _a2.call(n);
  };
} }), Sy = ne({ activeColor: String, baseColor: String, color: String, collapseIcon: { type: yt, default: "$collapse" }, disabled: Boolean, expandIcon: { type: yt, default: "$expand" }, rawId: [String, Number], prependIcon: yt, appendIcon: yt, fluid: Boolean, subgroup: Boolean, title: String, value: null, ...qe(), ...Rt() }, "VListGroup"), Ec = Pe()({ name: "VListGroup", props: Sy(), setup(e, t) {
  let { slots: n } = t;
  const { isOpen: r, open: i, id: s } = $d(() => e.value, () => e.disabled, true), o = H(() => `v-list-group--id-${String(e.rawId ?? s.value)}`), a = Vd(), { isBooted: l } = _y(), u = Me(lr), c = B(() => {
    var _a2;
  ...
  return ze(() => T(e.tag, { class: Le(["v-list-group", { "v-list-group--prepend": a == null ? void 0 : a.hasPrepend.value, "v-list-group--fluid": e.fluid, "v-list-group--subgroup": e.subgroup, "v-list-group--open": r.value }, e.class]), style: He(e.style) }, { default: () => [n.activator && T(mn, { defaults: b.value }, { default: () => [T(wy, null, { default: () => [n.activator({ props: d.value, isOpen: r.value })] })] }), T(Wn, { transition: { component: ty }, disabled: !l.value }, { default: () => {
    var _a2, _b2;
    return [c.value ? tr(k("div", { class: "v-list-group__items", role: "group", "aria-labelledby": o.value }, [(_a2 = n.default) == null ? void 0 : _a2.call(n)]), [[sa, r.value]]) : r.value && k("div", { class: "v-list-group__items", role: "group", "aria-labelledby": o.value }, [(_b2 = n.default) == null ? void 0 : _b2.call(n)])];
  } })] })), { isOpen: r };
} }), Cy = ne({ opacity: [Number, String], ...qe(), ...Rt() }, "VListItemSubtitle"), xy = Pe()({ name: "VListItemSubtitle", props: Cy(), setup(e, t) {
  let { slots: n } = t;
  return ze(() => T(e.tag, { class: Le(["v-list-item-subtitle", e.class]), style: He([{ "--v-list-item-subtitle-opacity": e.opacity }, e.style]) }, n)), {};
} }), Ay = Hv("v-list-item-title"), Ly = ne({ active: { type: Boolean, default: void 0 }, activeClass: String, activeColor: String, appendAvatar: String, appendIcon: yt, baseColor: String, disabled: Boolean, lines: [Boolean, String], link: { type: Boolean, default: void 0 }, nav: Boolean, prependAvatar: String, prependIcon: yt, ripple: { type: [Boolean, Object], default: true }, slim: Boolean, prependGap: [Number, String], subtitle: { type: [String, Number, Boolean], default: void 0 }, title: { type: [String, Number, Boolean], default: void 0 }, value: null, index: Number, tabindex: [Number, String], onClick: Dr(), onClickOnce: Dr(), ...hi(), ...qe(), ...vi(), ...pr(), ...ys(), ...gr(), ...Cd(), ...Rt(), ...Gt(), ...yi({ variant: "text" }) }, "VListItem"), Po = Pe()({ name: "VListItem", directives: { vRipple: Eo }, props: Ly(), emits: { click: (e) => true }, setup(e, t) {
  let { attrs: n, slots: r, emit: i } = t;
  const s = Sd(e, n), o = X(), a = H(() => e.value === void 0 ? s.href.value : e.value), { activate: l, isActivated: u, select: c, isOpen: f, isSelected: d, isIndeterminate: m, isGroupActivator: b, root: g, parent: S, openOnSelect: v, scrollToActive: y, id: A } = $d(a, () => e.disabled, false), _ = Vd(), x = H(() => {
    var _a2;
    return e.active !== false && (e.active || ((_a2 = s.isActive) == null ? void 0 : _a2.value) || (g.activatable.value ? u.value : d.value));
  }), E = B(() => e.link !== false && s.isLink.value), P = H(() => !!_ && (g.selectable.value || g.activatable.value || e.value != null)), w = H(() => !e.disabled && e.link !== false && (e.link || s.isClickable.value || P.value)), D = H(() => _ && _.navigationStrategy.value === "track" && e.index !== void 0 && _.trackingIndex.value === e.index), R = H(() => _ ? E.value ? "link" : P.value ? "option" : "listitem" : void 0), N = H(() => {
    if (P.value) return g.activatable.value ? u.value : g.selectable.value ? d.value : x.value;
  ...
  const { themeClasses: J } = sn(e), { borderClasses: Q } = gi(e), { colorClasses: ae, colorStyles: Oe, variantClasses: we } = Ca(Y), { densityClasses: oe } = pi(e), { dimensionStyles: he } = yr(e), { elevationClasses: de } = bs(e), { roundedClasses: Be } = vr(M), Ge = B(() => e.lines ? `v-list-item--${e.lines}-line` : void 0), Ne = B(() => e.ripple !== void 0 && e.ripple && (_ == null ? void 0 : _.filterable) ? { keys: ["Enter"] } : e.ripple), L = H(() => ({ isActive: x.value, select: c, isOpen: f.value, isSelected: d.value, isIndeterminate: m.value, isDisabled: e.disabled }));
  function j(U) {
    var _a2, _b2, _c2;
    i("click", U), !["INPUT", "TEXTAREA"].includes((_a2 = U.target) == null ? void 0 : _a2.tagName) && w.value && ((_c2 = (_b2 = s.navigate).value) == null ? void 0 : _c2.call(_b2, U), !b && (g.activatable.value ? l(!u.value, U) : (g.selectable.value || e.value != null && !E.value) && c(!d.value, U)));
  }
  function z(U) {
    const ge = U.target;
  ...
  return ze(() => {
    ...
    return _ == null ? void 0 : _.updateHasPrepend(V), e.activeColor && qf("active-color", ["color", "base-color"]), tr(T(U, Re(s.linkProps, { ref: o, id: e.index !== void 0 && _ ? `v-list-item-${_.uid}-${e.index}` : void 0, class: ["v-list-item", { "v-list-item--active": x.value, "v-list-item--disabled": e.disabled, "v-list-item--link": w.value, "v-list-item--nav": e.nav, "v-list-item--prepend": !V && (_ == null ? void 0 : _.hasPrepend.value), "v-list-item--slim": e.slim, "v-list-item--focus-visible": D.value, [`${e.activeClass}`]: e.activeClass && x.value }, J.value, Q.value, ae.value, oe.value, de.value, Ge.value, Be.value, we.value, e.class], style: [{ "--v-list-prepend-gap": pe(e.prependGap) }, Oe.value, he.value, e.style], tabindex: e.tabindex ?? (w.value ? _ ? -2 : 0 : void 0), "aria-selected": N.value, role: R.value, onClick: j, onKeydown: w.value && !E.value && z }), { default: () => {
      var _a2;
      return [Sa(w.value || x.value, "v-list-item"), V && k("div", { key: "prepend", class: "v-list-item__prepend" }, [r.prepend ? T(mn, { key: "prepend-defaults", defaults: { VAvatar: { density: e.density, image: e.prependAvatar }, VIcon: { density: e.density, icon: e.prependIcon }, VListItemAction: { start: true }, VCheckboxBtn: { density: e.density } } }, { default: () => {
        var _a3;
        return [(_a3 = r.prepend) == null ? void 0 : _a3.call(r, L.value)];
      } }) : k(_e, null, [e.prependAvatar && T(Lc, { key: "prepend-avatar", density: e.density, image: e.prependAvatar }, null), e.prependIcon && T(st, { key: "prepend-icon", density: e.density, icon: e.prependIcon }, null)]), k("div", { class: "v-list-item__spacer" }, null)]), k("div", { class: "v-list-item__content", "data-no-activator": "" }, [ge && T(Ay, { key: "title" }, { default: () => {
        var _a3;
        return [((_a3 = r.title) == null ? void 0 : _a3.call(r, { title: e.title })) ?? ye(e.title)];
      } }), h && T(xy, { key: "subtitle" }, { default: () => {
        var _a3;
        return [((_a3 = r.subtitle) == null ? void 0 : _a3.call(r, { subtitle: e.subtitle })) ?? ye(e.subtitle)];
      } }), (_a2 = r.default) == null ? void 0 : _a2.call(r, L.value)]), C && k("div", { key: "append", class: "v-list-item__append" }, [r.append ? T(mn, { key: "append-defaults", defaults: { VAvatar: { density: e.density, image: e.appendAvatar }, VIcon: { density: e.density, icon: e.appendIcon }, VListItemAction: { end: true }, VCheckboxBtn: { density: e.density } } }, { default: () => {
        var _a3;
        return [(_a3 = r.append) == null ? void 0 : _a3.call(r, L.value)];
      } }) : k(_e, null, [e.appendIcon && T(st, { key: "append-icon", density: e.density, icon: e.appendIcon }, null), e.appendAvatar && T(Lc, { key: "append-avatar", density: e.density, image: e.appendAvatar }, null)]), k("div", { class: "v-list-item__spacer" }, null)])];
    } }), [[Eo, w.value && Ne.value]]);
  }), { activate: l, isActivated: u, isGroupActivator: b, isSelected: d, list: _, select: c, root: g, id: A, link: s };
} }), Ey = ne({ color: String, inset: Boolean, sticky: Boolean, title: String, ...qe(), ...Rt() }, "VListSubheader"), My = Pe()({ name: "VListSubheader", props: Ey(), setup(e, t) {
  let { slots: n } = t;
  const { textColorClasses: r, textColorStyles: i } = Jr(() => e.color);
  return ze(() => {
    const s = !!(n.default || e.title);
    return T(e.tag, { class: Le(["v-list-subheader", { "v-list-subheader--inset": e.inset, "v-list-subheader--sticky": e.sticky }, r.value, e.class]), style: He([{ textColorStyles: i }, e.style]) }, { default: () => {
      var _a2;
      return [s && k("div", { class: "v-list-subheader__text" }, [((_a2 = n.default) == null ? void 0 : _a2.call(n)) ?? e.title])];
    } });
  }), {};
} }), ky = ne({ items: Array, returnObject: Boolean }, "VListChildren"), Bd = Pe()({ name: "VListChildren", props: ky(), setup(e, t) {
  let { slots: n } = t;
  return Od(), () => {
    var _a2, _b2;
    return ((_a2 = n.default) == null ? void 0 : _a2.call(n)) ?? ((_b2 = e.items) == null ? void 0 : _b2.map((r, i) => {
      ...
      if (a === "divider") return ((_a3 = n.divider) == null ? void 0 : _a3.call(n, { props: o })) ?? T(Zp, o, null);
      if (a === "subheader") return ((_b3 = n.subheader) == null ? void 0 : _b3.call(n, { props: o })) ?? T(My, o, null);
      ...
      } : void 0 }, c = Ec.filterProps(o);
      return s ? T(Ec, Re(c, { value: e.returnObject ? l : o == null ? void 0 : o.value, rawId: o == null ? void 0 : o.value }), { activator: (f) => {
        let { props: d } = f;
        const m = Re(o, d, { value: e.returnObject ? l : o.value });
        return n.header ? n.header({ props: m }) : T(Po, Re(m, { index: i }), u);
      }, default: () => T(Bd, { items: s, returnObject: e.returnObject }, n) }) : n.item ? n.item({ props: { ...o, index: i } }) : T(Po, Re(o, { index: i, value: e.returnObject ? l : o.value }), u);
    }));
  };
} }), Ty = ne({ items: { type: Array, default: () => [] }, itemTitle: { type: [String, Array, Function], default: "title" }, itemValue: { type: [String, Array, Function], default: "value" }, itemChildren: { type: [Boolean, String, Array, Function], default: "children" }, itemProps: { type: [Boolean, String, Array, Function], default: "props" }, itemType: { type: [Boolean, String, Array, Function], default: "type" }, returnObject: Boolean, valueComparator: Function }, "list-items"), Py = /* @__PURE__ */ new Set(["item", "divider", "subheader"]);
function Ry(e, t) {
  const n = or(t) ? t : xr(t, e.itemTitle), r = or(t) ? t : xr(t, e.itemValue, void 0), i = xr(t, e.itemChildren), s = e.itemProps === true ? mi(t, ["children"]) : xr(t, e.itemProps);
  let o = xr(t, e.itemType, "item");
  Py.has(o) || (o = "item");
  const a = { title: n, value: r, ...s };
  return { type: o, title: a.title, value: a.value, props: a, children: o === "item" && i ? jd(e, i) : void 0, raw: t };
}
function jd(e, t) {
  const n = [];
  for (const r of t) n.push(Ry(e, r));
  return n;
}
function Iy(e) {
  return { items: H(() => jd(e, e.items)) };
}
const Oy = ne({ baseColor: String, activeColor: String, activeClass: String, bgColor: String, disabled: Boolean, filterable: Boolean, expandIcon: yt, collapseIcon: yt, lines: { type: [Boolean, String], default: "one" }, slim: Boolean, prependGap: [Number, String], indent: [Number, String], nav: Boolean, navigationStrategy: { type: String, default: "focus" }, navigationIndex: Number, "onClick:open": Dr(), "onClick:select": Dr(), "onUpdate:opened": Dr(), ...py({ selectStrategy: "single-leaf", openStrategy: "list" }), ...hi(), ...qe(), ...vi(), ...pr(), ...ys(), ...Ty(), ...gr(), ...Rt(), ...Gt(), ...yi({ variant: "text" }) }, "VList"), Vy = Pe()({ name: "VList", props: Oy(), emits: { "update:selected": (e) => true, "update:activated": (e) => true, "update:opened": (e) => true, "update:navigationIndex": (e) => true, "click:open": (e) => true, "click:activate": (e) => true, "click:select": (e) => true }, setup(e, t) {
  let { attrs: n, slots: r, emit: i } = t;
  const { items: s } = Iy(e), { themeClasses: o } = sn(e), { backgroundColorClasses: a, backgroundColorStyles: l } = wa(() => e.bgColor), { borderClasses: u } = gi(e), { densityClasses: c } = pi(e), { dimensionStyles: f } = yr(e), { elevationClasses: d } = bs(e), { roundedClasses: m } = vr(e), { children: b, open: g, parents: S, select: v, getPath: y } = yy(e, { items: s, returnObject: B(() => e.returnObject), scrollToActive: B(() => e.navigationStrategy === "track") }), A = B(() => e.lines ? `v-list--${e.lines}-line` : void 0), _ = B(() => e.activeColor), x = B(() => e.baseColor), E = B(() => e.color), P = B(() => e.selectable || e.activatable), w = Qt(e, "navigationIndex", -1, (oe) => oe ?? -1), D = oi();
  Od({ filterable: e.filterable, trackingIndex: w, navigationStrategy: B(() => e.navigationStrategy), uid: D }), le(s, () => {
    e.navigationStrategy === "track" && (w.value = -1);
  }), ya({ VListGroup: { activeColor: _, baseColor: x, color: E, expandIcon: B(() => e.expandIcon), collapseIcon: B(() => e.collapseIcon) }, VListItem: { activeClass: B(() => e.activeClass), activeColor: _, baseColor: x, color: E, density: B(() => e.density), disabled: B(() => e.disabled), lines: B(() => e.lines), nav: B(() => e.nav), slim: B(() => e.slim), variant: B(() => e.variant), tabindex: B(() => e.navigationStrategy === "track" ? -1 : void 0) } });
  ...
  function Y(oe) {
    var _a2;
    e.navigationStrategy === "track" ? ~w.value || (w.value = Q("first")) : !R.value && !(oe.relatedTarget && ((_a2 = N.value) == null ? void 0 : _a2.contains(oe.relatedTarget))) && we();
  }
  function Z() {
    e.navigationStrategy === "track" && (w.value = -1);
  }
  ...
  function Q(oe) {
    ...
    if (he === 0) return -1;
    let de;
    oe === "first" ? de = 0 : oe === "last" ? de = he - 1 : (de = w.value + (oe === "next" ? 1 : -1), de < 0 && (de = he - 1), de >= he && (de = 0));
    const Be = de;
    let Ge = 0;
    for (; Ge < he; ) {
      const Ne = s.value[de];
      if (Ne && Ne.type !== "divider" && Ne.type !== "subheader") return de;
      if (de += oe === "next" || oe === "first" ? 1 : -1, de < 0 && (de = he - 1), de >= he && (de = 0), de === Be) return -1;
      Ge++;
    }
    return -1;
  }
  function ae(oe) {
    const he = oe.target;
    if (!N.value || he.tagName === "INPUT" && ["Home", "End"].includes(oe.key) || he.tagName === "TEXTAREA") return;
    const de = J(oe.key);
    if (de !== null) if (oe.preventDefault(), e.navigationStrategy === "track") {
      const Be = Q(de);
      Be !== -1 && (w.value = Be);
    } else we(de);
  }
  ...
  function we(oe) {
    if (N.value) return Hr(N.value, oe);
  }
  return ze(() => {
    const oe = e.indent ?? (e.prependGap ? Number(e.prependGap) + 24 : void 0), he = P.value ? n.ariaMultiselectable ?? !String(e.selectStrategy).startsWith("single-") : void 0;
    return T(e.tag, { ref: N, class: Le(["v-list", { "v-list--disabled": e.disabled, "v-list--nav": e.nav, "v-list--slim": e.slim }, o.value, a.value, u.value, c.value, d.value, A.value, m.value, e.class]), style: He([{ "--v-list-indent": pe(oe), "--v-list-group-prepend": oe ? "0px" : void 0, "--v-list-prepend-gap": pe(e.prependGap) }, l.value, f.value, e.style]), tabindex: e.disabled ? -1 : 0, role: P.value ? "listbox" : "list", "aria-activedescendant": e.navigationStrategy === "track" && w.value >= 0 ? `v-list-item-${D}-${w.value}` : void 0, "aria-multiselectable": he, onFocusin: M, onFocusout: $, onFocus: Y, onBlur: Z, onKeydown: ae, onMousedown: Oe }, { default: () => [T(Bd, { items: s.value, returnObject: e.returnObject }, r)] });
...
function Mc(e, t) {
  ...
  return Xs({ x: t.width / 2, y: t.height / 2 }, t);
}
const Wd = { static: Fy, connected: By }, Hy = ne({ locationStrategy: { type: [String, Function], default: "static", validator: (e) => typeof e == "function" || e in Wd }, location: { type: String, default: "bottom" }, origin: { type: String, default: "auto" }, offset: [Number, String, Array], stickToTarget: Boolean, viewportMargin: { type: [Number, String], default: 12 } }, "VOverlay-location-strategies");
function Ny(e, t) {
  const n = X({}), r = X();
  Ie && _s(() => !!(t.isActive.value && e.locationStrategy), (a) => {
    ...
    }), window.addEventListener("resize", i, { passive: true }), visualViewport == null ? void 0 : visualViewport.addEventListener("resize", s, { passive: true }), visualViewport == null ? void 0 : visualViewport.addEventListener("scroll", o, { passive: true }), typeof e.locationStrategy == "function" ? r.value = (_a2 = e.locationStrategy(t, e, n)) == null ? void 0 : _a2.updateLocation : r.value = (_b2 = Wd[e.locationStrategy](t, e, n)) == null ? void 0 : _b2.updateLocation;
  });
  function i(a) {
    var _a2;
...
function By(e, t, n) {
  (Array.isArray(e.target.value) || Wv(e.target.value)) && Object.assign(n.value, { position: "fixed", top: 0, [e.isRtl.value ? "right" : "left"]: 0 });
  const { preferredAnchor: i, preferredOrigin: s } = ga(() => {
    const v = _o(t.location, e.isRtl.value), y = t.origin === "overlap" ? v : t.origin === "auto" ? zs(v) : _o(t.origin, e.isRtl.value);
    return v.side === y.side && v.align === Gs(y).align ? { preferredAnchor: Kl(v), preferredOrigin: Kl(y) } : { preferredAnchor: v, preferredOrigin: y };
  ...
  let f = false, d = -1;
  const m = new rv(4), b = new ResizeObserver(() => {
    if (!f) return;
    if (requestAnimationFrame((y) => {
      ...
      const y = m.values();
      if (Jn(y.at(-1), y.at(-3)) && !Jn(y.at(-1), y.at(-2))) return;
    }
    const v = S();
    v && m.push(v.flipped);
  });
  ...
  le(e.target, (v, y) => {
    y && !Array.isArray(y) && b.unobserve(y), Array.isArray(v) ? Jn(v, y) || S() : v && b.observe(v);
  ...
  function S() {
    ...
    (Array.isArray(e.target.value) || e.target.value.offsetParent || e.target.value.getClientRects().length) && (g = od(e.target.value));
    const v = $y(e.contentEl.value, e.isRtl.value), y = qi(e.contentEl.value), A = Number(t.viewportMargin);
    ...
    function E($) {
      const Y = new xt(v), Z = Mc($.anchor, g), J = Mc($.origin, Y);
      let { x: Q, y: ae } = Dy(Z, J);
      switch ($.anchor.side) {
        case "top":
          ae -= c.value[0];
      ...
      return Y.x += Q, Y.y += ae, Y.width = Math.min(Y.width, l.value), Y.height = Math.min(Y.height, u.value), { overflows: ql(Y, _), x: Q, y: ae };
    }
    let P = 0, w = 0;
    ...
    for (; !(N++ > 10); ) {
      ...
      P += $, w += Y, v.x += $, v.y += Y;
      {
        const J = Yl(x.anchor), Q = Z.x.before || Z.x.after, ae = Z.y.before || Z.y.after;
        let Oe = false;
        if (["x", "y"].forEach((we) => {
          if (we === "x" && Q && !R.x || we === "y" && ae && !R.y) {
            const oe = { anchor: { ...x.anchor }, origin: { ...x.origin } }, he = we === "x" ? J === "y" ? Gs : zs : J === "y" ? zs : Gs;
            oe.anchor = he(oe.anchor), oe.origin = he(oe.origin);
            const { overflows: de } = E(oe);
            (de[we].before <= Z[we].before && de[we].after <= Z[we].after || de[we].before + de[we].after < (Z[we].before + Z[we].after) / 2) && (x = oe, Oe = R[we] = true);
          }
        }), Oe) continue;
      }
      Z.x.before && (P += Z.x.before, v.x += Z.x.before), Z.x.after && (P -= Z.x.after, v.x -= Z.x.after), Z.y.before && (w += Z.y.before, v.y += Z.y.before), Z.y.after && (w -= Z.y.after, v.y -= Z.y.after);
      {
        const J = ql(v, _);
        D.x = _.width - J.x.before - J.x.after, D.y = _.height - J.y.before - J.y.after, P += J.x.before, v.x += J.x.before, w += J.y.before, v.y += J.y.before;
      }
      break;
    }
    const M = Yl(x.anchor);
    return Object.assign(n.value, { "--v-overlay-anchor-origin": `${x.anchor.side} ${x.anchor.align}`, transformOrigin: `${x.origin.side} ${x.origin.align}`, top: pe(Js(w)), left: e.isRtl.value ? void 0 : pe(Js(P)), right: e.isRtl.value ? pe(Js(-P)) : void 0, minWidth: pe(M === "y" ? Math.min(o.value, g.width) : o.value), maxWidth: pe(kc(Zi(D.x, o.value === 1 / 0 ? 0 : o.value, l.value))), maxHeight: pe(kc(Zi(D.y, a.value === 1 / 0 ? 0 : a.value, u.value))) }), { available: D, contentBox: v, flipped: R };
  }
...
const Qi = [];
function jy(e) {
  !Ro || Qi.length ? (Qi.push(e), Io()) : (Ro = false, e(), Io());
}
let Tc = -1;
function Io() {
  cancelAnimationFrame(Tc), Tc = requestAnimationFrame(() => {
    const e = Qi.shift();
    e && e(), Qi.length ? Io() : Ro = true;
  });
}
const zd = { none: null, close: Gy, block: Uy, reposition: Zy }, Wy = ne({ scrollStrategy: { type: [String, Function], default: "block", validator: (e) => typeof e == "function" || e in zd } }, "VOverlay-scroll-strategies");
function zy(e, t) {
  if (!Ie) return;
  let n;
  gn(async () => {
...
function Gy(e) {
  ...
  Gd(Pa(e.target.value, e.contentEl.value), t);
}
function Uy(e, t) {
  var _a2;
  const n = (_a2 = e.root.value) == null ? void 0 : _a2.offsetParent, r = Pa(e.target.value, e.contentEl.value), i = [.../* @__PURE__ */ new Set([...qi(r, t.contained ? n : void 0), ...qi(e.contentEl.value, t.contained ? n : void 0)])].filter((a) => !a.classList.contains("v-overlay-scroll-blocked")), s = window.innerWidth - document.documentElement.offsetWidth, o = ((a) => ba(a) && a)(n || document.documentElement);
...
function Zy(e, t, n) {
  ...
  s = (typeof requestIdleCallback > "u" ? (a) => a() : requestIdleCallback)(() => {
    n.run(() => {
      Gd(Pa(e.target.value, e.contentEl.value), (a) => {
...
const Oo = Symbol.for("vuetify:v-menu"), Ky = ne({ closeDelay: [Number, String], openDelay: [Number, String] }, "delay");
function Yy(e, t) {
  let n = () => {
  };
  function r(o, a) {
...
const qy = ne({ target: [String, Object], activator: [String, Object], activatorProps: { type: Object, default: () => ({}) }, openOnClick: { type: Boolean, default: void 0 }, openOnHover: Boolean, openOnFocus: { type: Boolean, default: void 0 }, closeOnContentClick: Boolean, ...Ky() }, "VOverlay-activator");
function Xy(e, t) {
  let { isActive: n, isTop: r, contentEl: i } = t;
  const s = Ze("useActivator"), o = X();
  let a = false, l = false, u = true;
  const c = H(() => e.openOnFocus || e.openOnFocus == null && e.openOnHover), f = H(() => e.openOnClick || e.openOnClick == null && !e.openOnHover && !c.value), { runOpenDelay: d, runCloseDelay: m } = Yy(e, (w) => {
  ...
  const _ = bo(), x = H(() => e.target === "cursor" && b.value ? b.value : _.value ? _.el : Ud(e.target, s) || o.value), E = H(() => Array.isArray(x.value) ? void 0 : x.value);
  let P;
  return le(() => !!e.activator, (w) => {
    w && Ie ? (P = Br(), P.run(() => {
      Jy(e, s, { activatorEl: o, activatorEvents: S });
    })) : P && P.stop();
...
const Qy = ne({ retainFocus: Boolean, captureFocus: Boolean, disableInitialFocus: Boolean }, "focusTrap"), Vi = /* @__PURE__ */ new Map();
let Pc = 0;
function Rc(e) {
  const t = document.activeElement;
  if (e.key !== "Tab" || !t) return;
  const n = Array.from(Vi.values()).filter((u) => {
    var _a2;
  ...
  if (!r) return;
  const s = Xn(r).filter((u) => u.tabIndex >= 0);
  if (!s.length) return;
...
function e0(e, t) {
  ...
  async function u(d) {
    ...
    document.removeEventListener("pointerdown", l), document.removeEventListener("keydown", c), await dt(), n.value && !o && m !== b && i.value && rt(r) && ![document, i.value].includes(b) && !i.value.contains(b) && ((_a2 = Xn(i.value)[0]) == null ? void 0 : _a2.focus());
  }
  function c(d) {
    if (d.key === "Tab" && (document.removeEventListener("keydown", c), n.value && i.value && d.target && !i.value.contains(d.target))) {
      const m = Xn(document.documentElement);
  ...
  Ie && (le(() => e.retainFocus, (d) => {
    d ? Vi.set(s, { isActive: n, contentEl: i }) : Vi.delete(s);
  ...
  }, { immediate: true }), Pc++ < 1 && document.addEventListener("keydown", Rc)), ct(() => {
    Vi.delete(s), clearTimeout(a), document.removeEventListener("pointerdown", l), document.removeEventListener("focusin", u), document.removeEventListener("keydown", c), --Pc < 1 && document.removeEventListener("keydown", Rc);
  });
}
function t0() {
...
const n0 = ne({ eager: Boolean }, "lazy");
function r0(e, t) {
...
const Ic = Symbol.for("vuetify:stack"), Ar = Ue([]);
function i0(e, t, n) {
  const r = Ze("useStack"), i = !n, s = Me(Ic, void 0), o = Ue({ activeChildren: /* @__PURE__ */ new Set() });
  it(Ic, o);
  ...
  }), { globalTop: Qn(l), localTop: B(() => !o.activeChildren.size), stackStyles: B(() => ({ zIndex: a.value })) };
}
function s0(e) {
...
function Zd(e, t, n) {
  if (!e || Kd(e, n) === false) return false;
  const r = md(t);
...
function a0(e, t, n) {
  ...
  e.shadowTarget = e.target, t._clickOutside.lastMousedownWasOutside && Zd(e, t, n) && setTimeout(() => {
    Kd(e, n) && r && r(e);
  }, 0);
}
function Oc(e, t) {
...
const Vc = { mounted(e, t) {
  const n = (i) => a0(i, e, t), r = (i) => {
    e._clickOutside.lastMousedownWasOutside = Zd(i, e, t);
  };
  Oc(e, (i) => {
...
function l0(e) {
  ...
  return T(sr, { name: "fade-transition", appear: true }, { default: () => [e.modelValue && k("div", Re({ class: ["v-overlay__scrim", e.color.backgroundColorClasses.value], style: e.color.backgroundColorStyles.value }, r), null)] });
}
const Ia = ne({ absolute: Boolean, attach: [Boolean, String, Object], closeOnBack: { type: Boolean, default: true }, contained: Boolean, contentClass: null, contentProps: null, disabled: Boolean, opacity: [Number, String], noClickAnimation: Boolean, modelValue: Boolean, persistent: Boolean, scrim: { type: [Boolean, String], default: true }, zIndex: { type: [Number, String], default: 2e3 }, ...qy(), ...qe(), ...pr(), ...n0(), ...Hy(), ...Wy(), ...Qy(), ...Gt(), ...Rd() }, "VOverlay"), es = Pe()({ name: "VOverlay", directives: { vClickOutside: Vc }, inheritAttrs: false, props: { _disableGlobalStack: Boolean, ...mi(Ia(), ["disableInitialFocus"]) }, emits: { "click:outside": (e) => true, "update:modelValue": (e) => true, keydown: (e) => true, afterEnter: () => true, afterLeave: () => true }, setup(e, t) {
  let { slots: n, attrs: r, emit: i } = t;
  const s = Ze("VOverlay"), o = X(), a = X(), l = X(), u = Qt(e, "modelValue"), c = H({ get: () => u.value, set: (L) => {
    L && e.disabled || (u.value = L);
  } }), { themeClasses: f } = sn(e), { rtlClasses: d, isRtl: m } = bi(), { hasContent: b, onAfterLeave: g } = r0(e, c), S = wa(() => typeof e.scrim == "string" ? e.scrim : null), { globalTop: v, localTop: y, stackStyles: A } = i0(c, () => e.zIndex, e._disableGlobalStack), { activatorEl: _, activatorRef: x, target: E, targetEl: P, targetRef: w, activatorEvents: D, contentEvents: R, scrimEvents: N } = Xy(e, { isActive: c, isTop: y, contentEl: l }), { teleportTarget: M } = s0(() => {
    var _a2, _b2, _c2;
  ...
  }), { dimensionStyles: $ } = yr(e), Y = t0(), { scopeId: Z } = Ra();
  le(() => e.disabled, (L) => {
    L && (c.value = false);
  });
  const { contentStyles: J, updateLocation: Q } = Ny(e, { isRtl: m, contentEl: l, target: E, isActive: c });
  zy(e, { root: o, contentEl: l, targetEl: P, target: E, isActive: c, updateLocation: Q });
  function ae(L) {
  ...
  e0(e, { isActive: c, localTop: y, contentEl: l }), Ie && le(c, (L) => {
  ...
  return ze(() => {
    var _a2;
    return k(_e, null, [(_a2 = n.activator) == null ? void 0 : _a2.call(n, { isActive: c.value, targetRef: w, props: Re({ ref: x }, D.value, e.activatorProps) }), Y.value && b.value && T(oh, { disabled: !M.value, to: M.value }, { default: () => [k("div", Re({ class: ["v-overlay", { "v-overlay--absolute": e.absolute || e.contained, "v-overlay--active": c.value, "v-overlay--contained": e.contained }, f.value, d.value, e.class], style: [A.value, { "--v-overlay-opacity": e.opacity, top: pe(de.value) }, e.style], ref: o, onKeydown: oe }, Z, r), [T(l0, Re({ color: S, modelValue: c.value && !!e.scrim, ref: a }, N.value), null), T(Wn, { appear: true, persisted: true, transition: e.transition, target: E.value, onAfterEnter: Ge, onAfterLeave: Ne }, { default: () => {
      var _a3;
      return [tr(k("div", Re({ ref: l, class: ["v-overlay__content", e.contentClass], style: [$.value, J.value] }, R.value, e.contentProps), [(_a3 = n.default) == null ? void 0 : _a3.call(n, { isActive: c })]), [[sa, c.value], [Vc, { handler: ae, closeConditional: Oe, include: () => [_.value] }]])];
    } })])] })]);
  }), { activatorEl: _, scrimEl: a, target: E, animateClick: Be, contentEl: l, rootEl: o, globalTop: v, localTop: y, updateLocation: Q };
} }), c0 = ne({ id: String, submenu: Boolean, ...mi(Ia({ captureFocus: true, closeDelay: 250, closeOnContentClick: true, locationStrategy: "connected", location: void 0, openDelay: 300, scrim: false, scrollStrategy: "reposition", transition: { component: ey } }), ["absolute"]) }, "VMenu"), u0 = Pe()({ name: "VMenu", props: c0(), emits: { "update:modelValue": (e) => true }, setup(e, t) {
  let { slots: n } = t;
  const r = Qt(e, "modelValue"), { scopeId: i } = Ra(), { isRtl: s } = bi(), o = oi(), a = B(() => e.id || `v-menu-${o}`), l = X(), u = Me(Oo, null), c = ve(/* @__PURE__ */ new Set());
  it(Oo, { register() {
    c.value.add(o);
  }, unregister() {
    c.value.delete(o);
    ...
    setTimeout(() => {
      var _a2;
      !c.value.size && !e.persistent && (g == null || ((_a2 = l.value) == null ? void 0 : _a2.contentEl) && !ov(g, l.value.contentEl)) && (r.value = false, u == null ? void 0 : u.closeParents());
    }, 40);
  } }), zt(() => u == null ? void 0 : u.unregister()), Xu(() => r.value = false), le(r, (g) => {
  ...
  function d(g) {
    ...
    if (!e.disabled) if (g.key === "Tab" || g.key === "Enter" && !e.closeOnContentClick) {
      ...
      g.key === "Enter" && g.preventDefault(), !id(Xn((_a2 = l.value) == null ? void 0 : _a2.contentEl, false), g.shiftKey ? "prev" : "next", (v) => v.tabIndex >= 0) && !e.retainFocus && (r.value = false, (_c2 = (_b2 = l.value) == null ? void 0 : _b2.activatorEl) == null ? void 0 : _c2.focus());
  ...
  return ze(() => {
    const g = es.filterProps(e);
    return T(es, Re({ ref: l, id: a.value, class: ["v-menu", e.class], style: e.style }, g, { modelValue: r.value, "onUpdate:modelValue": (S) => r.value = S, absolute: true, activatorProps: b.value, location: e.location ?? (e.submenu ? "end" : "bottom"), "onClick:outside": f, onKeydown: d }, i), { activator: n.activator, default: function() {
      for (var S = arguments.length, v = new Array(S), y = 0; y < S; y++) v[y] = arguments[y];
      return T(mn, { root: "VMenu" }, { default: () => {
        var _a2;
        return [(_a2 = n.default) == null ? void 0 : _a2.call(n, ...v)];
      } });
    } });
  }), Id({ id: a, \u03A8openChildren: c }, l);
} }), At = (e, t) => {
  const n = e.__vccOpts || e;
  for (const [r, i] of t) n[r] = i;
  return n;
}, f0 = Ye({ __name: "AppBackground", setup(e) {
  const t = aa("AppBackground"), n = X(null), r = X(null), i = tg(), s = mr(), o = ig(i.gridInfo, s.worldOffsetDevicePx), a = sg(), l = og(o), u = fg(i.post);
  qg(i);
  function c(_) {
  ...
  const d = eg({ onSetZones: (_) => i.post({ type: "set_zones", zones: f(_) }), onAddZone: (_) => i.post({ type: "add_zone", zone: c(_) }), onUpdateZone: (_) => i.post({ type: "update_zone", zone: c(_) }), onRemoveZone: (_) => i.post({ type: "remove_zone", id: _ }), onClearZones: () => i.post({ type: "clear_zones" }) }), m = X(false), b = X(false), g = X({ mode: "both", edge: { style: "none", widthCells: 1, opacity: 1 } }), { theme: S } = Ff();
  le(S, (_) => {
  ...
  function y(_) {
    ...
    if (!x) return;
    const E = If(_.clientX, _.clientY, x), P = H1(E, x);
    t.debug("Click \u2192", _.clientX, _.clientY, "\u2192 cell", P.cx, P.cy), i.post({ type: "toggle_cell", cx: P.cx, cy: P.cy, scrollCanvasPx: x.offsetY });
  }
  let A = null;
  return Wt(() => {
    const _ = n.value, x = r.value;
    if (!_ || !x) return;
    const { offscreen: E, gridPitch: P } = u.initialize(_, x);
    i.init(E, P, S.value), t.debug("Worker spawned, gridPitch", P.toFixed(2)), i.on("ready", (w) => {
    ...
    }), mg(i), document.addEventListener("click", y), A = l.attachListeners(), a.start(() => i.post({ type: "frame" }));
  }), ai(() => {
    a.stop(), u.teardown(), document.removeEventListener("click", y), A == null ? void 0 : A(), i.terminate();
  }), (_, x) => (ce(), me(_e, null, [k("div", { ref_key: "shellRef", ref: n, class: "app-bg-shell" }, [k("canvas", { ref_key: "canvasRef", ref: r, class: "app-bg" }, null, 512)], 512), re(l).previewStyle.value ? (ce(), me("div", { key: 0, class: "zone-preview-overlay", style: He(re(l).previewStyle.value) }, null, 4)) : rr("", true), rr("", true)], 64));
} }), d0 = At(f0, [["__scopeId", "data-v-7fbe32f4"]]), m0 = ne({ id: String, interactive: Boolean, text: String, ...mi(Ia({ closeOnBack: false, location: "end", locationStrategy: "connected", eager: true, minWidth: 0, offset: 10, openOnClick: false, openOnHover: true, origin: "auto", scrim: false, scrollStrategy: "reposition", transition: null }), ["absolute", "retainFocus", "captureFocus", "disableInitialFocus"]) }, "VTooltip"), Nr = Pe()({ name: "VTooltip", props: m0(), emits: { "update:modelValue": (e) => true }, setup(e, t) {
  let { slots: n } = t;
  const r = Qt(e, "modelValue"), { scopeId: i } = Ra(), s = oi(), o = B(() => e.id || `v-tooltip-${s}`), a = X(), l = H(() => e.location.split(" ").length > 1 ? e.location : e.location + " center"), u = H(() => e.origin === "auto" || e.origin === "overlap" || e.origin.split(" ").length > 1 || e.location.split(" ").length > 1 ? e.origin : e.origin + " center"), c = B(() => e.transition != null ? e.transition : r.value ? "scale-transition" : "fade-transition"), f = H(() => Re({ "aria-describedby": o.value }, e.activatorProps));
  return ze(() => {
    const d = es.filterProps(e);
    return T(es, Re({ ref: a, class: ["v-tooltip", { "v-tooltip--interactive": e.interactive }, e.class], style: e.style, id: o.value }, d, { modelValue: r.value, "onUpdate:modelValue": (m) => r.value = m, transition: c.value, absolute: true, location: l.value, origin: u.value, role: "tooltip", activatorProps: f.value, _disableGlobalStack: true }, i), { activator: n.activator, default: function() {
      var _a2;
      for (var m = arguments.length, b = new Array(m), g = 0; g < m; g++) b[g] = arguments[g];
      return ((_a2 = n.default) == null ? void 0 : _a2.call(n, ...b)) ?? e.text;
    } });
  }), Id({}, a);
} }), h0 = Ye({ __name: "ThemeToggle", setup(e) {
  const { preference: t } = Ff();
  return (n, r) => (ce(), nr(fp, { modelValue: re(t), "onUpdate:modelValue": r[0] || (r[0] = (i) => Ve(t) ? t.value = i : null), mandatory: "", density: "compact", variant: "text", class: "theme-toggle" }, { default: $e(() => [T(Oi, { value: "light", icon: re(Vl), size: "small" }, { default: $e(() => [T(st, { icon: re(Vl) }, null, 8, ["icon"]), T(Nr, { activator: "parent", location: "bottom", text: "Light" })]), _: 1 }, 8, ["icon"]), T(Oi, { value: "system", icon: re(Il), size: "small" }, { default: $e(() => [T(st, { icon: re(Il) }, null, 8, ["icon"]), T(Nr, { activator: "parent", location: "bottom", text: "System" })]), _: 1 }, 8, ["icon"]), T(Oi, { value: "dark", icon: re(Ol), size: "small" }, { default: $e(() => [T(st, { icon: re(Ol) }, null, 8, ["icon"]), T(Nr, { activator: "parent", location: "bottom", text: "Dark" })]), _: 1 }, 8, ["icon"])]), _: 1 }, 8, ["modelValue"]));
} }), g0 = At(h0, [["__scopeId", "data-v-1de18a37"]]), v0 = { class: "chrome" }, p0 = { class: "chrome__bar" }, y0 = { class: "chrome__controls" }, b0 = Ye({ __name: "AppChrome", setup(e) {
  const t = X(false);
  return (n, r) => {
    const i = ef("router-link");
    return ce(), me("div", v0, [k("div", p0, [T(i, { to: "/", class: "chrome__mark glass-chip", "aria-label": "Taylor Hale \u2014 home" }, { default: $e(() => [...r[2] || (r[2] = [Yn(" Taylor Hale ", -1)])]), _: 1 }), k("div", y0, [T(g0), T(u0, { modelValue: t.value, "onUpdate:modelValue": r[1] || (r[1] = (s) => t.value = s), location: "bottom end", offset: "10" }, { activator: $e(({ props: s }) => [T(Oi, Re(s, { icon: re(_g), variant: "text", size: "small", class: "chrome__menu-btn", "aria-label": "All destinations" }), null, 16, ["icon"])]), default: $e(() => [T(Vy, { class: "chrome-menu-list", density: "compact" }, { default: $e(() => [(ce(true), me(_e, null, ht(re(dr), (s) => (ce(), nr(Po, { key: s.id, to: s.route, title: s.label, onClick: r[0] || (r[0] = (o) => t.value = false) }, null, 8, ["to", "title"]))), 128))]), _: 1 })]), _: 1 }, 8, ["modelValue"])])])]);
  };
} }), _0 = At(b0, [["__scopeId", "data-v-d468d2cb"]]);
/*!
* vue-router v4.6.4
...
function w0(e) {
  return e.__esModule || e[Symbol.toStringTag] === "Module" || e.default && Yd(e.default);
}
...
const qd = /#/g, S0 = /&/g, C0 = /\//g, x0 = /=/g, A0 = /\?/g, Xd = /\+/g, L0 = /%5B/g, E0 = /%5D/g, Jd = /%5E/g, M0 = /%60/g, Qd = /%7B/g, k0 = /%7C/g, em = /%7D/g, T0 = /%20/g;
function Oa(e) {
  return e == null ? "" : encodeURI("" + e).replace(k0, "|").replace(L0, "[").replace(E0, "]");
}
function P0(e) {
  return Oa(e).replace(Qd, "{").replace(em, "}").replace(Jd, "^");
}
function Vo(e) {
  return Oa(e).replace(Xd, "%2B").replace(T0, "+").replace(qd, "%23").replace(S0, "%26").replace(M0, "`").replace(Qd, "{").replace(em, "}").replace(Jd, "^");
}
function R0(e) {
  return Vo(e).replace(x0, "%3D");
}
function I0(e) {
  return Oa(e).replace(qd, "%23").replace(A0, "%3F");
}
function O0(e) {
  return I0(e).replace(C0, "%2F");
}
function ti(e) {
  if (e == null) return null;
  try {
...
const V0 = /\/$/, D0 = (e) => e.replace(V0, "");
function eo(e, t, n = "/") {
  let r, i = {}, s = "", o = "";
  const a = t.indexOf("#");
  let l = t.indexOf("?");
  return l = a >= 0 && l > a ? -1 : l, l >= 0 && (r = t.slice(0, l), s = t.slice(l, a > 0 ? a : t.length), i = e(s.slice(1))), a >= 0 && (r = r || t.slice(0, a), o = t.slice(a, t.length)), r = $0(r ?? t, n), { fullPath: r + s + o, path: r, query: i, hash: ti(o) };
}
function H0(e, t) {
...
function N0(e, t, n) {
  ...
  return r > -1 && r === i && cr(t.matched[r], n.matched[i]) && tm(t.params, n.params) && e(t.query) === e(n.query) && t.hash === n.hash;
}
function cr(e, t) {
...
function tm(e, t) {
  ...
  for (var n in e) if (!F0(e[n], t[n])) return false;
  return true;
}
function F0(e, t) {
  return Pt(e) ? Nc(e, t) : Pt(t) ? Nc(t, e) : (e == null ? void 0 : e.valueOf()) === (t == null ? void 0 : t.valueOf());
}
function Nc(e, t) {
...
function B0(e) {
  ...
  return e[0] !== "/" && e[0] !== "#" && (e = "/" + e), D0(e);
}
const j0 = /^[^#]+#/;
function W0(e, t) {
  return e.replace(j0, "#") + t;
}
function z0(e, t) {
...
function ur(e, t) {
  return Ce(new Error(), { type: e, [rm]: true }, t);
}
function Kt(e, t) {
  return e instanceof Error && rm in e && (t == null || !!(e.type & t));
}
const Y0 = ["params", "query", "hash"];
function q0(e) {
  if (typeof e == "string") return e;
  if (e.path != null) return e.path;
  const t = {};
  for (const n of Y0) n in e && (t[n] = e[n]);
...
function X0(e) {
  ...
  for (let r = 0; r < n.length; ++r) {
    const i = n[r].replace(Xd, " "), s = i.indexOf("="), o = ti(s < 0 ? i : i.slice(0, s)), a = s < 0 ? null : ti(i.slice(s + 1));
    if (o in t) {
      let l = t[o];
...
function $c(e) {
  ...
  for (let n in e) {
    ...
    (Pt(r) ? r.map((i) => i && Vo(i)) : [r && Vo(r)]).forEach((i) => {
...
const Q0 = Symbol(""), Bc = Symbol(""), As = Symbol(""), Va = Symbol(""), No = Symbol("");
function Lr() {
  let e = [];
  function t(r) {
    return e.push(r), () => {
...
function fn(e, t, n, r, i, s = (o) => o()) {
  ...
  return () => new Promise((a, l) => {
    const u = (d) => {
      d === false ? l(ur(Fe.NAVIGATION_ABORTED, { from: n, to: t })) : d instanceof Error ? l(d) : K0(d) ? l(ur(Fe.NAVIGATION_GUARD_REDIRECT, { from: t, to: d })) : (o && r.enterCallbacks[i] === o && typeof d == "function" && o.push(d), a());
    }, c = s(() => e.call(r && r.instances[i], t, n, u));
    let f = Promise.resolve(c);
    e.length < 3 && (f = f.then(u)), f.catch((d) => l(d));
  });
}
function no(e, t, n, r, i = (s) => s()) {
  const s = [];
  for (const o of e) for (const a in o.components) {
    let l = o.components[a];
    if (!(t !== "beforeRouteEnter" && !o.instances[a])) if (Yd(l)) {
...
function eb(e, t) {
  ...
  for (let o = 0; o < s; o++) {
    ...
    const l = e.matched[o];
    l && (t.matched.find((u) => cr(u, l)) || i.push(l));
  }
  return [n, r, i];
}
/*!
...
* @license MIT
*/
let tb = () => location.protocol + "//" + location.host;
function im(e, t) {
...
function nb(e, t, n, r) {
  let i = [], s = [], o = null;
  const a = ({ state: d }) => {
    const m = im(e, location), b = n.value, g = t.value;
    let S = 0;
    if (d) {
  ...
  function c() {
    if (document.visibilityState === "hidden") {
      ...
      if (!d.state) return;
      d.replaceState(Ce({}, d.state, { scroll: xs() }), "");
    }
  }
  function f() {
    for (const d of s) d();
...
function jc(e, t, n, r = false, i = false) {
  return { back: e, current: t, forward: n, replaced: r, position: window.history.length, scroll: i ? xs() : null };
}
function rb(e) {
  const { history: t, location: n } = window, r = { value: im(e, n) }, i = { value: t.state };
  i.value || s(r.value, { back: null, current: r.value, forward: null, position: t.length - 1, replaced: true, scroll: null }, true);
  function s(l, u, c) {
    const f = e.indexOf("#"), d = f > -1 ? (n.host && document.querySelector("base") ? e : e.slice(f)) + l : tb() + e + l;
    try {
  ...
  function o(l, u) {
    s(l, Ce({}, t.state, jc(i.value.back, l, i.value.forward, true), u, { position: i.value.position }), true), r.value = l;
  }
  function a(l, u) {
    const c = Ce({}, i.value, t.state, { forward: l, scroll: xs() });
    s(c.current, c, true), s(l, Ce({}, jc(r.value, l, null), { position: c.position + 1 }, u), false), r.value = l;
  }
  return { location: r, state: i, push: a, replace: o };
}
function ib(e) {
  e = B0(e);
  const t = rb(e), n = nb(e, t.state, t.location, t.replace);
  function r(s, o = true) {
    o || n.pauseListeners(), history.go(s);
  }
  const i = Ce({ location: "", base: e, go: r, createHref: W0.bind(null, e) }, t, n);
...
const sb = { type: En.Static, value: "" }, ob = /[a-zA-Z0-9_]/;
function ab(e) {
  if (!e) return [[]];
  if (e === "/") return [[sb]];
  ...
  for (; a < e.length; ) {
    ...
    switch (n) {
      ...
      case We.EscapeNext:
        ...
        break;
      case We.Param:
        l === "(" ? n = We.ParamRegExp : ob.test(l) ? d() : (f(), n = We.Static, l !== "*" && l !== "?" && l !== "+" && a--);
        break;
      case We.ParamRegExp:
...
const Wc = "[^/]+?", lb = { sensitive: false, strict: false, start: true, end: true };
var at = (function(e) {
...
function ub(e, t) {
  ...
  for (const u of e) {
    ...
    for (let f = 0; f < u.length; f++) {
      ...
      if (d.type === En.Static) f || (i += "/"), i += d.value.replace(cb, "\\$&"), m += at.Static;
...
const db = { strict: false, end: true, sensitive: false };
function mb(e, t, n) {
  const r = ub(ab(e.path), n), i = Ce(r, { record: e, parent: t, children: [], alias: [] });
...
function hb(e, t) {
  ...
  function s(f, d, m) {
    ...
    if ("alias" in f) {
      ...
      for (const x of _) v.push(Uc(Ce({}, g, { components: m ? m.record.components : g.components, path: x, aliasOf: m ? m.record : g })));
    }
    let y, A;
    for (const _ of v) {
      const { path: x } = _;
      if (d && x[0] !== "/") {
        const E = d.record.path, P = E[E.length - 1] === "/" ? "" : "/";
        _.path = d.record.path + (x && P + x);
      }
      if (y = mb(_, d, S), m ? m.alias.push(y) : (A = A || y, A !== y && A.alias.push(y), b && f.name && !Zc(y) && o(f.name)), om(y) && l(y), g.children) {
        const E = g.children;
        for (let P = 0; P < E.length; P++) s(E[P], y, m && m.children[P]);
      }
      m = m || y;
    }
    return A ? () => {
  ...
  function l(f) {
    const d = pb(f, n);
    n.splice(d, 0, f), f.record.name && !Zc(f) && r.set(f.record.name, f);
  }
  function u(f, d) {
    let m, b = {}, g, S;
    if ("name" in f && f.name) {
      if (m = r.get(f.name), !m) throw ur(Fe.MATCHER_NOT_FOUND, { location: f });
      S = m.record.name, b = Ce(Gc(d.params, m.keys.filter((A) => !A.optional).concat(m.parent ? m.parent.keys.filter((A) => A.optional) : []).map((A) => A.name)), f.params && Gc(f.params, m.keys.map((A) => A.name))), g = m.stringify(b);
    } else if (f.path != null) g = f.path, m = n.find((A) => A.re.test(g)), m && (b = m.parse(g), S = m.record.name);
    else {
      if (m = d.name ? r.get(d.name) : n.find((A) => A.re.test(d.path)), !m) throw ur(Fe.MATCHER_NOT_FOUND, { location: f, currentLocation: d });
      S = m.record.name, b = Ce({}, d.params, f.params), g = m.stringify(b);
    }
    const v = [];
    let y = m;
    for (; y; ) v.unshift(y.record), y = y.parent;
    return { name: S, path: g, params: b, matched: v, meta: vb(v) };
  }
  e.forEach((f) => s(f));
  function c() {
    n.length = 0, r.clear();
...
function Uc(e) {
  const t = { path: e.path, redirect: e.redirect, name: e.name, meta: e.meta || {}, aliasOf: e.aliasOf, beforeEnter: e.beforeEnter, props: gb(e), children: e.children || [], instances: {}, leaveGuards: /* @__PURE__ */ new Set(), updateGuards: /* @__PURE__ */ new Set(), enterCallbacks: {}, components: "components" in e ? e.components || null : e.component && { default: e.component } };
...
function yb(e) {
  let t = e;
  for (; t = t.parent; ) if (om(t) && sm(e, t) === 0) return t;
}
function om({ record: e }) {
  return !!(e.name || e.components && Object.keys(e.components).length || e.redirect);
}
function Kc(e) {
  const t = Me(As), n = Me(Va), r = H(() => {
    const l = re(e.to);
    return t.resolve(l);
  }), i = H(() => {
    ...
    if (d > -1) return d;
    const m = Yc(l[u - 2]);
    return u > 1 && Yc(c) === m && f[f.length - 1].path !== m ? f.findIndex(cr.bind(null, l[u - 2])) : d;
  }), s = H(() => i.value > -1 && Cb(n.params, r.value.params)), o = H(() => i.value > -1 && i.value === n.matched.length - 1 && tm(n.params, r.value.params));
  function a(l = {}) {
    if (Sb(l)) {
  ...
  return { route: r, href: H(() => r.value.href), isActive: s, isExactActive: o, navigate: a };
}
function bb(e) {
  return e.length === 1 ? e[0] : e;
}
const _b = Ye({ name: "RouterLink", compatConfig: { MODE: 3 }, props: { to: { type: [String, Object], required: true }, replace: Boolean, activeClass: String, exactActiveClass: String, custom: Boolean, ariaCurrentValue: { type: String, default: "page" }, viewTransition: Boolean }, useLink: Kc, setup(e, { slots: t }) {
  const n = Ue(Kc(e)), { options: r } = Me(As), i = H(() => ({ [qc(e.activeClass, r.linkActiveClass, "router-link-active")]: n.isActive, [qc(e.exactActiveClass, r.linkExactActiveClass, "router-link-exact-active")]: n.isExactActive }));
  return () => {
...
const qc = (e, t, n) => e ?? t ?? n, xb = Ye({ name: "RouterView", inheritAttrs: false, props: { name: { type: String, default: "default" }, route: Object }, compatConfig: { MODE: 3 }, setup(e, { attrs: t, slots: n }) {
  const r = Me(No), i = H(() => e.route || r.value), s = Me(Bc, 0), o = H(() => {
    let u = re(s);
    const { matched: c } = i.value;
    let f;
    for (; (f = c[u]) && !f.components; ) u++;
    return u;
  }), a = H(() => i.value.matched[o.value]);
  it(Bc, H(() => o.value + 1)), it(Q0, a), it(No, i);
  const l = X();
  return le(() => [l.value, a.value, e.name], ([u, c, f], [d, m, b]) => {
    c && (c.instances[f] = u, m && m !== c && u && u === d && (c.leaveGuards.size || (c.leaveGuards = m.leaveGuards), c.updateGuards.size || (c.updateGuards = m.updateGuards))), u && c && (!m || !cr(c, m) || !d) && (c.enterCallbacks[f] || []).forEach((g) => g(u));
  }, { flush: "post" }), () => {
    const u = i.value, c = e.name, f = a.value, d = f && f.components[c];
    if (!d) return Xc(n.default, { Component: d, route: u });
    ...
    return Xc(n.default, { Component: S, route: u }) || S;
  };
} });
function Xc(e, t) {
  if (!e) return null;
...
const Ab = xb;
function Lb(e) {
  const t = hb(e.routes, e), n = e.parseQuery || X0, r = e.stringifyQuery || $c, i = e.history, s = Lr(), o = Lr(), a = Lr(), l = ve(an);
  let u = an;
  $n && e.scrollBehavior && "scrollRestoration" in history && (history.scrollRestoration = "manual");
  const c = Qs.bind(null, (L) => "" + L), f = Qs.bind(null, O0), d = Qs.bind(null, ti);
  function m(L, j) {
    let z, U;
    return nm(L) ? (z = t.getRecordMatcher(L), U = j) : U = L, t.addRoute(U, z);
  }
  function b(L) {
  ...
  function v(L, j) {
    if (j = Ce({}, j || l.value), typeof L == "string") {
      const C = eo(n, L, j.path), I = t.resolve({ path: C.path }, j), V = i.createHref(C.fullPath);
      return Ce(C, I, { params: d(I.params), hash: ti(C.hash), redirectedFrom: void 0, href: V });
    }
    let z;
    ...
    const h = H0(r, Ce({}, L, { hash: P0(ge), path: U.path })), p = i.createHref(h);
    return Ce({ fullPath: h, hash: ge, query: r === $c ? J0(L.query) : L.query || {} }, U, { redirectedFrom: void 0, href: p });
  }
  function y(L) {
    return typeof L == "string" ? eo(n, L, l.value.path) : Ce({}, L);
  }
  function A(L, j) {
    if (u !== L) return ur(Fe.NAVIGATION_CANCELLED, { from: j, to: L });
  }
  function _(L) {
    return P(L);
  }
  ...
  function P(L, j) {
    ...
    if (C) return P(Ce(y(C), { state: typeof C == "object" ? Ce({}, ge, C.state) : ge, force: h, replace: p }), j || z);
    const I = z;
    I.redirectedFrom = j;
    let V;
    return !h && N0(r, U, z) && (V = ur(Fe.NAVIGATION_DUPLICATED, { to: I, from: U }), oe(U, U, true, false)), (V ? Promise.resolve(V) : R(I, U)).catch((O) => Kt(O) ? Kt(O, Fe.NAVIGATION_GUARD_REDIRECT) ? O : we(O) : ae(O, I, U)).then((O) => {
      if (O) {
        if (Kt(O, Fe.NAVIGATION_GUARD_REDIRECT)) return P(Ce({ replace: p }, y(O.to), { state: typeof O.to == "object" ? Ce({}, ge, O.to.state) : ge, force: h }), j || I);
  ...
  function R(L, j) {
    ...
    return z.push(p), Ne(z).then(() => {
      z = [];
      for (const C of s.list()) z.push(fn(C, L, j));
  ...
  function M(L, j, z, U, ge) {
    ...
    z && (U || p ? i.replace(L.fullPath, Ce({ scroll: p && C && C.scroll }, ge)) : i.push(L.fullPath, ge)), l.value = L, oe(L, j, z, p), we();
  }
  let $;
  function Y() {
    $ || ($ = i.listen((L, j, z) => {
      ...
      if (ge) {
        P(Ce(ge, { replace: true, force: true }), U).catch(Fr);
        return;
      }
      u = U;
      const h = l.value;
      $n && U0(Fc(h.fullPath, z.delta), xs()), R(U, h).catch((p) => Kt(p, Fe.NAVIGATION_ABORTED | Fe.NAVIGATION_CANCELLED) ? p : Kt(p, Fe.NAVIGATION_GUARD_REDIRECT) ? (P(Ce(y(p.to), { force: true }), U).then((C) => {
        Kt(C, Fe.NAVIGATION_ABORTED | Fe.NAVIGATION_DUPLICATED) && !z.delta && z.type === Do.pop && i.go(-1, false);
      }).catch(Fr), Promise.reject()) : (z.delta && i.go(-z.delta, false), ae(p, U, h))).then((p) => {
        p = p || M(U, h, false), p && (z.delta && !Kt(p, Fe.NAVIGATION_CANCELLED) ? i.go(-z.delta, false) : z.type === Do.pop && Kt(p, Fe.NAVIGATION_ABORTED | Fe.NAVIGATION_DUPLICATED) && i.go(-1, false)), N(U, h, p);
      }).catch(Fr);
    }));
  }
  let Z = Lr(), J = Lr(), Q;
  ...
  function oe(L, j, z, U) {
    ...
    const h = !z && Z0(Fc(L.fullPath, 0)) || (U || !z) && history.state && history.state.scroll || null;
    return dt().then(() => ge(L, j, h)).then((p) => p && G0(p)).catch((p) => ae(p, L, j));
  }
  const he = (L) => i.go(L);
  let de;
  const Be = /* @__PURE__ */ new Set(), Ge = { currentRoute: l, listening: true, addRoute: m, removeRoute: b, clearRoutes: t.clearRoutes, hasRoute: S, getRoutes: g, resolve: v, options: e, push: _, replace: x, go: he, back: () => he(-1), forward: () => he(1), beforeEach: s.add, beforeResolve: o.add, afterEach: a.add, onError: J.add, isReady: Oe, install(L) {
    L.component("RouterLink", wb), L.component("RouterView", Ab), L.config.globalProperties.$router = Ge, Object.defineProperty(L.config.globalProperties, "$route", { enumerable: true, get: () => re(l) }), $n && !de && l.value === an && (de = true, _(i.location).catch((U) => {
    }));
    const j = {};
    for (const U in an) Object.defineProperty(j, U, { get: () => l.value[U], enumerable: true });
    L.provide(As, Ge), L.provide(Va, Pu(j)), L.provide(No, l);
    const z = L.unmount;
    Be.add(L), L.unmount = function() {
      Be.delete(L), Be.size < 1 && (u = an, $ && $(), $ = null, l.value = an, de = false, Q = false), z();
    };
  } };
  function Ne(L) {
...
function Rb(e, t, n, r) {
  const i = { x: Math.cos(t), y: Math.sin(t) }, s = Pb(e, i, n), o = s.x - i.x * r, a = s.y - i.y * r;
  return { x: Math.min(n.maxX - r, Math.max(n.minX + r, o)), y: Math.min(n.maxY - r, Math.max(n.minY + r, a)) };
}
const Ib = ["id", "aria-current", "aria-label"], Ob = Ye({ __name: "WorldPanel", props: { waypointId: {} }, setup(e) {
  const t = e, n = vs(t.waypointId), { camera: r, viewport: i, spacing: s, setCaptureScroll: o } = mr(), a = am(), l = H(() => a.name === t.waypointId), u = H(() => fi(n, s.value)), c = H(() => {
    const b = Math.min(s.value.col, s.value.row) * Tg;
    return Eg(u.value, r.value, i.value, { radius: b, floor: kg });
  }), f = H(() => {
    const b = Nl + (1 - Nl) * c.value;
  ...
  }), (b, g) => (ce(), me("section", { id: `panel-${e.waypointId}`, ref_key: "panelRef", ref: d, class: Le(["world-panel", { "world-panel--scroll": l.value }]), style: He(f.value), "aria-current": l.value ? "page" : void 0, "aria-label": re(n).label, tabindex: "-1", "data-grid-ignore-click": "true", onScroll: m }, [yh(b.$slots, "default", {}, void 0)], 46, Ib));
} }), Er = At(Ob, [["__scopeId", "data-v-9d4ba97d"]]), Qe = { name: "Taylor Hale", tagline: "Engineer\xA0\xA0\xB7\xA0\xA0Designer\xA0\xA0\xB7\xA0\xA0Tinkerer", bio: "I build careful software: graphics systems, codegen tools, integration work on short delivery cycles. My background spans computer vision research, contract engineering, and full-stack web development. I'm chasing elegance where low-level detail and high-level design meet. At least once.", location: "Bentonville, AR", email: "hale.taylor.dev@gmail.com", phone: "(615) 681-3779", github: "https://github.com/Anjin-Byte", linkedin: "https://linkedin.com/in/bits-for-bread" }, Fo = [{ label: "Location", icon: jf, href: "https://maps.google.com/?q=Bentonville,+AR", display: Qe.location }, { label: "Email", icon: $f, href: `mailto:${Qe.email}`, display: Qe.email }, { label: "Phone", icon: wg, href: `tel:${Qe.phone.replace(/[^\d+]/g, "")}`, display: Qe.phone }, { label: "GitHub", icon: Bf, href: Qe.github, display: "Anjin-Byte" }, { label: "LinkedIn", icon: bg, href: Qe.linkedin, display: "bits-for-bread" }], Vb = [{ label: "Languages", items: ["Python", "Java", "Rust", "C/C++", "JavaScript", "TypeScript", "SQL"] }, { label: "Frameworks & Libraries", items: ["PyTorch", "Pydantic", "CUDA", "OpenCV", "Detectron2", "React", "Vue", "OpenGL / WebGPU"] }, { label: "Tools & Platforms", items: ["Git", "Cargo", "wasm-pack", "pnpm", "Vite", "Docker", "FFmpeg", "CMake", "GitHub Actions", "Postman"] }], Db = [{ title: "SM83 Emulator", blurb: "An SM83 CPU disassembler and emulator \u2014 translating Game Boy binaries into readable assembly and a custom microcode format, rendered with a WebGL2 LCD-substrate shader for material-grain authenticity.", tech: ["Rust", "WASM", "WebGL2", "Svelte", "TypeScript"], links: [{ kind: "demo", href: "https://anjin-byte.github.io/fragile-canvas/" }, { kind: "source", href: "https://github.com/Anjin-Byte/fragile-canvas" }] }, { title: "Anjin-Byte.github.io", blurb: "This site. Conway's Game of Life running as a WebGPU-rendered engineering-paper background, with a theme system parameterized in OKLab.", tech: ["Rust", "WebGPU", "WASM", "Vue 3", "TypeScript", "WGSL"], links: [{ kind: "source", href: "https://github.com/Anjin-Byte/Anjin-Byte.github.io" }] }, { title: "Gestalt", blurb: "A GPU-driven voxel mesh renderer built with Rust + WASM + Svelte 5 + WebGPU.", tech: ["Rust", "WASM", "WebGPU", "Svelte 5"], links: [{ kind: "demo", href: "https://anjin-byte.github.io/Gestalt/" }, { kind: "source", href: "https://github.com/Anjin-Byte/Gestalt" }] }, { title: "Adaptive Ray Tracer", blurb: 'A first-principles ray tracer based on "Ray Tracing in One Weekend," extended with entropy-based heuristics that dynamically adjust sample density for rendering efficiency.', tech: ["C++", "Rendering"], links: [{ kind: "source", href: "https://github.com/Anjin-Byte/shiny-parakeet" }] }, { title: "SIBR SDF Lattice Generator", blurb: "A Rust API for generating printable lattice meshes via SDF. Supports cubic, Kelvin, and BccXy unit cells; produces STL through a marching-cubes pipeline with Taubin smoothing and optional QEM decimation.", tech: ["Rust", "SDF", "Marching Cubes", "Mesh Processing"], links: [{ kind: "demo", href: "https://anjin-byte.github.io/WoodwardFormanLatticeGen/" }, { kind: "source", href: "https://github.com/Anjin-Byte/SIBR_SDF_Lattice_Generator" }] }, { title: "Heightfield Filters", blurb: "A Rust image-processing suite for terrain heightfields \u2014 hexagonal-kernel aggregation, Sobel/Prewitt edge detection, and extraction of structural lines (crests, thalwegs, convex/concave ridges) from raw .r32 elevation rasters. Parallelized with Rayon.", tech: ["Rust", "Image Processing", "Terrain Analysis", "Rayon"], links: [{ kind: "source", href: "https://github.com/Anjin-Byte/probable-eureka" }] }, { title: "Schmith", blurb: "A Python CLI that generates C# DataObjects from API specifications. Supports deterministic and LLM-augmented (Anthropic, OpenAI) generation with stable, reproducible output and partial regeneration that preserves downstream hand-edits as specs evolve.", tech: ["Python", "C#", "LLM", "Anthropic", "OpenAI", "CLI"], links: [{ kind: "source", href: "https://github.com/Anjin-Byte/Schmith" }] }], Hb = [{ role: "Dispatcher \xB7 NW: Nationwide Service & Projects", company: "Wachter, Inc.", location: "Bentonville, AR", dates: "Nov 2025 \u2013 Present", highlights: ["Coordinate nationwide dispatch of service technicians for low-voltage networking projects, maintaining an updated schedule in a high-volume, time-sensitive environment.", "Act as central coordination point between project managers, field technicians, and clients \u2014 translating job requirements into execution and closing communication gaps.", "Manage full lifecycle of service tickets across multiple concurrent projects: creation, assignment, progress tracking, and closeout deliverables."] }, { role: "Contract Developer \u2014 XChange Connector Engineering", company: "Pipeline Data Services", location: "Remote", dates: "Sep 2025 \u2013 Present", tech: ["C#", ".NET", "XChange SDK", "REST", "Python"], highlights: ["Delivered 5 production-ready connectors on an accelerated timeline, unifying client data across workforce-management and project-planning systems via Trimble's App Xchange platform.", "Designed an automated contract-testing framework validating API documentation, client data, and XChange Data Objects \u2014 reducing T&E cycles by 45%."] }, { role: "AI Systems Developer \u2014 SBIR Phase I Prototype", company: "Brynhild Industries", location: "Washington, DC \xB7 Remote", dates: "Feb 2024 \u2013 Apr 2025", tech: ["Python", "Pydantic", "anytree", "OpenAI API"], highlights: ["Built a recursive task-decomposition engine that transformed open-ended prompts into structured task trees, enabling downstream agent assignment and process automation.", "Wrote duplicate-detection and best-fit specialist-assignment logic, demonstrating schema-bound agent coordination for planning workflows."] }, { role: "Data Collection & Model Training", company: "UARK Computer Vision & Image Understanding Lab", location: "Fayetteville, AR", dates: "Jul 2023 \u2013 Jun 2024", tech: ["Python", "OpenCV", "FFmpeg", "Detectron2", "PyTorch"], highlights: ["Engineered an end-to-end video-to-training pipeline \u2014 ingesting raw multi-device footage, parallelizing instance segmentation with Detectron2, and aligning outputs to CASIA-B gait dataset standards \u2014 producing model-ready training data for gait-recognition research."] }, { role: "Graduate Research Assistant", company: "UARK Computer Vision & Image Understanding Lab", location: "Fayetteville, AR", dates: "Aug 2021 \u2013 Feb 2022", highlights: ["Built labeled datasets of thousands of taxonomically verified specimens and prototyped a detection + classification pipeline for species-level insect identification \u2014 targeting early-warning systems for agricultural pest outbreaks."] }, { role: "Internship", company: "Daybright Financial", location: "Brentwood, TN \xB7 Chennai, India", dates: "Apr 2021 \u2013 May 2022", highlights: ["Connected rich-text HTML email templates to Oracle databases via PL/SQL (UTL_MAIL, UTL_SMTP) to automate internal and customer-facing communications with consistent rendering across mail clients."] }], Nb = [{ degree: "BA", school: "University of Arkansas", field: "Computer Science", location: "Fayetteville, AR", dates: "Graduated 2024", focus: "GPGPU Programming" }], Fb = { id: "hero", class: "hero-section" }, $b = { class: "hero-frame glass-panel glass-panel--strong" }, Bb = { class: "hero-main" }, jb = ["href", "aria-label"], Wb = { class: "hero-name section-heading" }, zb = { class: "hero-tagline" }, Gb = { class: "hero-bio" }, Ub = { class: "hero-actions" }, Zb = { class: "hero-rail" }, Kb = { class: "hero-note quiet-sheet" }, Yb = { class: "skills-block" }, qb = { class: "skill-label" }, Xb = { class: "skill-items" }, Jb = { class: "hero-note quiet-sheet" }, Qb = { class: "hero-links" }, e2 = ["href"], t2 = Ye({ __name: "HeroSection", setup(e) {
  const t = Fo.filter((r) => r.label === "Email" || r.label === "GitHub" || r.label === "LinkedIn"), n = Fo.find((r) => r.label === "Location");
  return (r, i) => {
    const s = ef("router-link");
    return ce(), me("section", Fb, [T(_i, { class: "hero-container" }, { default: $e(() => {
      var _a2;
      return [k("div", $b, [k("div", Bb, [k("a", { href: (_a2 = re(n)) == null ? void 0 : _a2.href, target: "_blank", rel: "noopener noreferrer", class: "hero-kicker glass-chip section-kicker", "aria-label": `${re(Qe).location} \u2014 open in maps` }, [T(st, { icon: re(jf), class: "hero-location-icon" }, null, 8, ["icon"]), Yn(ye(re(Qe).location), 1)], 8, jb), k("h1", Wb, ye(re(Qe).name), 1), k("p", zb, ye(re(Qe).tagline), 1), k("p", Gb, ye(re(Qe).bio), 1), k("div", Ub, [T(s, { to: "/projects", class: "hero-link paper-key paper-key--primary" }, { default: $e(() => [i[0] || (i[0] = Yn(" View selected work ", -1)), T(st, { icon: re(gg), class: "hero-link-icon" }, null, 8, ["icon"])]), _: 1 }), T(s, { to: "/resume", class: "hero-link paper-key" }, { default: $e(() => [...i[1] || (i[1] = [Yn("Resume", -1)])]), _: 1 })])]), k("aside", Zb, [k("section", Kb, [i[2] || (i[2] = k("p", { class: "hero-note-label" }, "Capabilities", -1)), k("div", Yb, [(ce(true), me(_e, null, ht(re(Vb), (o) => (ce(), me("div", { key: o.label, class: "skill-group" }, [k("span", qb, ye(o.label), 1), k("span", Xb, ye(o.items.join("  \xB7  ")), 1)]))), 128))])]), k("section", Jb, [i[3] || (i[3] = k("p", { class: "hero-note-label" }, "Elsewhere", -1)), k("div", Qb, [(ce(true), me(_e, null, ht(re(t), (o) => (ce(), me("a", { key: o.label, href: o.href, class: "hero-meta-link", target: "_blank", rel: "noopener noreferrer" }, [T(st, { icon: o.icon, class: "hero-meta-link-icon" }, null, 8, ["icon"]), k("span", null, ye(o.display ?? o.label), 1)], 8, e2))), 128))])])])])];
    }), _: 1 })]);
  };
} }), n2 = At(t2, [["__scopeId", "data-v-98831fd5"]]), $o = { demo: { ariaLabel: "Live demo", icon: Rl, label: "Demo", priority: 0 }, source: { ariaLabel: "GitHub repository", icon: Bf, label: "Source", priority: 1 }, writeup: { ariaLabel: "Project writeup", icon: Sg, label: "Writeup", priority: 2 }, video: { ariaLabel: "Project video", icon: Rl, label: "Video", priority: 3 }, docs: { ariaLabel: "Project documentation", icon: pg, label: "Docs", priority: 4 } };
function r2(e, t) {
  return $o[e].priority - $o[t].priority;
}
function i2(e) {
  return [...e.links ?? []].sort((t, n) => r2(t.kind, n.kind)).map((t) => ({ ...t, ...$o[t.kind] }));
}
function Jc(e, t) {
  const n = i2(e);
  return t === "featured" ? n : n.slice(0, 2);
}
const s2 = { id: "projects", class: "demos-section" }, o2 = { key: 0, class: "project-feature glass-panel" }, a2 = { class: "project-feature-body" }, l2 = { class: "project-feature-title" }, c2 = { class: "project-feature-blurb" }, u2 = { class: "project-feature-tech" }, f2 = { class: "project-feature-actions" }, d2 = ["href", "aria-label"], m2 = { class: "project-index" }, h2 = { class: "project-item-head" }, g2 = { class: "project-item-title" }, v2 = { key: 0, class: "project-item-links", "aria-label": "Project links" }, p2 = ["href", "aria-label"], y2 = { class: "project-item-blurb" }, b2 = { class: "project-item-tech" }, _2 = Ye({ __name: "ProjectsSection", setup(e) {
  const [t, ...n] = Db, r = t ? { ...t, visibleLinks: Jc(t, "featured") } : null, i = n.map((s) => ({ ...s, visibleLinks: Jc(s, "compact") }));
  return (s, o) => (ce(), me("section", s2, [T(_i, { class: "projects-container" }, { default: $e(() => [o[1] || (o[1] = k("div", { class: "projects-head" }, [k("div", { class: "projects-heading" }, [k("span", { class: "glass-chip section-kicker" }, "Selected work"), k("h2", { class: "section-heading projects-title" }, "Small things, built carefully.")]), k("p", { class: "section-intro projects-intro" }, " Projects spanning graphics, emulation, mesh generation, and interface engineering. ")], -1)), re(r) ? (ce(), me("article", o2, [k("div", a2, [o[0] || (o[0] = k("span", { class: "project-feature-label" }, "Featured project", -1)), k("h3", l2, ye(re(r).title), 1), k("p", c2, ye(re(r).blurb), 1), k("div", u2, [(ce(true), me(_e, null, ht(re(r).tech, (a) => (ce(), me("span", { key: a, class: "project-tech-tag" }, ye(a), 1))), 128))])]), k("div", f2, [(ce(true), me(_e, null, ht(re(r).visibleLinks, (a) => (ce(), me("a", { key: a.kind, href: a.href, target: "_blank", rel: "noopener noreferrer", class: Le(["project-link paper-key", { "paper-key--primary": a.kind === "demo" }]), "aria-label": a.ariaLabel }, [T(st, { icon: a.icon }, null, 8, ["icon"]), k("span", null, ye(a.label), 1), T(Nr, { activator: "parent", location: "top", text: a.ariaLabel }, null, 8, ["text"])], 10, d2))), 128))])])) : rr("", true), k("div", m2, [(ce(true), me(_e, null, ht(re(i), (a) => (ce(), me("article", { key: a.title, class: "project-item quiet-sheet" }, [k("header", h2, [k("h3", g2, ye(a.title), 1), a.visibleLinks.length ? (ce(), me("div", v2, [(ce(true), me(_e, null, ht(a.visibleLinks, (l) => (ce(), me("a", { key: l.kind, href: l.href, target: "_blank", rel: "noopener noreferrer", class: Le(["project-item-link paper-key--ghost", { "project-item-link--demo": l.kind === "demo" }]), "aria-label": l.ariaLabel }, [T(st, { icon: l.icon }, null, 8, ["icon"]), T(Nr, { activator: "parent", location: "top", text: l.ariaLabel }, null, 8, ["text"])], 10, p2))), 128))])) : rr("", true)]), k("p", y2, ye(a.blurb), 1), k("div", b2, [(ce(true), me(_e, null, ht(a.tech, (l) => (ce(), me("span", { key: l, class: "project-tech-tag" }, ye(l), 1))), 128))])]))), 128))])]), _: 1 })]));
} }), w2 = At(_2, [["__scopeId", "data-v-479b2a52"]]), S2 = { id: "resume", class: "resume-section" }, C2 = { class: "timeline" }, x2 = { class: "entry-rail" }, A2 = { class: "entry-dates glass-chip" }, L2 = { class: "entry quiet-sheet" }, E2 = { class: "entry-head" }, M2 = { class: "entry-titleblock" }, k2 = { class: "entry-role" }, T2 = { class: "entry-subhead" }, P2 = { class: "entry-company" }, R2 = { class: "entry-work-location" }, I2 = { class: "entry-bullets" }, O2 = { key: 0, class: "entry-tech" }, V2 = { class: "entry-tech-items" }, D2 = { class: "entry-head" }, H2 = { class: "entry-titleblock" }, N2 = { class: "entry-role" }, F2 = { class: "entry-company" }, $2 = { class: "entry-meta" }, B2 = { class: "entry-dates" }, j2 = { class: "entry-location" }, W2 = { key: 0, class: "entry-focus" }, z2 = Ye({ __name: "ResumeSection", setup(e) {
  return (t, n) => (ce(), me("section", S2, [T(_i, { class: "resume-container" }, { default: $e(() => [n[2] || (n[2] = k("div", { class: "resume-head" }, [k("div", { class: "resume-heading" }, [k("span", { class: "glass-chip section-kicker" }, "Resume"), k("h2", { class: "section-heading resume-title" }, "Experience")])], -1)), k("ol", C2, [(ce(true), me(_e, null, ht(re(Hb), (r) => (ce(), me("li", { key: `${r.company}-${r.dates}`, class: "timeline-row" }, [k("div", x2, [k("span", A2, ye(r.dates), 1)]), k("article", L2, [k("header", E2, [k("div", M2, [k("h3", k2, ye(r.role), 1), k("div", T2, [k("p", P2, ye(r.company), 1), k("span", R2, ye(r.location), 1)])])]), k("ul", I2, [(ce(true), me(_e, null, ht(r.highlights, (i, s) => (ce(), me("li", { key: s }, ye(i), 1))), 128))]), r.tech ? (ce(), me("div", O2, [n[0] || (n[0] = k("span", { class: "entry-tech-label" }, "Stack", -1)), k("span", V2, ye(r.tech.join("  \xB7  ")), 1)])) : rr("", true)])]))), 128))]), n[3] || (n[3] = k("div", { class: "edu-head" }, [k("span", { class: "glass-chip section-kicker" }, "Education")], -1)), (ce(true), me(_e, null, ht(re(Nb), (r) => (ce(), me("div", { key: `${r.school}-${r.degree}`, class: "education-card glass-panel" }, [k("header", D2, [k("div", H2, [k("h3", N2, ye(r.degree) + " \u2014 " + ye(r.field), 1), k("p", F2, ye(r.school), 1)]), k("div", $2, [k("span", B2, ye(r.dates), 1), k("span", j2, ye(r.location), 1)])]), r.focus ? (ce(), me("p", W2, [n[1] || (n[1] = k("span", { class: "entry-tech-label" }, "Focus", -1)), Yn(" " + ye(r.focus), 1)])) : rr("", true)]))), 128))]), _: 1 })]));
} }), G2 = At(z2, [["__scopeId", "data-v-081aa046"]]), U2 = ["href", "aria-label"], Z2 = { class: "contact-text" }, K2 = Ye({ __name: "ContactStrip", props: { dense: { type: Boolean } }, setup(e) {
  return (t, n) => (ce(), me("div", { class: Le(["contact-strip", { "is-dense": e.dense }]) }, [(ce(true), me(_e, null, ht(re(Fo), (r) => (ce(), me("a", { key: r.label, href: r.href, "aria-label": r.label, target: "_blank", rel: "noopener noreferrer", class: "contact-link paper-key" }, [T(st, { icon: r.icon, class: "contact-icon" }, null, 8, ["icon"]), k("span", Z2, ye(r.display ?? r.label), 1)], 8, U2))), 128))], 2));
} }), Y2 = At(K2, [["__scopeId", "data-v-999b7116"]]), q2 = { id: "contact", class: "contact-section" }, X2 = { class: "contact-band glass-panel" }, J2 = Ye({ __name: "ContactSection", setup(e) {
  return (t, n) => (ce(), me("section", q2, [T(_i, { class: "contact-container" }, { default: $e(() => [k("div", X2, [n[0] || (n[0] = k("div", { class: "contact-head" }, [k("span", { class: "glass-chip section-kicker" }, "Contact"), k("h2", { class: "contact-title" }, "Open to interesting problems."), k("p", { class: "contact-copy" })], -1)), T(Y2, { class: "contact-strip-wrap" })])]), _: 1 })]));
} }), Q2 = At(J2, [["__scopeId", "data-v-95eff47f"]]), e_ = { class: "about-section" }, t_ = { class: "content-surface about-card" }, n_ = { class: "section-heading" }, r_ = { class: "about-tagline" }, i_ = { class: "section-intro" }, s_ = { class: "about-meta" }, o_ = Ye({ __name: "AboutSection", setup(e) {
  return (t, n) => (ce(), me("section", e_, [T(_i, { class: "about-container" }, { default: $e(() => [k("div", t_, [n[0] || (n[0] = k("p", { class: "section-kicker" }, "About", -1)), k("h2", n_, ye(re(Qe).name), 1), k("p", r_, ye(re(Qe).tagline), 1), k("p", i_, ye(re(Qe).bio), 1), k("p", s_, ye(re(Qe).location), 1)])]), _: 1 })]));
} }), a_ = At(o_, [["__scopeId", "data-v-b03b1108"]]), l_ = Ye({ __name: "WorldStage", setup(e) {
  const { cameraStyle: t, setViewport: n, isAnimating: r } = mr(), i = X(null);
  let s = null;
  return Wt(() => {
    const o = i.value;
    if (!o) return;
  ...
  }), ai(() => s == null ? void 0 : s.disconnect()), (o, a) => (ce(), me("div", { ref_key: "stageRef", ref: i, class: "world-stage" }, [k("div", { class: Le(["world-plane", { "world-plane--animating": re(r) }]), style: He(re(t)) }, [T(Er, { "waypoint-id": "hero" }, { default: $e(() => [T(n2)]), _: 1 }), T(Er, { "waypoint-id": "projects" }, { default: $e(() => [T(w2)]), _: 1 }), T(Er, { "waypoint-id": "resume" }, { default: $e(() => [T(G2)]), _: 1 }), T(Er, { "waypoint-id": "contact" }, { default: $e(() => [T(Q2)]), _: 1 }), T(Er, { "waypoint-id": "about" }, { default: $e(() => [T(a_)]), _: 1 })], 6)], 512));
} }), c_ = At(l_, [["__scopeId", "data-v-0dbf5244"]]);
function Qc(e, t, n) {
  return Math.min(n, Math.max(t, e));
}
function u_(e, t, n) {
...
function eu(e, t) {
  e.wall === "L" ? e.x = t.minX + e.r : e.wall === "R" ? e.x = t.maxX - e.r : e.wall === "T" ? e.y = t.minY + e.r : e.y = t.maxY - e.r, e.x = Qc(e.x, t.minX + e.r, t.maxX - e.r), e.y = Qc(e.y, t.minY + e.r, t.maxY - e.r);
}
function f_(e, t) {
  const n = e.r + t.r;
  if (e.wall === t.wall) {
...
function d_(e, t, n) {
  const r = e.map((i) => {
    ...
    return { x: i.pos.x + s + a, y: i.pos.y + o + l, r: i.radius, wall: u_(i.target, t, i.radius) };
  });
  for (const i of r) eu(i, t);
  for (let i = 0; i < n.iterations; i++) {
    for (let s = 0; s < r.length; s++) for (let o = s + 1; o < r.length; o++) f_(r[s], r[o]);
    for (const s of r) eu(s, t);
  }
  return r.map((i) => ({ x: i.x, y: i.y }));
}
const m_ = 25.5, h_ = 40, g_ = 0.05, v_ = 720, p_ = 12;
function y_(e) {
...
function __() {
  const e = mr(), t = am(), n = X([]), r = /* @__PURE__ */ new Map(), i = b_();
  function s(c) {
    const f = e.camera.value, d = e.viewport.value, m = e.spacing.value, b = y_(d), g = { x: d.w / 2, y: d.h / 2 }, S = dr.map((M) => {
      const $ = fi(M, m);
      return { wp: M, dist: kb($, f), bearing: Mb($, f, d) };
    }).filter((M) => M.dist > Fl), v = S.map((M) => M.dist), y = v.length ? Math.min(...v) : 0, A = v.length ? Math.max(...v) : 1, _ = Math.min(d.w, d.h), x = Math.min(p_, Math.max(0, g_ * (_ - v_))), E = m_ + x, P = h_ + x, w = S.map((M) => {
      const $ = Tb(M.dist, y, A, E, P), Y = Rb(g, M.bearing, b, $), Z = r.get(M.wp.id) ?? { pos: Y, prevPos: Y };
      return { pos: Z.pos, prevPos: Z.prevPos, target: Y, radius: $ };
    }), D = d_(w, b, { stiffness: c ? 1 : Rg, friction: c ? 0 : Ig, iterations: Og }), R = new Set(S.map((M) => M.wp.id));
    ...
    return n.value = S.map((M, $) => {
      ...
      const J = w[$].target;
      return (Math.hypot(Y.x - Z.x, Y.y - Z.y) > 0.3 || Math.hypot(Y.x - J.x, Y.y - J.y) > 0.5) && (N = false), { id: M.wp.id, route: M.wp.route, label: M.wp.label, icon: M.wp.icon, x: Y.x, y: Y.y, radius: w[$].radius, bearing: M.bearing, opacity: Math.min(1, Math.max(0, (M.dist - Fl) / Pg)) };
    }), N;
  }
  let o = 0, a = false;
  function l() {
  ...
  return le([() => e.camera.value.x, () => e.camera.value.y, () => e.viewport.value, () => e.spacing.value, e.isAnimating, () => t.name], u), Wt(() => i ? s(true) : u()), ai(() => {
    o && cancelAnimationFrame(o);
  }), n;
}
const w_ = { class: "compass", "aria-label": "Move to a section" }, S_ = ["aria-label", "title", "onClick"], C_ = Ye({ __name: "CompassNav", setup(e) {
  const t = Eb(), n = __();
  function r(i) {
    t.push(i);
  }
  return (i, s) => (ce(), me("nav", w_, [(ce(true), me(_e, null, ht(re(n), (o) => (ce(), me("button", { key: o.id, type: "button", class: "compass__marker", style: He({ transform: `translate(${o.x}px, ${o.y}px) translate(-50%, -50%)`, width: `${o.radius * 2}px`, height: `${o.radius * 2}px`, opacity: o.opacity, pointerEvents: o.opacity > 0.4 ? "auto" : "none" }), "aria-label": `Go to ${o.label}`, title: o.label, onClick: (a) => r(o.route) }, [k("span", { class: "compass__arrow", style: He({ transform: `rotate(${o.bearing}rad)` }), "aria-hidden": "true" }, null, 4), T(st, { icon: o.icon, size: Math.round(o.radius), class: "compass__icon" }, null, 8, ["icon", "size"])], 12, S_))), 128))]));
} }), x_ = At(C_, [["__scopeId", "data-v-41dac3fc"]]), tu = Symbol.for("vuetify:layout"), A_ = Symbol.for("vuetify:layout-item"), nu = 1e3, L_ = ne({ overlaps: { type: Array, default: () => [] }, fullHeight: Boolean }, "layout"), E_ = (e, t, n, r) => {
...
function M_(e) {
  const t = Me(tu, null), n = H(() => t ? t.rootZIndex.value - 100 : nu), r = X([]), i = Ue(/* @__PURE__ */ new Map()), s = Ue(/* @__PURE__ */ new Map()), o = Ue(/* @__PURE__ */ new Map()), a = Ue(/* @__PURE__ */ new Map()), l = Ue(/* @__PURE__ */ new Map()), { resizeRef: u, contentRect: c } = yd(), f = H(() => {
    const E = /* @__PURE__ */ new Map(), P = e.overlaps ?? [];
    for (const w of P.filter((D) => D.includes(":"))) {
      const [D, R] = w.split(":");
      if (!r.value.includes(D) || !r.value.includes(R)) continue;
      const N = i.get(D), M = i.get(R), $ = s.get(D), Y = s.get(R);
      !N || !M || !$ || !Y || (E.set(R, { position: N.value, amount: parseInt($.value, 10) }), E.set(D, { position: M.value, amount: -parseInt(Y.value, 10) }));
    }
    return E;
  }), d = H(() => {
    const E = [...new Set([...o.values()].map((w) => w.value))].sort((w, D) => w - D), P = [];
    for (const w of E) {
    ...
    return E_(P, i, s, a);
  }), m = H(() => !Array.from(l.values()).some((E) => E.value)), b = H(() => d.value[d.value.length - 1].layer), g = B(() => ({ "--v-layout-left": pe(b.value.left), "--v-layout-right": pe(b.value.right), "--v-layout-top": pe(b.value.top), "--v-layout-bottom": pe(b.value.bottom), ...m.value ? void 0 : { transition: "none" } })), S = H(() => d.value.slice(1).map((E, P) => {
    let { id: w } = E;
    const { layer: D } = d.value[P], R = s.get(w), N = i.get(w);
    return { id: w, ...D, size: Number(R.value), position: N.value };
  })), v = (E) => S.value.find((P) => P.id === E), y = Ze("createLayout"), A = ve(false);
  return Wt(() => {
    A.value = true;
  }), it(tu, { register: (E, P) => {
    let { id: w, order: D, position: R, layoutSize: N, elementSize: M, active: $, disableTransitions: Y, absolute: Z } = P;
    o.set(w, D), i.set(w, R), s.set(w, N), a.set(w, $), Y && l.set(w, Y);
    const Q = jn(A_, y == null ? void 0 : y.vnode).indexOf(E);
    ...
    const ae = H(() => S.value.findIndex((he) => he.id === w)), Oe = H(() => n.value + d.value.length * 2 - ae.value * 2), we = H(() => {
      const he = R.value === "left" || R.value === "right", de = R.value === "right", Be = R.value === "bottom", Ge = M.value ?? N.value, Ne = Ge === 0 ? "%" : "px", L = { [R.value]: 0, zIndex: Oe.value, transform: `translate${he ? "X" : "Y"}(${($.value ? 0 : -(Ge === 0 ? 100 : Ge)) * (de || Be ? -1 : 1)}${Ne})`, position: Z.value || n.value !== nu ? "absolute" : "fixed", ...m.value ? void 0 : { transition: "none" } };
      if (!A.value) return L;
    ...
    }), oe = H(() => ({ zIndex: Oe.value - 1 }));
    return { layoutItemStyles: we, layoutItemScrimStyles: oe, zIndex: Oe };
  }, unregister: (E) => {
    o.delete(E), i.delete(E), s.delete(E), a.delete(E), l.delete(E), r.value = r.value.filter((P) => P !== E);
...
const k_ = ne({ ...qe(), ...mi(L_(), ["fullHeight"]), ...Gt() }, "VApp"), T_ = Pe()({ name: "VApp", props: k_(), setup(e, t) {
  let { slots: n } = t;
  const r = sn(e), { layoutClasses: i, getLayoutItem: s, items: o, layoutRef: a } = M_({ ...e, fullHeight: true }), { rtlClasses: l } = bi();
  return ze(() => {
    var _a2;
...
} }), P_ = Ye({ __name: "App", setup(e) {
  return (t, n) => (ce(), nr(T_, { class: "app-shell" }, { default: $e(() => [T(d0), T(_0), T(c_), T(x_)]), _: 1 }));
} }), R_ = { collapse: "mdi-chevron-up", complete: "mdi-check", cancel: "mdi-close-circle", close: "mdi-close", delete: "mdi-close-circle", clear: "mdi-close-circle", success: "mdi-check-circle", info: "mdi-information", warning: "mdi-alert-circle", error: "mdi-close-circle", prev: "mdi-chevron-left", next: "mdi-chevron-right", checkboxOn: "mdi-checkbox-marked", checkboxOff: "mdi-checkbox-blank-outline", checkboxIndeterminate: "mdi-minus-box", delimiter: "mdi-circle", sortAsc: "mdi-arrow-up", sortDesc: "mdi-arrow-down", expand: "mdi-chevron-down", menu: "mdi-menu", subgroup: "mdi-menu-down", dropdown: "mdi-menu-down", radioOn: "mdi-radiobox-marked", radioOff: "mdi-radiobox-blank", edit: "mdi-pencil", ratingEmpty: "mdi-star-outline", ratingFull: "mdi-star", ratingHalf: "mdi-star-half-full", loading: "mdi-cached", first: "mdi-page-first", last: "mdi-page-last", unfold: "mdi-unfold-more-horizontal", file: "mdi-paperclip", plus: "mdi-plus", minus: "mdi-minus", calendar: "mdi-calendar", treeviewCollapse: "mdi-menu-down", treeviewExpand: "mdi-menu-right", tableGroupCollapse: "mdi-chevron-down", tableGroupExpand: "mdi-chevron-right", eyeDropper: "mdi-eyedropper", upload: "mdi-cloud-upload", color: "mdi-palette", command: "mdi-apple-keyboard-command", ctrl: "mdi-apple-keyboard-control", space: "mdi-keyboard-space", shift: "mdi-apple-keyboard-shift", alt: "mdi-apple-keyboard-option", enter: "mdi-keyboard-return", arrowup: "mdi-arrow-up", arrowdown: "mdi-arrow-down", arrowleft: "mdi-arrow-left", arrowright: "mdi-arrow-right", backspace: "mdi-backspace", play: "mdi-play", pause: "mdi-pause", fullscreen: "mdi-fullscreen", fullscreenExit: "mdi-fullscreen-exit", volumeHigh: "mdi-volume-high", volumeMedium: "mdi-volume-medium", volumeLow: "mdi-volume-low", volumeOff: "mdi-volume-variant-off", search: "mdi-magnify" }, I_ = { component: (e) => vn(pd, { ...e, class: "mdi" }) };
function O_() {
  return { svg: { component: xa }, class: { component: pd } };
}
function V_(e) {
  const t = O_(), n = (e == null ? void 0 : e.defaultSet) ?? "mdi";
  return n === "mdi" && !t.mdi && (t.mdi = I_), pt({ defaultSet: n, sets: t, aliases: { ...R_, vuetify: ["M8.2241 14.2009L12 21L22 3H14.4459L8.2241 14.2009Z", ["M7.26303 12.4733L7.00113 12L2 3H12.5261C12.5261 3 12.5261 3 12.5261 3L7.26303 12.4733Z", 0.6]], "vuetify-outline": "svg:M7.26 12.47 12.53 3H2L7.26 12.47ZM14.45 3 8.22 14.2 12 21 22 3H14.45ZM18.6 5 12 16.88 10.51 14.2 15.62 5ZM7.26 8.35 5.4 5H9.13L7.26 8.35Z", "vuetify-play": ["m6.376 13.184-4.11-7.192C1.505 4.66 2.467 3 4.003 3h8.532l-.953 1.576-.006.01-.396.677c-.429.732-.214 1.507.194 2.015.404.503 1.092.878 1.869.806a3.72 3.72 0 0 1 1.005.022c.276.053.434.143.523.237.138.146.38.635-.25 2.09-.893 1.63-1.553 1.722-1.847 1.677-.213-.033-.468-.158-.756-.406a4.95 4.95 0 0 1-.8-.927c-.39-.564-1.04-.84-1.66-.846-.625-.006-1.316.27-1.693.921l-.478.826-.911 1.506Z", ["M9.093 11.552c.046-.079.144-.15.32-.148a.53.53 0 0 1 .43.207c.285.414.636.847 1.046 1.2.405.35.914.662 1.516.754 1.334.205 2.502-.698 3.48-2.495l.014-.028.013-.03c.687-1.574.774-2.852-.005-3.675-.37-.391-.861-.586-1.333-.676a5.243 5.243 0 0 0-1.447-.044c-.173.016-.393-.073-.54-.257-.145-.18-.127-.316-.082-.392l.393-.672L14.287 3h5.71c1.536 0 2.499 1.659 1.737 2.992l-7.997 13.996c-.768 1.344-2.706 1.344-3.473 0l-3.037-5.314 1.377-2.278.004-.006.004-.007.481-.831Z", 0.6]] } }, e);
}
function wi(e) {
...
function D_(e, t, n) {
  ...
  const r = [];
  let i = [];
  const s = lm(e), o = cm(e), a = n ?? ((_a2 = wi(t)) == null ? void 0 : _a2.firstDay) ?? 0, l = (s.getDay() - a + 7) % 7, u = (o.getDay() - a + 7) % 7;
  for (let c = 0; c < l; c++) {
    const f = new Date(s);
...
const F_ = /^([12]\d{3}-([1-9]|0[1-9]|1[0-2])-([1-9]|0[1-9]|[12]\d|3[01]))$/;
function um(e) {
  if (e == null) return /* @__PURE__ */ new Date();
  if (e instanceof Date) return e;
  if (typeof e == "string") {
    let t;
    if (F_.test(e)) return N_(e);
    if (t = Date.parse(e), !isNaN(t)) return new Date(t);
  }
  return null;
}
const ru = new Date(2e3, 0, 2);
function $_(e, t, n) {
  var _a2;
  const r = t ?? ((_a2 = wi(e)) == null ? void 0 : _a2.firstDay) ?? 0;
  return ed(7).map((i) => {
    const s = new Date(ru);
    return s.setDate(ru.getDate() + r + i), new Intl.DateTimeFormat(e, { weekday: n ?? "narrow" }).format(s);
  });
}
function B_(e, t, n, r) {
  const i = um(e) ?? /* @__PURE__ */ new Date(), s = r == null ? void 0 : r[t];
...
function j_(e, t) {
  const n = e.toJsDate(t), r = n.getFullYear(), i = Gl(String(n.getMonth() + 1), 2, "0"), s = Gl(String(n.getDate()), 2, "0");
  return `${r}-${i}-${s}`;
}
function W_(e) {
...
function Y_(e, t, n, r) {
  ...
  return r !== void 0 ? q_(e, t, s, r) : X_(e, t, s, o);
}
function q_(e, t, n, r) {
  const i = (7 + r - n) % 7, s = $r(e, t, n), o = Rn(s, 6);
  function a(d) {
  ...
  return 1 + ns(Da(s), ri(f), "weeks");
}
function X_(e, t, n, r) {
  const i = $r(e, t, n), s = Rn($r(e, t, n), 6);
  function o(f) {
    const d = new Date(f, 0, 1);
    return 7 - ns(d, $r(d, t, n), "days");
  }
  let a = ni(i);
  a < ni(s) && o(a + 1) >= r && a++;
  const l = new Date(a, 0, 1), u = o(a), c = u >= r ? Rn(l, u - 7) : Rn(l, u);
  return 1 + ns(Da(i), ri(c), "weeks");
}
function J_(e) {
  return e.getDate();
}
...
class pw {
  ...
  getWeekArray(t, n) {
    ...
    return D_(t, this.locale, r);
  }
  startOfWeek(t, n) {
    const r = n !== void 0 ? Number(n) : void 0;
    return $r(t, this.locale, r);
  }
  endOfWeek(t) {
    return H_(t, this.locale);
  }
  startOfMonth(t) {
    return lm(t);
  }
  ...
  format(t, n) {
    return B_(t, n, this.locale, this.formats);
  }
  isEqual(t, n) {
    return iu(t, n);
  }
...
const yw = Symbol.for("vuetify:date-options"), su = Symbol.for("vuetify:date-adapter");
function bw(e, t) {
  const n = pt({ adapter: pw, locale: { af: "af-ZA", bg: "bg-BG", ca: "ca-ES", ckb: "", cs: "cs-CZ", de: "de-DE", el: "el-GR", en: "en-US", et: "et-EE", fa: "fa-IR", fi: "fi-FI", hr: "hr-HR", hu: "hu-HU", he: "he-IL", id: "id-ID", it: "it-IT", ja: "ja-JP", ko: "ko-KR", lv: "lv-LV", lt: "lt-LT", nl: "nl-NL", no: "no-NO", pl: "pl-PL", pt: "pt-PT", ro: "ro-RO", ru: "ru-RU", sk: "sk-SK", sl: "sl-SI", srCyrl: "sr-SP", srLatn: "sr-SP", sv: "sv-SE", th: "th-TH", tr: "tr-TR", az: "az-AZ", uk: "uk-UA", vi: "vi-VN", zhHans: "zh-CN", zhHant: "zh-TW" } }, e);
  return { options: n, instance: _w(n, t) };
}
function _w(e, t) {
...
function fm() {
  ...
  return a.run(() => {
    const l = Ov(r.defaults), u = qp(r.display, r.ssr), c = Qv(r.theme), f = V_(r.icons), d = xp(r.locale), m = bw(r.date, d), b = ly(r.goTo, d);
    function g(v) {
      ...
      if (y.run(() => {
        c.install(v);
      }), v.onUnmount(() => y.stop()), v.provide(ar, l), v.provide(Mo, u), v.provide(Xr, c), v.provide(Co, f), v.provide(xo, d), v.provide(yw, m.options), v.provide(su, m.instance), v.provide(oy, b), Ie && r.ssr) if (v.$nuxt) v.$nuxt.hook("app:suspense:resolve", () => {
        u.update();
      });
      else {
        const { mount: A } = v;
      ...
      v.mixin({ computed: { $vuetify() {
        return Ue({ defaults: Nn.call(this, ar), display: Nn.call(this, Mo), theme: Nn.call(this, Xr), icons: Nn.call(this, Co), locale: Nn.call(this, xo), date: Nn.call(this, su) });
      } } });
    }
    function S() {
      a.stop();
...
const Lw = Ye({ name: "RouteCoordinate", render: () => null }), Ew = [...dr.map((e) => ({ path: e.route, name: e.id, component: Lw })), { path: "/:pathMatch(.*)*", redirect: "/" }], Ha = Lb({ history: ib("/"), routes: Ew }), Mw = I1(P_).use(xw).use(Ha);
Aw(Ha);
Ha.isReady().then(() => Mw.mount("#app"));
