...
} }), Kw = Bn(Yw, [["__scopeId", "data-v-dbb9d5dc"]]), ds = 5, qw = 16, Xw = 4, Zw = 260, Jw = 220, Qw = 0.3, e0 = 0.12, t0 = ln({ __name: "AppBackground", setup(e) {
...
} }), n0 = Bn(t0, [["__scopeId", "data-v-f9fefb9e"]]);
function wg(e, t) {
...
} }), P1 = Bn(I1, [["__scopeId", "data-v-6c7f4bed"]]), A1 = ["href", "aria-label"], T1 = { class: "contact-text" }, D1 = ln({ __name: "ContactStrip", props: { dense: { type: Boolean } }, setup(e) {
  return (t, n) => {
    const a = je("v-icon");
