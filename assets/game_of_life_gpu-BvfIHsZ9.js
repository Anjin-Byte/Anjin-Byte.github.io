...
let T;
let __tla = (async ()=>{
    var j = "/assets/game_of_life_gpu_bg-Be2gTQUC.wasm";
    T = class {
        static __wrap(_) {
            _ = _ >>> 0;
